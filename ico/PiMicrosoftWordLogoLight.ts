...
/**
 * MicrosoftWordLogoLight icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftWordLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftWordLogoLight;
