...
/**
 * AlignRightSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAlignRightSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignRightSimpleThin;
