...
/**
 * AlignCenterHorizontal icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontal;
