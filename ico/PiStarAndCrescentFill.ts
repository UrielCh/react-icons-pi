...
/**
 * StarAndCrescentFill icon from Phosphor Icons
 * @module
 */
export function PiStarAndCrescentFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarAndCrescentFill;
