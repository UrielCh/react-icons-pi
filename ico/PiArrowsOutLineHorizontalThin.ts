...
/**
 * ArrowsOutLineHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineHorizontalThin;
