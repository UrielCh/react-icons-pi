...
/**
 * SpeakerSlashThin icon from Phosphor Icons
 * @module
 */
export function PiSpeakerSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerSlashThin;
