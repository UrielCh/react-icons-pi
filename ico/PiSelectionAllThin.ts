...
/**
 * SelectionAllThin icon from Phosphor Icons
 * @module
 */
export function PiSelectionAllThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionAllThin;
