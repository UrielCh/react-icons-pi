...
/**
 * PaintBrushBroadBold icon from Phosphor Icons
 * @module
 */
export function PiPaintBrushBroadBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaintBrushBroadBold;
