...
/**
 * CaretCircleDoubleUpThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleUpThin;
