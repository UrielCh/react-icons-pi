...
/**
 * MagicWandDuotone icon from Phosphor Icons
 * @module
 */
export function PiMagicWandDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagicWandDuotone;
