...
/**
 * ProjectorScreenFill icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenFill;
