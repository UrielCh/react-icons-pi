...
/**
 * MicrosoftTeamsLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftTeamsLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftTeamsLogoDuotone;
