...
/**
 * EnvelopeSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleLight;
