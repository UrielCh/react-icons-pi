...
/**
 * GitlabLogoSimple icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoSimple;
