...
/**
 * ArrowBendUpLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpLeftBold;
