...
/**
 * ArrowCounterClockwiseLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCounterClockwiseLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCounterClockwiseLight;
