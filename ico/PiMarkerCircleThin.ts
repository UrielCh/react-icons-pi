...
/**
 * MarkerCircleThin icon from Phosphor Icons
 * @module
 */
export function PiMarkerCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMarkerCircleThin;
