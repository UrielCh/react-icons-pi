...
/**
 * NumberSquareSixLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSixLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSixLight;
