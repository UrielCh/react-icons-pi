...
/**
 * ParallelogramDuotone icon from Phosphor Icons
 * @module
 */
export function PiParallelogramDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiParallelogramDuotone;
