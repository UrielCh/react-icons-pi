...
/**
 * SpinnerGapDuotone icon from Phosphor Icons
 * @module
 */
export function PiSpinnerGapDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpinnerGapDuotone;
