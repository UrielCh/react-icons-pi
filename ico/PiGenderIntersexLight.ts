...
/**
 * GenderIntersexLight icon from Phosphor Icons
 * @module
 */
export function PiGenderIntersexLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderIntersexLight;
