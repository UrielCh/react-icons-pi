...
/**
 * TrashSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrashSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrashSimpleDuotone;
