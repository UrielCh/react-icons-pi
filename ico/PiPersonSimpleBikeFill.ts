...
/**
 * PersonSimpleBikeFill icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBikeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBikeFill;
