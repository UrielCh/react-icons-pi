...
/**
 * ArrowFatDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatDownBold;
