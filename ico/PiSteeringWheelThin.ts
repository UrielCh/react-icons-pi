...
/**
 * SteeringWheelThin icon from Phosphor Icons
 * @module
 */
export function PiSteeringWheelThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSteeringWheelThin;
