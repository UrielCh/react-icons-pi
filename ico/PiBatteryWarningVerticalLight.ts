...
/**
 * BatteryWarningVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryWarningVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryWarningVerticalLight;
