...
/**
 * SelectionDuotone icon from Phosphor Icons
 * @module
 */
export function PiSelectionDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionDuotone;
