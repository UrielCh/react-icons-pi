...
/**
 * FolderSimpleStarLight icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleStarLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleStarLight;
