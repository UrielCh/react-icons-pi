...
/**
 * BookmarksSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiBookmarksSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookmarksSimpleBold;
