...
/**
 * BatteryMediumBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryMediumBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryMediumBold;
