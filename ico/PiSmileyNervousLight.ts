...
/**
 * SmileyNervousLight icon from Phosphor Icons
 * @module
 */
export function PiSmileyNervousLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyNervousLight;
