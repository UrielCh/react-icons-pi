...
/**
 * ProhibitInsetThin icon from Phosphor Icons
 * @module
 */
export function PiProhibitInsetThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProhibitInsetThin;
