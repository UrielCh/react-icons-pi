...
/**
 * CalendarCheckLight icon from Phosphor Icons
 * @module
 */
export function PiCalendarCheckLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarCheckLight;
