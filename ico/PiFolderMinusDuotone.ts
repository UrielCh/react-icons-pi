...
/**
 * FolderMinusDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderMinusDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderMinusDuotone;
