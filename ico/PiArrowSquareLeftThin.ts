...
/**
 * ArrowSquareLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareLeftThin;
