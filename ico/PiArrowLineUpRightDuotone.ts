...
/**
 * ArrowLineUpRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpRightDuotone;
