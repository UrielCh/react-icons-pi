...
/**
 * ArrowElbowLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowLeftThin;
