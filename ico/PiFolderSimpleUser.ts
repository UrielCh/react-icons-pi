...
/**
 * FolderSimpleUser icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleUser(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleUser;
