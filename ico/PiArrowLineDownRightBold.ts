...
/**
 * ArrowLineDownRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownRightBold;
