...
/**
 * PersonArmsSpreadFill icon from Phosphor Icons
 * @module
 */
export function PiPersonArmsSpreadFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonArmsSpreadFill;
