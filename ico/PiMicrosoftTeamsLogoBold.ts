...
/**
 * MicrosoftTeamsLogoBold icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftTeamsLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftTeamsLogoBold;
