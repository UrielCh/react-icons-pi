...
/**
 * LinkSimpleHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalBold;
