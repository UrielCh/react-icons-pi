...
/**
 * ArrowBendUpRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpRightFill;
