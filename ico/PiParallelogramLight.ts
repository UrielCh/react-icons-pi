...
/**
 * ParallelogramLight icon from Phosphor Icons
 * @module
 */
export function PiParallelogramLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiParallelogramLight;
