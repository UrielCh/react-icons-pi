...
/**
 * WarningCircleThin icon from Phosphor Icons
 * @module
 */
export function PiWarningCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningCircleThin;
