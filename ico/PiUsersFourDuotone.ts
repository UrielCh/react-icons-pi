...
/**
 * UsersFourDuotone icon from Phosphor Icons
 * @module
 */
export function PiUsersFourDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUsersFourDuotone;
