...
/**
 * CubeTransparentFill icon from Phosphor Icons
 * @module
 */
export function PiCubeTransparentFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCubeTransparentFill;
