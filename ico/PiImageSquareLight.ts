...
/**
 * ImageSquareLight icon from Phosphor Icons
 * @module
 */
export function PiImageSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiImageSquareLight;
