...
/**
 * LockLaminatedBold icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedBold;
