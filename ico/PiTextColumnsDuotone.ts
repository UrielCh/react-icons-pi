...
/**
 * TextColumnsDuotone icon from Phosphor Icons
 * @module
 */
export function PiTextColumnsDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextColumnsDuotone;
