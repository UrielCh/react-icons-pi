...
/**
 * RainbowCloudFill icon from Phosphor Icons
 * @module
 */
export function PiRainbowCloudFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRainbowCloudFill;
