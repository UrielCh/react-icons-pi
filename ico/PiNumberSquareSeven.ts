...
/**
 * NumberSquareSeven icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSeven(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSeven;
