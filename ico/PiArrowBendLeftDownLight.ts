...
/**
 * ArrowBendLeftDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftDownLight;
