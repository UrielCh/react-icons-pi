...
/**
 * AlignCenterHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalLight;
