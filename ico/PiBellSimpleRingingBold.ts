...
/**
 * BellSimpleRingingBold icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleRingingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleRingingBold;
