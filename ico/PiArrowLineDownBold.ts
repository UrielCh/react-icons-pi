...
/**
 * ArrowLineDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownBold;
