...
/**
 * ThermometerLight icon from Phosphor Icons
 * @module
 */
export function PiThermometerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerLight;
