...
/**
 * CodesandboxLogoLight icon from Phosphor Icons
 * @module
 */
export function PiCodesandboxLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodesandboxLogoLight;
