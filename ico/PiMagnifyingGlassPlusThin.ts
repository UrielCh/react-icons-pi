...
/**
 * MagnifyingGlassPlusThin icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassPlusThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassPlusThin;
