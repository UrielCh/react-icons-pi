...
/**
 * CaretCircleDoubleDownThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleDownThin;
