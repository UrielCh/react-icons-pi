...
/**
 * ArrowsMergeLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsMergeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsMergeLight;
