...
/**
 * WarningOctagonFill icon from Phosphor Icons
 * @module
 */
export function PiWarningOctagonFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningOctagonFill;
