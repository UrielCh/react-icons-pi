...
/**
 * SplitVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiSplitVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitVerticalFill;
