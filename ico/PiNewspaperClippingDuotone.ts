...
/**
 * NewspaperClippingDuotone icon from Phosphor Icons
 * @module
 */
export function PiNewspaperClippingDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNewspaperClippingDuotone;
