...
/**
 * ArrowsDownUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsDownUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsDownUpThin;
