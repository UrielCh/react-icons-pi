...
/**
 * ArrowArcRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowArcRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcRightLight;
