...
/**
 * BatteryVerticalMediumThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalMediumThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalMediumThin;
