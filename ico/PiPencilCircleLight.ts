...
/**
 * PencilCircleLight icon from Phosphor Icons
 * @module
 */
export function PiPencilCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilCircleLight;
