...
/**
 * SmileyMeltingThin icon from Phosphor Icons
 * @module
 */
export function PiSmileyMeltingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyMeltingThin;
