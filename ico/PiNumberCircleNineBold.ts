...
/**
 * NumberCircleNineBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleNineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleNineBold;
