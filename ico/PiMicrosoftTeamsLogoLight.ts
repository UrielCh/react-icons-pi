...
/**
 * MicrosoftTeamsLogoLight icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftTeamsLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftTeamsLogoLight;
