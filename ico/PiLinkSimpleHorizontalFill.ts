...
/**
 * LinkSimpleHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalFill;
