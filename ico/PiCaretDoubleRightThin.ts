...
/**
 * CaretDoubleRightThin icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleRightThin;
