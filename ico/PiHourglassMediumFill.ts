...
/**
 * HourglassMediumFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassMediumFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassMediumFill;
