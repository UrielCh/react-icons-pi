...
/**
 * TextAlignCenterThin icon from Phosphor Icons
 * @module
 */
export function PiTextAlignCenterThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignCenterThin;
