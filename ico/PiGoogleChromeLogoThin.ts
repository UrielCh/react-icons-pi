...
/**
 * GoogleChromeLogoThin icon from Phosphor Icons
 * @module
 */
export function PiGoogleChromeLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleChromeLogoThin;
