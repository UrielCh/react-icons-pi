...
/**
 * CirclesThreePlusDuotone icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreePlusDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreePlusDuotone;
