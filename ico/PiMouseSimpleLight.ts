...
/**
 * MouseSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiMouseSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMouseSimpleLight;
