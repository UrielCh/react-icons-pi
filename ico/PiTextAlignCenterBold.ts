...
/**
 * TextAlignCenterBold icon from Phosphor Icons
 * @module
 */
export function PiTextAlignCenterBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignCenterBold;
