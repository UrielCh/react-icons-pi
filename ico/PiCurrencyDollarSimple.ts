...
/**
 * CurrencyDollarSimple icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarSimple;
