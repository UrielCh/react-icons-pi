...
/**
 * GooglePodcastsLogoFill icon from Phosphor Icons
 * @module
 */
export function PiGooglePodcastsLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePodcastsLogoFill;
