...
/**
 * AlignRightSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAlignRightSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignRightSimpleBold;
