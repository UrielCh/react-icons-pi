...
/**
 * SelectionSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiSelectionSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionSlashDuotone;
