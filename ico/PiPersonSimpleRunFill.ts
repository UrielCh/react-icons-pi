...
/**
 * PersonSimpleRunFill icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleRunFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleRunFill;
