...
/**
 * HourglassSimpleMediumThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleMediumThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleMediumThin;
