...
/**
 * ArrowCounterClockwise icon from Phosphor Icons
 * @module
 */
export function PiArrowCounterClockwise(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCounterClockwise;
