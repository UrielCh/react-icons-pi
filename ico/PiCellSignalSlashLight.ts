...
/**
 * CellSignalSlashLight icon from Phosphor Icons
 * @module
 */
export function PiCellSignalSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalSlashLight;
