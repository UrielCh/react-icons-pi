...
/**
 * ProhibitInsetFill icon from Phosphor Icons
 * @module
 */
export function PiProhibitInsetFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProhibitInsetFill;
