...
/**
 * EnvelopeSimpleOpenFill icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleOpenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleOpenFill;
