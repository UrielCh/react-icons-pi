...
/**
 * IntersectDuotone icon from Phosphor Icons
 * @module
 */
export function PiIntersectDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectDuotone;
