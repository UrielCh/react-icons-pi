...
/**
 * ArrowSquareDownLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownLeftThin;
