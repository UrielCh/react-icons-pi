...
/**
 * ContactlessPaymentFill icon from Phosphor Icons
 * @module
 */
export function PiContactlessPaymentFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiContactlessPaymentFill;
