...
/**
 * ArrowFatLineLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineLeftDuotone;
