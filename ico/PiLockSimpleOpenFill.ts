...
/**
 * LockSimpleOpenFill icon from Phosphor Icons
 * @module
 */
export function PiLockSimpleOpenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockSimpleOpenFill;
