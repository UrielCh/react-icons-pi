...
/**
 * VideoCameraSlashLight icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraSlashLight;
