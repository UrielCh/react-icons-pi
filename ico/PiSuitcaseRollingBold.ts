...
/**
 * SuitcaseRollingBold icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseRollingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseRollingBold;
