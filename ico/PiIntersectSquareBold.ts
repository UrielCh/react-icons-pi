...
/**
 * IntersectSquareBold icon from Phosphor Icons
 * @module
 */
export function PiIntersectSquareBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectSquareBold;
