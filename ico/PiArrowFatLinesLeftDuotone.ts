...
/**
 * ArrowFatLinesLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesLeftDuotone;
