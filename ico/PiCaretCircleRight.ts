...
/**
 * CaretCircleRight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleRight;
