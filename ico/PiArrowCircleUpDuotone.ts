...
/**
 * ArrowCircleUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpDuotone;
