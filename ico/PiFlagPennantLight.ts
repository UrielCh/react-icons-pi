...
/**
 * FlagPennantLight icon from Phosphor Icons
 * @module
 */
export function PiFlagPennantLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlagPennantLight;
