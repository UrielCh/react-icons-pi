...
/**
 * UserCircleGearDuotone icon from Phosphor Icons
 * @module
 */
export function PiUserCircleGearDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleGearDuotone;
