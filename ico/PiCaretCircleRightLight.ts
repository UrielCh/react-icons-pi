...
/**
 * CaretCircleRightLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleRightLight;
