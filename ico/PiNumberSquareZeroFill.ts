...
/**
 * NumberSquareZeroFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareZeroFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareZeroFill;
