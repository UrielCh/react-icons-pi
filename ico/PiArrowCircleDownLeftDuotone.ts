...
/**
 * ArrowCircleDownLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLeftDuotone;
