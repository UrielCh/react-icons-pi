...
/**
 * DotsSixVerticalDuotone icon from Phosphor Icons
 * @module
 */
export function PiDotsSixVerticalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsSixVerticalDuotone;
