...
/**
 * NumberSquareOneLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareOneLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareOneLight;
