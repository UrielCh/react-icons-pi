...
/**
 * NumberCircleOneThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleOneThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleOneThin;
