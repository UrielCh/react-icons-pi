...
/**
 * TrayArrowDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrayArrowDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrayArrowDownDuotone;
