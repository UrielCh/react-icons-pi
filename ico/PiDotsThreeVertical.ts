...
/**
 * DotsThreeVertical icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeVertical;
