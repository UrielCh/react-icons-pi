...
/**
 * IdentificationCardLight icon from Phosphor Icons
 * @module
 */
export function PiIdentificationCardLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationCardLight;
