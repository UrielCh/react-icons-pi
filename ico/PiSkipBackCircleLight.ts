...
/**
 * SkipBackCircleLight icon from Phosphor Icons
 * @module
 */
export function PiSkipBackCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipBackCircleLight;
