...
/**
 * NumberSquareSevenBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSevenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSevenBold;
