...
/**
 * ArrowSquareUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpBold;
