...
/**
 * ArrowUUpRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpRightLight;
