...
/**
 * DropboxLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiDropboxLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDropboxLogoDuotone;
