...
/**
 * ClockCountdownThin icon from Phosphor Icons
 * @module
 */
export function PiClockCountdownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCountdownThin;
