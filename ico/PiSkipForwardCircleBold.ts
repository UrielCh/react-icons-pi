...
/**
 * SkipForwardCircleBold icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardCircleBold;
