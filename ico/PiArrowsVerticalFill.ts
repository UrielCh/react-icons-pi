...
/**
 * ArrowsVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsVerticalFill;
