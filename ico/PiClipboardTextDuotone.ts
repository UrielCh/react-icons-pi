...
/**
 * ClipboardTextDuotone icon from Phosphor Icons
 * @module
 */
export function PiClipboardTextDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClipboardTextDuotone;
