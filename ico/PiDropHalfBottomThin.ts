...
/**
 * DropHalfBottomThin icon from Phosphor Icons
 * @module
 */
export function PiDropHalfBottomThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDropHalfBottomThin;
