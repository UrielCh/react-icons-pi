...
/**
 * CellSignalHighLight icon from Phosphor Icons
 * @module
 */
export function PiCellSignalHighLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalHighLight;
