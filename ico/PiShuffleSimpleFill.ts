...
/**
 * ShuffleSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiShuffleSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShuffleSimpleFill;
