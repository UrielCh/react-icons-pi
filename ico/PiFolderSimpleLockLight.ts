...
/**
 * FolderSimpleLockLight icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleLockLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleLockLight;
