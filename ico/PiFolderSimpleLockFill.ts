...
/**
 * FolderSimpleLockFill icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleLockFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleLockFill;
