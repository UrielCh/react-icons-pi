...
/**
 * MicrosoftTeamsLogoThin icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftTeamsLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftTeamsLogoThin;
