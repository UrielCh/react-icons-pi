...
/**
 * TextAlignLeftBold icon from Phosphor Icons
 * @module
 */
export function PiTextAlignLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignLeftBold;
