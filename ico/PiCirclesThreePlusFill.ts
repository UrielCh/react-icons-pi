...
/**
 * CirclesThreePlusFill icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreePlusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreePlusFill;
