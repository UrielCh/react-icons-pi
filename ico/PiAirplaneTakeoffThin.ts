...
/**
 * AirplaneTakeoffThin icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTakeoffThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTakeoffThin;
