...
/**
 * CaretCircleUpLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpLight;
