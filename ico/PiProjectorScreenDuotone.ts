...
/**
 * ProjectorScreenDuotone icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenDuotone;
