...
/**
 * FolderSimplePlusFill icon from Phosphor Icons
 * @module
 */
export function PiFolderSimplePlusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimplePlusFill;
