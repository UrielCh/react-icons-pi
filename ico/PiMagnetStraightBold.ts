...
/**
 * MagnetStraightBold icon from Phosphor Icons
 * @module
 */
export function PiMagnetStraightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnetStraightBold;
