...
/**
 * PushPinSlashLight icon from Phosphor Icons
 * @module
 */
export function PiPushPinSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSlashLight;
