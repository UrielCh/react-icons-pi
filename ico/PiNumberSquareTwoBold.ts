...
/**
 * NumberSquareTwoBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareTwoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareTwoBold;
