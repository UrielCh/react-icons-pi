...
/**
 * ArrowSquareRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareRightDuotone;
