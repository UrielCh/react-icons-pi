...
/**
 * LockSimpleOpenDuotone icon from Phosphor Icons
 * @module
 */
export function PiLockSimpleOpenDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockSimpleOpenDuotone;
