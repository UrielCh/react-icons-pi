...
/**
 * DeviceTabletSpeakerThin icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletSpeakerThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletSpeakerThin;
