...
/**
 * StarOfDavidDuotone icon from Phosphor Icons
 * @module
 */
export function PiStarOfDavidDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarOfDavidDuotone;
