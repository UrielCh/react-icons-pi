...
/**
 * GooglePodcastsLogoThin icon from Phosphor Icons
 * @module
 */
export function PiGooglePodcastsLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePodcastsLogoThin;
