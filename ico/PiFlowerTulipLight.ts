...
/**
 * FlowerTulipLight icon from Phosphor Icons
 * @module
 */
export function PiFlowerTulipLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlowerTulipLight;
