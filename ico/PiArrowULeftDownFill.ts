...
/**
 * ArrowULeftDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftDownFill;
