...
/**
 * UmbrellaSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiUmbrellaSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUmbrellaSimpleBold;
