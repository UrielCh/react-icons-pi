...
/**
 * AlignCenterVerticalSimple icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalSimple;
