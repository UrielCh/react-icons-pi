...
/**
 * HardDriveDuotone icon from Phosphor Icons
 * @module
 */
export function PiHardDriveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHardDriveDuotone;
