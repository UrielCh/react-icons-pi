...
/**
 * HourglassLowFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassLowFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassLowFill;
