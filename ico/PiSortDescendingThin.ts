...
/**
 * SortDescendingThin icon from Phosphor Icons
 * @module
 */
export function PiSortDescendingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSortDescendingThin;
