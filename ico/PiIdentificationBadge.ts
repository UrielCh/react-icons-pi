...
/**
 * IdentificationBadge icon from Phosphor Icons
 * @module
 */
export function PiIdentificationBadge(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationBadge;
