...
/**
 * GitlabLogoSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoSimpleDuotone;
