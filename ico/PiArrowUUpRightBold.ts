...
/**
 * ArrowUUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpRightBold;
