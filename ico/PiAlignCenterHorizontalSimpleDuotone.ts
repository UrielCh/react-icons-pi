...
/**
 * AlignCenterHorizontalSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalSimpleDuotone;
