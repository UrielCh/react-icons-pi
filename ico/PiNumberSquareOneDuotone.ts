...
/**
 * NumberSquareOneDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareOneDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareOneDuotone;
