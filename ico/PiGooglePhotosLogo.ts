...
/**
 * GooglePhotosLogo icon from Phosphor Icons
 * @module
 */
export function PiGooglePhotosLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePhotosLogo;
