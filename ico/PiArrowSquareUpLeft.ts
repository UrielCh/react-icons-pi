...
/**
 * ArrowSquareUpLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpLeft;
