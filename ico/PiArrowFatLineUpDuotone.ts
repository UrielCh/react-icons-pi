...
/**
 * ArrowFatLineUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineUpDuotone;
