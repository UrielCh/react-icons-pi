...
/**
 * ArrowsOutLineHorizontal icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineHorizontal;
