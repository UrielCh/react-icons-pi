...
/**
 * HeartStraightDuotone icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightDuotone;
