...
/**
 * ChartLineDownBold icon from Phosphor Icons
 * @module
 */
export function PiChartLineDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartLineDownBold;
