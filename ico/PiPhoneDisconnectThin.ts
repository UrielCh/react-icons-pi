...
/**
 * PhoneDisconnectThin icon from Phosphor Icons
 * @module
 */
export function PiPhoneDisconnectThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneDisconnectThin;
