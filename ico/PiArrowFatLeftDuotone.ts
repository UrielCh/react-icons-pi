...
/**
 * ArrowFatLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLeftDuotone;
