...
/**
 * ProjectorScreenChartDuotone icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenChartDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenChartDuotone;
