...
/**
 * HourglassLowThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassLowThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassLowThin;
