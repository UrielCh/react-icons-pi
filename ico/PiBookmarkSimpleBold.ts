...
/**
 * BookmarkSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiBookmarkSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookmarkSimpleBold;
