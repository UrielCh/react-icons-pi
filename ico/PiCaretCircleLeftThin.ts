...
/**
 * CaretCircleLeftThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleLeftThin;
