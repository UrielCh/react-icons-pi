...
/**
 * ArrowCircleDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownFill;
