...
/**
 * HandsPrayingDuotone icon from Phosphor Icons
 * @module
 */
export function PiHandsPrayingDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandsPrayingDuotone;
