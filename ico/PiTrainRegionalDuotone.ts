...
/**
 * TrainRegionalDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrainRegionalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainRegionalDuotone;
