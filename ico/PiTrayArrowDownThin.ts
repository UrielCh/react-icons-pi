...
/**
 * TrayArrowDownThin icon from Phosphor Icons
 * @module
 */
export function PiTrayArrowDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrayArrowDownThin;
