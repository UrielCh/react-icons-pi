...
/**
 * SubtitlesDuotone icon from Phosphor Icons
 * @module
 */
export function PiSubtitlesDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSubtitlesDuotone;
