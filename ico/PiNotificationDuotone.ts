...
/**
 * NotificationDuotone icon from Phosphor Icons
 * @module
 */
export function PiNotificationDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNotificationDuotone;
