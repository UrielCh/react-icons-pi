...
/**
 * ProjectorScreenLight icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenLight;
