...
/**
 * SquareSplitHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitHorizontalLight;
