...
/**
 * SoundcloudLogoThin icon from Phosphor Icons
 * @module
 */
export function PiSoundcloudLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSoundcloudLogoThin;
