...
/**
 * DotsThreeCircleFill icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleFill;
