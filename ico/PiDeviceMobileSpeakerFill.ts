...
/**
 * DeviceMobileSpeakerFill icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileSpeakerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileSpeakerFill;
