...
/**
 * ArrowFatLinesDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesDownFill;
