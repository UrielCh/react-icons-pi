...
/**
 * CloudLightningDuotone icon from Phosphor Icons
 * @module
 */
export function PiCloudLightningDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudLightningDuotone;
