...
/**
 * ArrowBendUpLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpLeftDuotone;
