...
/**
 * HeartStraightBreakFill icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightBreakFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightBreakFill;
