...
/**
 * SelectionSlashThin icon from Phosphor Icons
 * @module
 */
export function PiSelectionSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionSlashThin;
