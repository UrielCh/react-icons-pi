...
/**
 * NumberCircleFourDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFourDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFourDuotone;
