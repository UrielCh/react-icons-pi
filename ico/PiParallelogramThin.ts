...
/**
 * ParallelogramThin icon from Phosphor Icons
 * @module
 */
export function PiParallelogramThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiParallelogramThin;
