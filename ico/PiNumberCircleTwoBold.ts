...
/**
 * NumberCircleTwoBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleTwoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleTwoBold;
