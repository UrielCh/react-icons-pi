...
/**
 * ProjectorScreenChartThin icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenChartThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenChartThin;
