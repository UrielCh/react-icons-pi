...
/**
 * NumberCircleSevenLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSevenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSevenLight;
