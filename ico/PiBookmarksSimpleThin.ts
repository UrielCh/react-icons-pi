...
/**
 * BookmarksSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiBookmarksSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookmarksSimpleThin;
