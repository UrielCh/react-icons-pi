...
/**
 * SelectionAllBold icon from Phosphor Icons
 * @module
 */
export function PiSelectionAllBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionAllBold;
