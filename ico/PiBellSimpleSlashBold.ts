...
/**
 * BellSimpleSlashBold icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleSlashBold;
