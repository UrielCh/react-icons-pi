...
/**
 * ArrowsInSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsInSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInSimpleFill;
