...
/**
 * ArrowCircleUpLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpLeft;
