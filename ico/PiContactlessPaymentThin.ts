...
/**
 * ContactlessPaymentThin icon from Phosphor Icons
 * @module
 */
export function PiContactlessPaymentThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiContactlessPaymentThin;
