...
/**
 * ArrowLineLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowLineLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineLeftBold;
