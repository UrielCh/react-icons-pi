...
/**
 * FrameCornersBold icon from Phosphor Icons
 * @module
 */
export function PiFrameCornersBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFrameCornersBold;
