...
/**
 * CubeTransparentDuotone icon from Phosphor Icons
 * @module
 */
export function PiCubeTransparentDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCubeTransparentDuotone;
