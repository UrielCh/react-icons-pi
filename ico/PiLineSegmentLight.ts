...
/**
 * LineSegmentLight icon from Phosphor Icons
 * @module
 */
export function PiLineSegmentLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLineSegmentLight;
