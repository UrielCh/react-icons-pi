...
/**
 * CircleDashedLight icon from Phosphor Icons
 * @module
 */
export function PiCircleDashedLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleDashedLight;
