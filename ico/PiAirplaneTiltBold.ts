...
/**
 * AirplaneTiltBold icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTiltBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTiltBold;
