...
/**
 * ArrowURightDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowURightDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightDownBold;
