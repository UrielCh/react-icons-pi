...
/**
 * AppStoreLogoThin icon from Phosphor Icons
 * @module
 */
export function PiAppStoreLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAppStoreLogoThin;
