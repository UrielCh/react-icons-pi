...
/**
 * DotsThreeCircleVerticalDuotone icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleVerticalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleVerticalDuotone;
