...
/**
 * StripeLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiStripeLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStripeLogoDuotone;
