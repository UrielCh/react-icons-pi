...
/**
 * ArrowLineUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpLight;
