...
/**
 * CurrencyKrwDuotone icon from Phosphor Icons
 * @module
 */
export function PiCurrencyKrwDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyKrwDuotone;
