...
/**
 * ArrowUDownLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownLeftLight;
