...
/**
 * ArrowURightUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowURightUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightUpFill;
