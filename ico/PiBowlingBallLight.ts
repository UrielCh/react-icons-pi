...
/**
 * BowlingBallLight icon from Phosphor Icons
 * @module
 */
export function PiBowlingBallLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBowlingBallLight;
