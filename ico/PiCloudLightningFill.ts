...
/**
 * CloudLightningFill icon from Phosphor Icons
 * @module
 */
export function PiCloudLightningFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudLightningFill;
