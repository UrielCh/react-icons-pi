...
/**
 * ShoppingBagDuotone icon from Phosphor Icons
 * @module
 */
export function PiShoppingBagDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShoppingBagDuotone;
