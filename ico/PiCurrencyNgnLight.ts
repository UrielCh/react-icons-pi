...
/**
 * CurrencyNgnLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyNgnLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyNgnLight;
