...
/**
 * CirclesThreeDuotone icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreeDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreeDuotone;
