...
/**
 * CaretCircleDoubleRight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleRight;
