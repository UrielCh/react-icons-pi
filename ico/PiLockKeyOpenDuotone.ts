...
/**
 * LockKeyOpenDuotone icon from Phosphor Icons
 * @module
 */
export function PiLockKeyOpenDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockKeyOpenDuotone;
