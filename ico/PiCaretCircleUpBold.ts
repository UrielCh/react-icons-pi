...
/**
 * CaretCircleUpBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpBold;
