...
/**
 * CubeTransparentBold icon from Phosphor Icons
 * @module
 */
export function PiCubeTransparentBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCubeTransparentBold;
