...
/**
 * FlagBannerFoldBold icon from Phosphor Icons
 * @module
 */
export function PiFlagBannerFoldBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlagBannerFoldBold;
