...
/**
 * FolderSimpleStarDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleStarDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleStarDuotone;
