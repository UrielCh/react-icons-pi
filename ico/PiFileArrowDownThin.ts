...
/**
 * FileArrowDownThin icon from Phosphor Icons
 * @module
 */
export function PiFileArrowDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileArrowDownThin;
