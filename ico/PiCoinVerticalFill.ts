...
/**
 * CoinVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiCoinVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCoinVerticalFill;
