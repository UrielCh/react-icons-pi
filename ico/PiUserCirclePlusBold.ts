...
/**
 * UserCirclePlusBold icon from Phosphor Icons
 * @module
 */
export function PiUserCirclePlusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCirclePlusBold;
