...
/**
 * ArrowFatLinesDown icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesDown;
