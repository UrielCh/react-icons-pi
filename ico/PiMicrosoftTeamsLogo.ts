...
/**
 * MicrosoftTeamsLogo icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftTeamsLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftTeamsLogo;
