...
/**
 * NumberCircleEightDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleEightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleEightDuotone;
