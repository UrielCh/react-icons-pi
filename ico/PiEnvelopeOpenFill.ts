...
/**
 * EnvelopeOpenFill icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeOpenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeOpenFill;
