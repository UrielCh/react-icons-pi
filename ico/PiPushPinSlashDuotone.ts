...
/**
 * PushPinSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiPushPinSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSlashDuotone;
