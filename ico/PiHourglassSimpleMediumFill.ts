...
/**
 * HourglassSimpleMediumFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleMediumFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleMediumFill;
