...
/**
 * BellSimpleRingingFill icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleRingingFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleRingingFill;
