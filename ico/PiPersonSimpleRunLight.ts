...
/**
 * PersonSimpleRunLight icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleRunLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleRunLight;
