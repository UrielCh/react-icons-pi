...
/**
 * FlyingSaucerThin icon from Phosphor Icons
 * @module
 */
export function PiFlyingSaucerThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlyingSaucerThin;
