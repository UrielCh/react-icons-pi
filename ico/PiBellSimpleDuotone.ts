...
/**
 * BellSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleDuotone;
