...
/**
 * NumberSquareThreeBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareThreeBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareThreeBold;
