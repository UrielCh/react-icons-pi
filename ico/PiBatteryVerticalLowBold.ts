...
/**
 * BatteryVerticalLowBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalLowBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalLowBold;
