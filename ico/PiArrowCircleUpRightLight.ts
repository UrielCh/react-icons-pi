...
/**
 * ArrowCircleUpRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpRightLight;
