...
/**
 * ArrowsInLineVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineVerticalFill;
