...
/**
 * ProjectorScreenChartLight icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenChartLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenChartLight;
