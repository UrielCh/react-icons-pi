...
/**
 * CaretDoubleRightLight icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleRightLight;
