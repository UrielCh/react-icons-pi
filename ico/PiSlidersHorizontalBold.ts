...
/**
 * SlidersHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiSlidersHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSlidersHorizontalBold;
