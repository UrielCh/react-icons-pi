...
/**
 * CircleDashedDuotone icon from Phosphor Icons
 * @module
 */
export function PiCircleDashedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleDashedDuotone;
