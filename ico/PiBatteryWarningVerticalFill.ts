...
/**
 * BatteryWarningVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryWarningVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryWarningVerticalFill;
