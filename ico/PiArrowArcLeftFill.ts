...
/**
 * ArrowArcLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowArcLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcLeftFill;
