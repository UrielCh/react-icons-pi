...
/**
 * LinkedinLogoFill icon from Phosphor Icons
 * @module
 */
export function PiLinkedinLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkedinLogoFill;
