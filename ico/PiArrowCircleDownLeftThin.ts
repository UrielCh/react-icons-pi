...
/**
 * ArrowCircleDownLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLeftThin;
