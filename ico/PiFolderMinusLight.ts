...
/**
 * FolderMinusLight icon from Phosphor Icons
 * @module
 */
export function PiFolderMinusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderMinusLight;
