...
/**
 * NumberCircleThreeLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleThreeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleThreeLight;
