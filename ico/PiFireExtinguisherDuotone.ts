...
/**
 * FireExtinguisherDuotone icon from Phosphor Icons
 * @module
 */
export function PiFireExtinguisherDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireExtinguisherDuotone;
