...
/**
 * ArrowBendUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpRightBold;
