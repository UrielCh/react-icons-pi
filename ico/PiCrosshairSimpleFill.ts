...
/**
 * CrosshairSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiCrosshairSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCrosshairSimpleFill;
