...
/**
 * StarAndCrescentLight icon from Phosphor Icons
 * @module
 */
export function PiStarAndCrescentLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarAndCrescentLight;
