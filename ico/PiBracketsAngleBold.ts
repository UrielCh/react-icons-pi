...
/**
 * BracketsAngleBold icon from Phosphor Icons
 * @module
 */
export function PiBracketsAngleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsAngleBold;
