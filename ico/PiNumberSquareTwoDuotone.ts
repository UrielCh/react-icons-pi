...
/**
 * NumberSquareTwoDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareTwoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareTwoDuotone;
