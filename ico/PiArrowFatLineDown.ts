...
/**
 * ArrowFatLineDown icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineDown;
