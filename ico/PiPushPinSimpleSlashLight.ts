...
/**
 * PushPinSimpleSlashLight icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleSlashLight;
