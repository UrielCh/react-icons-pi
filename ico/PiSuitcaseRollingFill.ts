...
/**
 * SuitcaseRollingFill icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseRollingFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseRollingFill;
