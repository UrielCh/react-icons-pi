...
/**
 * ArrowUUpLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpLeftThin;
