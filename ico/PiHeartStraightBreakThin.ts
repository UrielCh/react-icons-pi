...
/**
 * HeartStraightBreakThin icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightBreakThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightBreakThin;
