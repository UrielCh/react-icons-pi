...
/**
 * CirclesThreeFill icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreeFill;
