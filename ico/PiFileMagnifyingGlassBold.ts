...
/**
 * FileMagnifyingGlassBold icon from Phosphor Icons
 * @module
 */
export function PiFileMagnifyingGlassBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileMagnifyingGlassBold;
