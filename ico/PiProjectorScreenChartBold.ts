...
/**
 * ProjectorScreenChartBold icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenChartBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenChartBold;
