...
/**
 * AnchorSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAnchorSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAnchorSimpleLight;
