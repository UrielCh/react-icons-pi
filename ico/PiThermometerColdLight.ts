...
/**
 * ThermometerColdLight icon from Phosphor Icons
 * @module
 */
export function PiThermometerColdLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerColdLight;
