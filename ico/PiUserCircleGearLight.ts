...
/**
 * UserCircleGearLight icon from Phosphor Icons
 * @module
 */
export function PiUserCircleGearLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleGearLight;
