...
/**
 * PaintBrushBroadThin icon from Phosphor Icons
 * @module
 */
export function PiPaintBrushBroadThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaintBrushBroadThin;
