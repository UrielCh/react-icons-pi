...
/**
 * MagnifyingGlassPlus icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassPlus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassPlus;
