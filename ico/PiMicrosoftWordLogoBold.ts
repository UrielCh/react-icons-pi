...
/**
 * MicrosoftWordLogoBold icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftWordLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftWordLogoBold;
