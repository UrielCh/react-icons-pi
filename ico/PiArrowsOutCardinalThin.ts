...
/**
 * ArrowsOutCardinalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutCardinalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutCardinalThin;
