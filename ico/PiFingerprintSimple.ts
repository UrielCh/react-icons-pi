...
/**
 * FingerprintSimple icon from Phosphor Icons
 * @module
 */
export function PiFingerprintSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFingerprintSimple;
