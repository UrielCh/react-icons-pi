...
/**
 * MicrosoftWordLogo icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftWordLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftWordLogo;
