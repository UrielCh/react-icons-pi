...
/**
 * ArrowsInLineVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineVerticalBold;
