...
/**
 * BookBookmarkFill icon from Phosphor Icons
 * @module
 */
export function PiBookBookmarkFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookBookmarkFill;
