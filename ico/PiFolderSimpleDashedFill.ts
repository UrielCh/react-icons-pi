...
/**
 * FolderSimpleDashedFill icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleDashedFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleDashedFill;
