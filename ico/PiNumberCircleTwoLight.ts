...
/**
 * NumberCircleTwoLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleTwoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleTwoLight;
