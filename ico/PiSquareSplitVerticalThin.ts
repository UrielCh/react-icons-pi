...
/**
 * SquareSplitVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitVerticalThin;
