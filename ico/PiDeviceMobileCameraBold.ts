...
/**
 * DeviceMobileCameraBold icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileCameraBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileCameraBold;
