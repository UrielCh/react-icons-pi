...
/**
 * ArrowBendLeftUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftUpBold;
