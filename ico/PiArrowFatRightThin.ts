...
/**
 * ArrowFatRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatRightThin;
