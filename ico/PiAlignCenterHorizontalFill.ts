...
/**
 * AlignCenterHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalFill;
