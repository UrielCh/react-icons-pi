...
/**
 * GenderIntersexFill icon from Phosphor Icons
 * @module
 */
export function PiGenderIntersexFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderIntersexFill;
