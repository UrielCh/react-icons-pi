...
/**
 * GlobeHemisphereEastFill icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereEastFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereEastFill;
