...
/**
 * LightbulbFilamentThin icon from Phosphor Icons
 * @module
 */
export function PiLightbulbFilamentThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightbulbFilamentThin;
