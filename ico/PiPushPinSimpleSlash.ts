...
/**
 * PushPinSimpleSlash icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleSlash(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleSlash;
