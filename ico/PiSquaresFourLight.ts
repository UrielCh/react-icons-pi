...
/**
 * SquaresFourLight icon from Phosphor Icons
 * @module
 */
export function PiSquaresFourLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquaresFourLight;
