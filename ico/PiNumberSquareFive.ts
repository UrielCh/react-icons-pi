...
/**
 * NumberSquareFive icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFive(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFive;
