...
/**
 * ArrowArcLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowArcLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcLeftBold;
