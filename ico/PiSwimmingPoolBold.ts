...
/**
 * SwimmingPoolBold icon from Phosphor Icons
 * @module
 */
export function PiSwimmingPoolBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSwimmingPoolBold;
