...
/**
 * FolderUserDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderUserDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderUserDuotone;
