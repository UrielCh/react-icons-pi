...
/**
 * ArrowBendRightUp icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightUp;
