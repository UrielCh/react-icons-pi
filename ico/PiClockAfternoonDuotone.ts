...
/**
 * ClockAfternoonDuotone icon from Phosphor Icons
 * @module
 */
export function PiClockAfternoonDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockAfternoonDuotone;
