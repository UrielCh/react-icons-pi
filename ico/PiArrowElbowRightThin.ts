...
/**
 * ArrowElbowRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightThin;
