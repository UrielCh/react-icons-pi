...
/**
 * NumberCircleSixFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSixFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSixFill;
