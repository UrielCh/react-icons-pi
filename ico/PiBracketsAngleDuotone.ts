...
/**
 * BracketsAngleDuotone icon from Phosphor Icons
 * @module
 */
export function PiBracketsAngleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsAngleDuotone;
