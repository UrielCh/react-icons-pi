...
/**
 * TrafficSignalBold icon from Phosphor Icons
 * @module
 */
export function PiTrafficSignalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficSignalBold;
