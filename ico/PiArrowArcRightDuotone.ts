...
/**
 * ArrowArcRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowArcRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcRightDuotone;
