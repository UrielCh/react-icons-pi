...
/**
 * SuitcaseSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseSimpleBold;
