...
/**
 * LockLaminatedOpenLight icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedOpenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedOpenLight;
