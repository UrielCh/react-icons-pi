...
/**
 * SoundcloudLogoLight icon from Phosphor Icons
 * @module
 */
export function PiSoundcloudLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSoundcloudLogoLight;
