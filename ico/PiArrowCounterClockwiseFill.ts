...
/**
 * ArrowCounterClockwiseFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCounterClockwiseFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCounterClockwiseFill;
