...
/**
 * DotsThreeOutlineVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineVerticalBold;
