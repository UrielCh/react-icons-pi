...
/**
 * AlignLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignLeftDuotone;
