...
/**
 * CloudArrowDownThin icon from Phosphor Icons
 * @module
 */
export function PiCloudArrowDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudArrowDownThin;
