...
/**
 * PersonSimpleWalk icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleWalk(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleWalk;
