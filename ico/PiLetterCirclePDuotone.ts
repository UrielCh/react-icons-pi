...
/**
 * LetterCirclePDuotone icon from Phosphor Icons
 * @module
 */
export function PiLetterCirclePDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLetterCirclePDuotone;
