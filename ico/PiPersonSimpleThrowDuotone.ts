...
/**
 * PersonSimpleThrowDuotone icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThrowDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThrowDuotone;
