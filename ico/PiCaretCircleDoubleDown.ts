...
/**
 * CaretCircleDoubleDown icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleDown;
