...
/**
 * ArrowBendRightUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightUpDuotone;
