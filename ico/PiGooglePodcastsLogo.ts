...
/**
 * GooglePodcastsLogo icon from Phosphor Icons
 * @module
 */
export function PiGooglePodcastsLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePodcastsLogo;
