...
/**
 * HandsPrayingFill icon from Phosphor Icons
 * @module
 */
export function PiHandsPrayingFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandsPrayingFill;
