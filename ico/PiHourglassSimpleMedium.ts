...
/**
 * HourglassSimpleMedium icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleMedium(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleMedium;
