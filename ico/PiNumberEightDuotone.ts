...
/**
 * NumberEightDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberEightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberEightDuotone;
