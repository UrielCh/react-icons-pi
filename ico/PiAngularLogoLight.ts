...
/**
 * AngularLogoLight icon from Phosphor Icons
 * @module
 */
export function PiAngularLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAngularLogoLight;
