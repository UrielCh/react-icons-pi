...
/**
 * SpeakerHighLight icon from Phosphor Icons
 * @module
 */
export function PiSpeakerHighLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerHighLight;
