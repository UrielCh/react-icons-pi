...
/**
 * ArrowSquareUpLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpLeftFill;
