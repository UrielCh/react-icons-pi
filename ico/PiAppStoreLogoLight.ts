...
/**
 * AppStoreLogoLight icon from Phosphor Icons
 * @module
 */
export function PiAppStoreLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAppStoreLogoLight;
