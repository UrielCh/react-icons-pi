...
/**
 * NumberCircleEightBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleEightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleEightBold;
