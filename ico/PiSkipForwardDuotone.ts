...
/**
 * SkipForwardDuotone icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardDuotone;
