...
/**
 * VirtualRealityThin icon from Phosphor Icons
 * @module
 */
export function PiVirtualRealityThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVirtualRealityThin;
