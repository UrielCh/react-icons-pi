...
/**
 * ArrowURightUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowURightUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightUpThin;
