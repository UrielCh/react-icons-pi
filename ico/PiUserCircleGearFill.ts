...
/**
 * UserCircleGearFill icon from Phosphor Icons
 * @module
 */
export function PiUserCircleGearFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleGearFill;
