...
/**
 * WhatsappLogoLight icon from Phosphor Icons
 * @module
 */
export function PiWhatsappLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWhatsappLogoLight;
