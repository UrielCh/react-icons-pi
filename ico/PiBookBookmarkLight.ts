...
/**
 * BookBookmarkLight icon from Phosphor Icons
 * @module
 */
export function PiBookBookmarkLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookBookmarkLight;
