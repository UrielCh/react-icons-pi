...
/**
 * HourglassHighBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassHighBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassHighBold;
