...
/**
 * MicrophoneStageFill icon from Phosphor Icons
 * @module
 */
export function PiMicrophoneStageFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrophoneStageFill;
