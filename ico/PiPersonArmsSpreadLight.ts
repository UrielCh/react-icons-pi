...
/**
 * PersonArmsSpreadLight icon from Phosphor Icons
 * @module
 */
export function PiPersonArmsSpreadLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonArmsSpreadLight;
