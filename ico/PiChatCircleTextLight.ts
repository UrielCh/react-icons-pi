...
/**
 * ChatCircleTextLight icon from Phosphor Icons
 * @module
 */
export function PiChatCircleTextLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleTextLight;
