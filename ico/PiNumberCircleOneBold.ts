...
/**
 * NumberCircleOneBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleOneBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleOneBold;
