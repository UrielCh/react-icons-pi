...
/**
 * TrafficConeLight icon from Phosphor Icons
 * @module
 */
export function PiTrafficConeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficConeLight;
