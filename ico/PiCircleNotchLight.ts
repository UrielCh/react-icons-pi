...
/**
 * CircleNotchLight icon from Phosphor Icons
 * @module
 */
export function PiCircleNotchLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleNotchLight;
