...
/**
 * ArrowCircleDownLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLeftBold;
