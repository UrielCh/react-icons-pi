...
/**
 * StandardDefinitionThin icon from Phosphor Icons
 * @module
 */
export function PiStandardDefinitionThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStandardDefinitionThin;
