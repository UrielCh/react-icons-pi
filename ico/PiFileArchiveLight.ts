...
/**
 * FileArchiveLight icon from Phosphor Icons
 * @module
 */
export function PiFileArchiveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileArchiveLight;
