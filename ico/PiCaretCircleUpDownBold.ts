...
/**
 * CaretCircleUpDownBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpDownBold;
