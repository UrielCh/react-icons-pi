...
/**
 * ArrowsLeftRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsLeftRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsLeftRightThin;
