...
/**
 * IdentificationCardFill icon from Phosphor Icons
 * @module
 */
export function PiIdentificationCardFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationCardFill;
