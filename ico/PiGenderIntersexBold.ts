...
/**
 * GenderIntersexBold icon from Phosphor Icons
 * @module
 */
export function PiGenderIntersexBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderIntersexBold;
