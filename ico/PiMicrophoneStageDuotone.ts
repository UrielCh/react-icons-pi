...
/**
 * MicrophoneStageDuotone icon from Phosphor Icons
 * @module
 */
export function PiMicrophoneStageDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrophoneStageDuotone;
