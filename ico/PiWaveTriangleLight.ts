...
/**
 * WaveTriangleLight icon from Phosphor Icons
 * @module
 */
export function PiWaveTriangleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWaveTriangleLight;
