...
/**
 * LockLaminatedLight icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedLight;
