...
/**
 * ArrowSquareRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareRightThin;
