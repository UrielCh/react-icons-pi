...
/**
 * ArrowElbowUpLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowUpLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowUpLeftBold;
