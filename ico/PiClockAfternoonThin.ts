...
/**
 * ClockAfternoonThin icon from Phosphor Icons
 * @module
 */
export function PiClockAfternoonThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockAfternoonThin;
