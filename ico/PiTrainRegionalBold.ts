...
/**
 * TrainRegionalBold icon from Phosphor Icons
 * @module
 */
export function PiTrainRegionalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainRegionalBold;
