...
/**
 * TextAlignJustifyThin icon from Phosphor Icons
 * @module
 */
export function PiTextAlignJustifyThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignJustifyThin;
