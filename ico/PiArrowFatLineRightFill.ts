...
/**
 * ArrowFatLineRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineRightFill;
