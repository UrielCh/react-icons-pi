...
/**
 * StackOverflowLogoLight icon from Phosphor Icons
 * @module
 */
export function PiStackOverflowLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackOverflowLogoLight;
