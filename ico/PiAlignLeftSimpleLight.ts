...
/**
 * AlignLeftSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAlignLeftSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignLeftSimpleLight;
