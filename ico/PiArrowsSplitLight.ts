...
/**
 * ArrowsSplitLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsSplitLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsSplitLight;
