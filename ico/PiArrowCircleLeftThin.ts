...
/**
 * ArrowCircleLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleLeftThin;
