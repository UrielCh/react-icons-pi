...
/**
 * GoogleChromeLogoLight icon from Phosphor Icons
 * @module
 */
export function PiGoogleChromeLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleChromeLogoLight;
