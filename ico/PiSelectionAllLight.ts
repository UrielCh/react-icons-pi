...
/**
 * SelectionAllLight icon from Phosphor Icons
 * @module
 */
export function PiSelectionAllLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionAllLight;
