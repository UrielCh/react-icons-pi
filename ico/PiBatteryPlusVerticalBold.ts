...
/**
 * BatteryPlusVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryPlusVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryPlusVerticalBold;
