...
/**
 * PaintRollerLight icon from Phosphor Icons
 * @module
 */
export function PiPaintRollerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaintRollerLight;
