...
/**
 * FingerprintSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiFingerprintSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFingerprintSimpleLight;
