...
/**
 * ChalkboardTeacherBold icon from Phosphor Icons
 * @module
 */
export function PiChalkboardTeacherBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChalkboardTeacherBold;
