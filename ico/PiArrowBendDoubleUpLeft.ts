...
/**
 * ArrowBendDoubleUpLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpLeft;
