...
/**
 * MicrophoneStageLight icon from Phosphor Icons
 * @module
 */
export function PiMicrophoneStageLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrophoneStageLight;
