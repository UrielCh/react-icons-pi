...
/**
 * ArrowFatDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatDownThin;
