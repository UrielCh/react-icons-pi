...
/**
 * ArrowBendRightDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightDownThin;
