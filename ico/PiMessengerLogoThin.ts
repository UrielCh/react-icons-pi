...
/**
 * MessengerLogoThin icon from Phosphor Icons
 * @module
 */
export function PiMessengerLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMessengerLogoThin;
