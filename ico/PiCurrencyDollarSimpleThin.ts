...
/**
 * CurrencyDollarSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarSimpleThin;
