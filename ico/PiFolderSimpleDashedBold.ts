...
/**
 * FolderSimpleDashedBold icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleDashedBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleDashedBold;
