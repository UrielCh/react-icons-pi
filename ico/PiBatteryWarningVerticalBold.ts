...
/**
 * BatteryWarningVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryWarningVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryWarningVerticalBold;
