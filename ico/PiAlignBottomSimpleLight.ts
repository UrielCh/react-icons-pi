...
/**
 * AlignBottomSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomSimpleLight;
