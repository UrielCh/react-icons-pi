...
/**
 * PersonArmsSpreadBold icon from Phosphor Icons
 * @module
 */
export function PiPersonArmsSpreadBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonArmsSpreadBold;
