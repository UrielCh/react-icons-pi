...
/**
 * MagnifyingGlassMinusBold icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassMinusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassMinusBold;
