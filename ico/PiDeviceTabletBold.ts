...
/**
 * DeviceTabletBold icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletBold;
