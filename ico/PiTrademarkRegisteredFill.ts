...
/**
 * TrademarkRegisteredFill icon from Phosphor Icons
 * @module
 */
export function PiTrademarkRegisteredFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrademarkRegisteredFill;
