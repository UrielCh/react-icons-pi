...
/**
 * ChartLineUpLight icon from Phosphor Icons
 * @module
 */
export function PiChartLineUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartLineUpLight;
