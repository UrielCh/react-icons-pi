...
/**
 * ChatCircleTextThin icon from Phosphor Icons
 * @module
 */
export function PiChatCircleTextThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleTextThin;
