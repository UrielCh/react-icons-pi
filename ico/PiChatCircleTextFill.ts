...
/**
 * ChatCircleTextFill icon from Phosphor Icons
 * @module
 */
export function PiChatCircleTextFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleTextFill;
