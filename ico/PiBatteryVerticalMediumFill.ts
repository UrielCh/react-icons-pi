...
/**
 * BatteryVerticalMediumFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalMediumFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalMediumFill;
