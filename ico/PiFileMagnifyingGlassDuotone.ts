...
/**
 * FileMagnifyingGlassDuotone icon from Phosphor Icons
 * @module
 */
export function PiFileMagnifyingGlassDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileMagnifyingGlassDuotone;
