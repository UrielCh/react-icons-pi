...
/**
 * GoogleChromeLogoBold icon from Phosphor Icons
 * @module
 */
export function PiGoogleChromeLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleChromeLogoBold;
