...
/**
 * BracketsSquareLight icon from Phosphor Icons
 * @module
 */
export function PiBracketsSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsSquareLight;
