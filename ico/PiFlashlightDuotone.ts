...
/**
 * FlashlightDuotone icon from Phosphor Icons
 * @module
 */
export function PiFlashlightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlashlightDuotone;
