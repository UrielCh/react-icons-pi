...
/**
 * DeviceMobileSpeakerLight icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileSpeakerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileSpeakerLight;
