...
/**
 * FireExtinguisherThin icon from Phosphor Icons
 * @module
 */
export function PiFireExtinguisherThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireExtinguisherThin;
