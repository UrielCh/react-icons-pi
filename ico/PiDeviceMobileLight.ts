...
/**
 * DeviceMobileLight icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileLight;
