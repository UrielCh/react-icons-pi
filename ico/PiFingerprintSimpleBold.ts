...
/**
 * FingerprintSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiFingerprintSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFingerprintSimpleBold;
