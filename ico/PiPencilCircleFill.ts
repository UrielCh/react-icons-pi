...
/**
 * PencilCircleFill icon from Phosphor Icons
 * @module
 */
export function PiPencilCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilCircleFill;
