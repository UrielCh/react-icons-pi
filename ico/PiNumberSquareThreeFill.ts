...
/**
 * NumberSquareThreeFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareThreeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareThreeFill;
