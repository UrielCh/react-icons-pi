...
/**
 * ArrowCircleDownRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownRightLight;
