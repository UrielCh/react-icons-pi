...
/**
 * NumberCircleZeroBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleZeroBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleZeroBold;
