...
/**
 * TextAlignJustifyBold icon from Phosphor Icons
 * @module
 */
export function PiTextAlignJustifyBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignJustifyBold;
