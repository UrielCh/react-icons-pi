...
/**
 * ToiletPaperLight icon from Phosphor Icons
 * @module
 */
export function PiToiletPaperLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiToiletPaperLight;
