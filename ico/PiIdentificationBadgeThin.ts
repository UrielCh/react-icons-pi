...
/**
 * IdentificationBadgeThin icon from Phosphor Icons
 * @module
 */
export function PiIdentificationBadgeThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationBadgeThin;
