...
/**
 * ProjectorScreenThin icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenThin;
