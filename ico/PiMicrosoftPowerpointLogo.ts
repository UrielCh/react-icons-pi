...
/**
 * MicrosoftPowerpointLogo icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftPowerpointLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftPowerpointLogo;
