...
/**
 * MicrosoftPowerpointLogoFill icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftPowerpointLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftPowerpointLogoFill;
