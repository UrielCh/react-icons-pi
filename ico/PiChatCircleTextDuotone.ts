...
/**
 * ChatCircleTextDuotone icon from Phosphor Icons
 * @module
 */
export function PiChatCircleTextDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleTextDuotone;
