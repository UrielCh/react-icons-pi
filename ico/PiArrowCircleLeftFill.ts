...
/**
 * ArrowCircleLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleLeftFill;
