...
/**
 * BracketsAngleThin icon from Phosphor Icons
 * @module
 */
export function PiBracketsAngleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsAngleThin;
