...
/**
 * TrainRegionalFill icon from Phosphor Icons
 * @module
 */
export function PiTrainRegionalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainRegionalFill;
