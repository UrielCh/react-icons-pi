...
/**
 * MouseLeftClickBold icon from Phosphor Icons
 * @module
 */
export function PiMouseLeftClickBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMouseLeftClickBold;
