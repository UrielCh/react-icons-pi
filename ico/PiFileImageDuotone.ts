...
/**
 * FileImageDuotone icon from Phosphor Icons
 * @module
 */
export function PiFileImageDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileImageDuotone;
