...
/**
 * SneakerMoveLight icon from Phosphor Icons
 * @module
 */
export function PiSneakerMoveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSneakerMoveLight;
