...
/**
 * CellSignalFullBold icon from Phosphor Icons
 * @module
 */
export function PiCellSignalFullBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalFullBold;
