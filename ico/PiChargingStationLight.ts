...
/**
 * ChargingStationLight icon from Phosphor Icons
 * @module
 */
export function PiChargingStationLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChargingStationLight;
