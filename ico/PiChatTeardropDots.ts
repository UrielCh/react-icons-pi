...
/**
 * ChatTeardropDots icon from Phosphor Icons
 * @module
 */
export function PiChatTeardropDots(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatTeardropDots;
