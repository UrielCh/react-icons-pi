...
/**
 * IdentificationBadgeFill icon from Phosphor Icons
 * @module
 */
export function PiIdentificationBadgeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationBadgeFill;
