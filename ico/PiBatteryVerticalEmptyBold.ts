...
/**
 * BatteryVerticalEmptyBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalEmptyBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalEmptyBold;
