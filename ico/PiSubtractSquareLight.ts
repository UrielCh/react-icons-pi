...
/**
 * SubtractSquareLight icon from Phosphor Icons
 * @module
 */
export function PiSubtractSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSubtractSquareLight;
