...
/**
 * PencilCircleBold icon from Phosphor Icons
 * @module
 */
export function PiPencilCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilCircleBold;
