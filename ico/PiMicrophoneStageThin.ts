...
/**
 * MicrophoneStageThin icon from Phosphor Icons
 * @module
 */
export function PiMicrophoneStageThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrophoneStageThin;
