...
/**
 * WheelchairMotionLight icon from Phosphor Icons
 * @module
 */
export function PiWheelchairMotionLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWheelchairMotionLight;
