...
/**
 * MotorcycleDuotone icon from Phosphor Icons
 * @module
 */
export function PiMotorcycleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMotorcycleDuotone;
