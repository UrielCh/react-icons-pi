...
/**
 * BracketsAngleFill icon from Phosphor Icons
 * @module
 */
export function PiBracketsAngleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsAngleFill;
