...
/**
 * WarningDiamondBold icon from Phosphor Icons
 * @module
 */
export function PiWarningDiamondBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningDiamondBold;
