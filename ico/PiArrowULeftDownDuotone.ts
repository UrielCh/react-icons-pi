...
/**
 * ArrowULeftDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftDownDuotone;
