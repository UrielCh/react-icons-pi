...
/**
 * NumberSquareNineLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareNineLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareNineLight;
