...
/**
 * IdentificationCardThin icon from Phosphor Icons
 * @module
 */
export function PiIdentificationCardThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationCardThin;
