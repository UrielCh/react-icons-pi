...
/**
 * LightningSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiLightningSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightningSlashDuotone;
