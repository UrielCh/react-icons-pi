...
/**
 * DevToLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiDevToLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDevToLogoDuotone;
