...
/**
 * ArrowsInLineVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineVerticalThin;
