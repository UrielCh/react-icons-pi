...
/**
 * ArrowSquareOutLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareOutLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareOutLight;
