...
/**
 * CellSignalMedium icon from Phosphor Icons
 * @module
 */
export function PiCellSignalMedium(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalMedium;
