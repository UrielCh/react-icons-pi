...
/**
 * ArrowBendDoubleUpLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpLeftFill;
