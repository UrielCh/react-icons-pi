...
/**
 * TwitterLogoLight icon from Phosphor Icons
 * @module
 */
export function PiTwitterLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTwitterLogoLight;
