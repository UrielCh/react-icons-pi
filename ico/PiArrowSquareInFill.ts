...
/**
 * ArrowSquareInFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareInFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareInFill;
