...
/**
 * ImagesSquareThin icon from Phosphor Icons
 * @module
 */
export function PiImagesSquareThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiImagesSquareThin;
