...
/**
 * ArrowElbowRightDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightDownLight;
