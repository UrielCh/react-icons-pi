...
/**
 * CellSignalHighThin icon from Phosphor Icons
 * @module
 */
export function PiCellSignalHighThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalHighThin;
