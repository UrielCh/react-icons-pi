...
/**
 * PushPinSimpleSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleSlashDuotone;
