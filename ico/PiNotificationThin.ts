...
/**
 * NotificationThin icon from Phosphor Icons
 * @module
 */
export function PiNotificationThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNotificationThin;
