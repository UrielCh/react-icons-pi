...
/**
 * ArrowCircleRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleRightThin;
