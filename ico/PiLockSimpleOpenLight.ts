...
/**
 * LockSimpleOpenLight icon from Phosphor Icons
 * @module
 */
export function PiLockSimpleOpenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockSimpleOpenLight;
