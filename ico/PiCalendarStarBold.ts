...
/**
 * CalendarStarBold icon from Phosphor Icons
 * @module
 */
export function PiCalendarStarBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarStarBold;
