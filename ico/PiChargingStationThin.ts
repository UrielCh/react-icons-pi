...
/**
 * ChargingStationThin icon from Phosphor Icons
 * @module
 */
export function PiChargingStationThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChargingStationThin;
