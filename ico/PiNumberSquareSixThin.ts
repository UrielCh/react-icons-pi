...
/**
 * NumberSquareSixThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSixThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSixThin;
