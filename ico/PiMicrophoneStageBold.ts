...
/**
 * MicrophoneStageBold icon from Phosphor Icons
 * @module
 */
export function PiMicrophoneStageBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrophoneStageBold;
