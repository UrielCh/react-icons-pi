...
/**
 * ToggleRightLight icon from Phosphor Icons
 * @module
 */
export function PiToggleRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiToggleRightLight;
