...
/**
 * MagnifyingGlassMinusThin icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassMinusThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassMinusThin;
