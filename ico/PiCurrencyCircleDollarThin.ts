...
/**
 * CurrencyCircleDollarThin icon from Phosphor Icons
 * @module
 */
export function PiCurrencyCircleDollarThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyCircleDollarThin;
