...
/**
 * SidebarSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiSidebarSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSidebarSimpleThin;
