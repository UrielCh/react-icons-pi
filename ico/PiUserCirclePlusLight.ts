...
/**
 * UserCirclePlusLight icon from Phosphor Icons
 * @module
 */
export function PiUserCirclePlusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCirclePlusLight;
