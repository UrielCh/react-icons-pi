...
/**
 * TextAlignLeftLight icon from Phosphor Icons
 * @module
 */
export function PiTextAlignLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignLeftLight;
