...
/**
 * CurrencyRubLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyRubLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyRubLight;
