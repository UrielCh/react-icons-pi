...
/**
 * GraphicsCardThin icon from Phosphor Icons
 * @module
 */
export function PiGraphicsCardThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraphicsCardThin;
