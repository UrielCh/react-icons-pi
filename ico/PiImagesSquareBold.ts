...
/**
 * ImagesSquareBold icon from Phosphor Icons
 * @module
 */
export function PiImagesSquareBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiImagesSquareBold;
