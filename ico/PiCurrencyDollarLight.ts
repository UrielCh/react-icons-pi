...
/**
 * CurrencyDollarLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarLight;
