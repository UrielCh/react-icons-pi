...
/**
 * EnvelopeSimpleOpenBold icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleOpenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleOpenBold;
