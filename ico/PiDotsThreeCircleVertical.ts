...
/**
 * DotsThreeCircleVertical icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleVertical;
