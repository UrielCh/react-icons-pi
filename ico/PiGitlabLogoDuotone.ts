...
/**
 * GitlabLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoDuotone;
