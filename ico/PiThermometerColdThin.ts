...
/**
 * ThermometerColdThin icon from Phosphor Icons
 * @module
 */
export function PiThermometerColdThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerColdThin;
