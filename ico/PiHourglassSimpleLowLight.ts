...
/**
 * HourglassSimpleLowLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLowLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLowLight;
