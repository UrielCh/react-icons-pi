...
/**
 * SquareHalfBottomThin icon from Phosphor Icons
 * @module
 */
export function PiSquareHalfBottomThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareHalfBottomThin;
