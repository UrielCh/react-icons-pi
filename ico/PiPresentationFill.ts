...
/**
 * PresentationFill icon from Phosphor Icons
 * @module
 */
export function PiPresentationFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationFill;
