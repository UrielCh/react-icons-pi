...
/**
 * SelectionForegroundFill icon from Phosphor Icons
 * @module
 */
export function PiSelectionForegroundFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionForegroundFill;
