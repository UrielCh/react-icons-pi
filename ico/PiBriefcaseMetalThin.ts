...
/**
 * BriefcaseMetalThin icon from Phosphor Icons
 * @module
 */
export function PiBriefcaseMetalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBriefcaseMetalThin;
