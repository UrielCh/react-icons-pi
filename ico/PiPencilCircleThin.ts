...
/**
 * PencilCircleThin icon from Phosphor Icons
 * @module
 */
export function PiPencilCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilCircleThin;
