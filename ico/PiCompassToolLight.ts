...
/**
 * CompassToolLight icon from Phosphor Icons
 * @module
 */
export function PiCompassToolLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCompassToolLight;
