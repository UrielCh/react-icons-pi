...
/**
 * SteeringWheelLight icon from Phosphor Icons
 * @module
 */
export function PiSteeringWheelLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSteeringWheelLight;
