...
/**
 * MessengerLogoFill icon from Phosphor Icons
 * @module
 */
export function PiMessengerLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMessengerLogoFill;
