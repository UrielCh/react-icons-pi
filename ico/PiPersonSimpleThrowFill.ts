...
/**
 * PersonSimpleThrowFill icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThrowFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThrowFill;
