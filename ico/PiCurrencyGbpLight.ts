...
/**
 * CurrencyGbpLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyGbpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyGbpLight;
