...
/**
 * BriefcaseMetalFill icon from Phosphor Icons
 * @module
 */
export function PiBriefcaseMetalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBriefcaseMetalFill;
