...
/**
 * NumberCircleSixBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSixBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSixBold;
