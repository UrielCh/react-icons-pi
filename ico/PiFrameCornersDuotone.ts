...
/**
 * FrameCornersDuotone icon from Phosphor Icons
 * @module
 */
export function PiFrameCornersDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFrameCornersDuotone;
