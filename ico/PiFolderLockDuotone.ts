...
/**
 * FolderLockDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderLockDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderLockDuotone;
