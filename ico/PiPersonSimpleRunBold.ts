...
/**
 * PersonSimpleRunBold icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleRunBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleRunBold;
