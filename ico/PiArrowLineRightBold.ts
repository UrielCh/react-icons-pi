...
/**
 * ArrowLineRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowLineRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineRightBold;
