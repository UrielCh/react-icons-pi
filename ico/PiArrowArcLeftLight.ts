...
/**
 * ArrowArcLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowArcLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcLeftLight;
