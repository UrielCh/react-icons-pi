...
/**
 * ArrowLineRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowLineRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineRightThin;
