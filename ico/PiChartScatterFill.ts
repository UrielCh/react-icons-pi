...
/**
 * ChartScatterFill icon from Phosphor Icons
 * @module
 */
export function PiChartScatterFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartScatterFill;
