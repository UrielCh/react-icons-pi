...
/**
 * NumberSquareSevenThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSevenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSevenThin;
