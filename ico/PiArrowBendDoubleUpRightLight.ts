...
/**
 * ArrowBendDoubleUpRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpRightLight;
