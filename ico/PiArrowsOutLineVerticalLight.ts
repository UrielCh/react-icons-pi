...
/**
 * ArrowsOutLineVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineVerticalLight;
