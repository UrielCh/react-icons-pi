...
/**
 * BagSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiBagSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBagSimpleDuotone;
