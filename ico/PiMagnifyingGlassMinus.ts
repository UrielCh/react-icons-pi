...
/**
 * MagnifyingGlassMinus icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassMinus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassMinus;
