...
/**
 * HourglassMediumLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassMediumLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassMediumLight;
