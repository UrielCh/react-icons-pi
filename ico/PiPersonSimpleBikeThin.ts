...
/**
 * PersonSimpleBikeThin icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBikeThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBikeThin;
