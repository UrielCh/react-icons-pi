...
/**
 * PencilSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleBold;
