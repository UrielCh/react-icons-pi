...
/**
 * BracketsCurlyBold icon from Phosphor Icons
 * @module
 */
export function PiBracketsCurlyBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsCurlyBold;
