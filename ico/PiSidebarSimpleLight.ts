...
/**
 * SidebarSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiSidebarSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSidebarSimpleLight;
