...
/**
 * StarOfDavidLight icon from Phosphor Icons
 * @module
 */
export function PiStarOfDavidLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarOfDavidLight;
