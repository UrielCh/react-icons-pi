...
/**
 * BeerSteinDuotone icon from Phosphor Icons
 * @module
 */
export function PiBeerSteinDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBeerSteinDuotone;
