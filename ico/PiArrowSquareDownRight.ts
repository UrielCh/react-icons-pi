...
/**
 * ArrowSquareDownRight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownRight;
