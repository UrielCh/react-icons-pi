...
/**
 * CloudWarningFill icon from Phosphor Icons
 * @module
 */
export function PiCloudWarningFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudWarningFill;
