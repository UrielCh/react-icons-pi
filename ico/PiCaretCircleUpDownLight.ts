...
/**
 * CaretCircleUpDownLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpDownLight;
