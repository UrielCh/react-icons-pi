...
/**
 * NumberSquareFourLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFourLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFourLight;
