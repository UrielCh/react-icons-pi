...
/**
 * MoonStarsDuotone icon from Phosphor Icons
 * @module
 */
export function PiMoonStarsDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMoonStarsDuotone;
