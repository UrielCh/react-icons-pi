...
/**
 * HighlighterCircleBold icon from Phosphor Icons
 * @module
 */
export function PiHighlighterCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHighlighterCircleBold;
