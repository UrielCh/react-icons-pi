...
/**
 * ArrowCircleDownRight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownRight;
