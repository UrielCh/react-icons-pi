...
/**
 * ChartLineDownThin icon from Phosphor Icons
 * @module
 */
export function PiChartLineDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartLineDownThin;
