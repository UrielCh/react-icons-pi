...
/**
 * DotsThreeVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeVerticalBold;
