...
/**
 * ArrowBendDownLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownLeftThin;
