...
/**
 * ArrowsInCardinal icon from Phosphor Icons
 * @module
 */
export function PiArrowsInCardinal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInCardinal;
