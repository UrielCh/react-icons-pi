...
/**
 * LetterCircleVDuotone icon from Phosphor Icons
 * @module
 */
export function PiLetterCircleVDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLetterCircleVDuotone;
