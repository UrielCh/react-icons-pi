...
/**
 * ArrowsInLineHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineHorizontalFill;
