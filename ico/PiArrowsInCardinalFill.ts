...
/**
 * ArrowsInCardinalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsInCardinalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInCardinalFill;
