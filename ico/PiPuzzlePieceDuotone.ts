...
/**
 * PuzzlePieceDuotone icon from Phosphor Icons
 * @module
 */
export function PiPuzzlePieceDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPuzzlePieceDuotone;
