...
/**
 * ChatCircleDotsBold icon from Phosphor Icons
 * @module
 */
export function PiChatCircleDotsBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleDotsBold;
