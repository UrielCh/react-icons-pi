...
/**
 * WarningCircleLight icon from Phosphor Icons
 * @module
 */
export function PiWarningCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningCircleLight;
