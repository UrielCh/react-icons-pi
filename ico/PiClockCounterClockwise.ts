...
/**
 * ClockCounterClockwise icon from Phosphor Icons
 * @module
 */
export function PiClockCounterClockwise(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCounterClockwise;
