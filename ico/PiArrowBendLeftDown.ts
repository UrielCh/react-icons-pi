...
/**
 * ArrowBendLeftDown icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftDown;
