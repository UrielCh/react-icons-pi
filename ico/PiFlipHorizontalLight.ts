...
/**
 * FlipHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiFlipHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlipHorizontalLight;
