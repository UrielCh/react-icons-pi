...
/**
 * ClockClockwiseThin icon from Phosphor Icons
 * @module
 */
export function PiClockClockwiseThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockClockwiseThin;
