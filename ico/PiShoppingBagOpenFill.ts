...
/**
 * ShoppingBagOpenFill icon from Phosphor Icons
 * @module
 */
export function PiShoppingBagOpenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShoppingBagOpenFill;
