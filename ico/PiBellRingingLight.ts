...
/**
 * BellRingingLight icon from Phosphor Icons
 * @module
 */
export function PiBellRingingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellRingingLight;
