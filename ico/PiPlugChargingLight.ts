...
/**
 * PlugChargingLight icon from Phosphor Icons
 * @module
 */
export function PiPlugChargingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlugChargingLight;
