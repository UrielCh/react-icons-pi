...
/**
 * NumberSquareFiveThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFiveThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFiveThin;
