...
/**
 * ArrowDownRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowDownRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownRightThin;
