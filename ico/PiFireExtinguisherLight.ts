...
/**
 * FireExtinguisherLight icon from Phosphor Icons
 * @module
 */
export function PiFireExtinguisherLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireExtinguisherLight;
