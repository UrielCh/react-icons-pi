...
/**
 * ArrowFatLineLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineLeft;
