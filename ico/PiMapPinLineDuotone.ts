...
/**
 * MapPinLineDuotone icon from Phosphor Icons
 * @module
 */
export function PiMapPinLineDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMapPinLineDuotone;
