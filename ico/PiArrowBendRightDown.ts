...
/**
 * ArrowBendRightDown icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightDown;
