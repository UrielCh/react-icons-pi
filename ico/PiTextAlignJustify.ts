...
/**
 * TextAlignJustify icon from Phosphor Icons
 * @module
 */
export function PiTextAlignJustify(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignJustify;
