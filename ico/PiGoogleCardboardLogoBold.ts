...
/**
 * GoogleCardboardLogoBold icon from Phosphor Icons
 * @module
 */
export function PiGoogleCardboardLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleCardboardLogoBold;
