...
/**
 * CaretCircleRightThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleRightThin;
