...
/**
 * LightningADuotone icon from Phosphor Icons
 * @module
 */
export function PiLightningADuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightningADuotone;
