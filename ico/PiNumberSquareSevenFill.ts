...
/**
 * NumberSquareSevenFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSevenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSevenFill;
