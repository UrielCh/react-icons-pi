...
/**
 * AlignCenterVerticalSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalSimpleFill;
