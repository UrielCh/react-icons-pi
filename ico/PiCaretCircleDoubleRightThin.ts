...
/**
 * CaretCircleDoubleRightThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleRightThin;
