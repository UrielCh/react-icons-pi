...
/**
 * ListBulletsLight icon from Phosphor Icons
 * @module
 */
export function PiListBulletsLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListBulletsLight;
