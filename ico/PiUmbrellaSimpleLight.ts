...
/**
 * UmbrellaSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiUmbrellaSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUmbrellaSimpleLight;
