...
/**
 * ShoppingBagOpenBold icon from Phosphor Icons
 * @module
 */
export function PiShoppingBagOpenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShoppingBagOpenBold;
