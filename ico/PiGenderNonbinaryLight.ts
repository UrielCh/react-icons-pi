...
/**
 * GenderNonbinaryLight icon from Phosphor Icons
 * @module
 */
export function PiGenderNonbinaryLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNonbinaryLight;
