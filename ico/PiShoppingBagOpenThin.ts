...
/**
 * ShoppingBagOpenThin icon from Phosphor Icons
 * @module
 */
export function PiShoppingBagOpenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShoppingBagOpenThin;
