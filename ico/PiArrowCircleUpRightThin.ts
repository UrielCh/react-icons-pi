...
/**
 * ArrowCircleUpRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpRightThin;
