...
/**
 * NumberSquareEightFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareEightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareEightFill;
