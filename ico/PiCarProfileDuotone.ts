...
/**
 * CarProfileDuotone icon from Phosphor Icons
 * @module
 */
export function PiCarProfileDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCarProfileDuotone;
