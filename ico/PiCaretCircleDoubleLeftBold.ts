...
/**
 * CaretCircleDoubleLeftBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleLeftBold;
