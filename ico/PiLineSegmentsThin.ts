...
/**
 * LineSegmentsThin icon from Phosphor Icons
 * @module
 */
export function PiLineSegmentsThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLineSegmentsThin;
