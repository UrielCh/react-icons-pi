...
/**
 * HeartStraightThin icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightThin;
