...
/**
 * BookBookmarkThin icon from Phosphor Icons
 * @module
 */
export function PiBookBookmarkThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookBookmarkThin;
