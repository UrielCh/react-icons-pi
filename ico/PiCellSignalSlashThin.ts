...
/**
 * CellSignalSlashThin icon from Phosphor Icons
 * @module
 */
export function PiCellSignalSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalSlashThin;
