...
/**
 * ArrowFatLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLeftLight;
