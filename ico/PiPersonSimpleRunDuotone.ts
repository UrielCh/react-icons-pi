...
/**
 * PersonSimpleRunDuotone icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleRunDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleRunDuotone;
