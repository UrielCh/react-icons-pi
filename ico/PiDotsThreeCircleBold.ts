...
/**
 * DotsThreeCircleBold icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleBold;
