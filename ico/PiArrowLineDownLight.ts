...
/**
 * ArrowLineDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownLight;
