...
/**
 * CoinVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiCoinVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCoinVerticalLight;
