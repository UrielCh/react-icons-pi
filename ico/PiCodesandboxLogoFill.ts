...
/**
 * CodesandboxLogoFill icon from Phosphor Icons
 * @module
 */
export function PiCodesandboxLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodesandboxLogoFill;
