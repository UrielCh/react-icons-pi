...
/**
 * ArrowBendRightDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightDownBold;
