...
/**
 * AppStoreLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiAppStoreLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAppStoreLogoDuotone;
