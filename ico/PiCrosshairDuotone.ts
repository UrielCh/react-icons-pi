...
/**
 * CrosshairDuotone icon from Phosphor Icons
 * @module
 */
export function PiCrosshairDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCrosshairDuotone;
