...
/**
 * GlobeHemisphereWestThin icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereWestThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereWestThin;
