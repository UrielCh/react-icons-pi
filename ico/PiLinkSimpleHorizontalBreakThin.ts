...
/**
 * LinkSimpleHorizontalBreakThin icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalBreakThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalBreakThin;
