...
/**
 * MathOperationsBold icon from Phosphor Icons
 * @module
 */
export function PiMathOperationsBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMathOperationsBold;
