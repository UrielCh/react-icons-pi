...
/**
 * DeviceMobileCameraLight icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileCameraLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileCameraLight;
