...
/**
 * AlignCenterVerticalSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalSimpleLight;
