...
/**
 * GlobeHemisphereEastBold icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereEastBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereEastBold;
