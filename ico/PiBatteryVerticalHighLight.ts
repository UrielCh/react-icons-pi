...
/**
 * BatteryVerticalHighLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalHighLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalHighLight;
