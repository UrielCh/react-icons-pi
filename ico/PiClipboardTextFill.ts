...
/**
 * ClipboardTextFill icon from Phosphor Icons
 * @module
 */
export function PiClipboardTextFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClipboardTextFill;
