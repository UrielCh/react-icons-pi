...
/**
 * ArrowBendUpLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpLeftFill;
