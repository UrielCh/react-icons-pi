...
/**
 * ArrowSquareUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpThin;
