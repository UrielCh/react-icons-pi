...
/**
 * DotsThreeOutlineBold icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineBold;
