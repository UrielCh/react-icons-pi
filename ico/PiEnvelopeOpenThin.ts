...
/**
 * EnvelopeOpenThin icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeOpenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeOpenThin;
