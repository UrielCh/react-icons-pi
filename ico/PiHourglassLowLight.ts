...
/**
 * HourglassLowLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassLowLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassLowLight;
