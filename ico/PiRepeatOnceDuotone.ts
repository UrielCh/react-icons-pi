...
/**
 * RepeatOnceDuotone icon from Phosphor Icons
 * @module
 */
export function PiRepeatOnceDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRepeatOnceDuotone;
