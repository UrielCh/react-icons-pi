...
/**
 * ArrowULeftDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftDownLight;
