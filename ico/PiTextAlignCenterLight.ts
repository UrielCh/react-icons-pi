...
/**
 * TextAlignCenterLight icon from Phosphor Icons
 * @module
 */
export function PiTextAlignCenterLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignCenterLight;
