...
/**
 * FileMagnifyingGlassThin icon from Phosphor Icons
 * @module
 */
export function PiFileMagnifyingGlassThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileMagnifyingGlassThin;
