...
/**
 * ArrowURightDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowURightDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightDownFill;
