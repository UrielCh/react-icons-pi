...
/**
 * ChartLineDownLight icon from Phosphor Icons
 * @module
 */
export function PiChartLineDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartLineDownLight;
