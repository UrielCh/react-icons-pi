...
/**
 * PhoneTransferFill icon from Phosphor Icons
 * @module
 */
export function PiPhoneTransferFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneTransferFill;
