...
/**
 * ArrowCircleDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownBold;
