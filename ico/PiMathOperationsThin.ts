...
/**
 * MathOperationsThin icon from Phosphor Icons
 * @module
 */
export function PiMathOperationsThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMathOperationsThin;
