...
/**
 * RadioactiveDuotone icon from Phosphor Icons
 * @module
 */
export function PiRadioactiveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRadioactiveDuotone;
