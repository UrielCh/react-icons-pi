...
/**
 * ImagesSquareLight icon from Phosphor Icons
 * @module
 */
export function PiImagesSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiImagesSquareLight;
