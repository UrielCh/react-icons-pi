...
/**
 * FireSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiFireSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireSimpleDuotone;
