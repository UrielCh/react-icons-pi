...
/**
 * CurrencyEthDuotone icon from Phosphor Icons
 * @module
 */
export function PiCurrencyEthDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyEthDuotone;
