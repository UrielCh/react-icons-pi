...
/**
 * ArrowFatLineUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineUpThin;
