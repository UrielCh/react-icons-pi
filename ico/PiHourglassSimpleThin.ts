...
/**
 * HourglassSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleThin;
