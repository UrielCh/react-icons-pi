...
/**
 * LinkSimpleHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalThin;
