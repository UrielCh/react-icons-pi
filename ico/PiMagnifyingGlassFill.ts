...
/**
 * MagnifyingGlassFill icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassFill;
