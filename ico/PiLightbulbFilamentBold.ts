...
/**
 * LightbulbFilamentBold icon from Phosphor Icons
 * @module
 */
export function PiLightbulbFilamentBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightbulbFilamentBold;
