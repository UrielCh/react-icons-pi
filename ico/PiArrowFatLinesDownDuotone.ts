...
/**
 * ArrowFatLinesDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesDownDuotone;
