...
/**
 * ArrowLineUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpRightBold;
