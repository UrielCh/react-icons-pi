...
/**
 * PencilSimpleLine icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleLine(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleLine;
