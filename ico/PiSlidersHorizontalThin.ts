...
/**
 * SlidersHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiSlidersHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSlidersHorizontalThin;
