...
/**
 * CoinVerticalDuotone icon from Phosphor Icons
 * @module
 */
export function PiCoinVerticalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCoinVerticalDuotone;
