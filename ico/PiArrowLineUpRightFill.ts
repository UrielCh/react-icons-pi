...
/**
 * ArrowLineUpRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpRightFill;
