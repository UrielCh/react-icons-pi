...
/**
 * NewspaperClippingBold icon from Phosphor Icons
 * @module
 */
export function PiNewspaperClippingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNewspaperClippingBold;
