...
/**
 * PaperclipHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiPaperclipHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipHorizontalFill;
