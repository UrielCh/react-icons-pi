...
/**
 * RowsPlusBottomFill icon from Phosphor Icons
 * @module
 */
export function PiRowsPlusBottomFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRowsPlusBottomFill;
