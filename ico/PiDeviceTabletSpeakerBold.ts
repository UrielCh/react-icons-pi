...
/**
 * DeviceTabletSpeakerBold icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletSpeakerBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletSpeakerBold;
