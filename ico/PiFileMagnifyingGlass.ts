...
/**
 * FileMagnifyingGlass icon from Phosphor Icons
 * @module
 */
export function PiFileMagnifyingGlass(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileMagnifyingGlass;
