...
/**
 * DeviceTabletSpeaker icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletSpeaker(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletSpeaker;
