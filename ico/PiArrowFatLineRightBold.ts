...
/**
 * ArrowFatLineRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineRightBold;
