...
/**
 * VideoCameraLight icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraLight;
