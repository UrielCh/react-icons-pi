...
/**
 * ArrowCircleUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpFill;
