...
/**
 * PersonSimpleCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleCircleDuotone;
