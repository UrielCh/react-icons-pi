...
/**
 * GraphicsCardLight icon from Phosphor Icons
 * @module
 */
export function PiGraphicsCardLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraphicsCardLight;
