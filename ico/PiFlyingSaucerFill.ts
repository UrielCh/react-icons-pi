...
/**
 * FlyingSaucerFill icon from Phosphor Icons
 * @module
 */
export function PiFlyingSaucerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlyingSaucerFill;
