...
/**
 * NumberCircleTwoFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleTwoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleTwoFill;
