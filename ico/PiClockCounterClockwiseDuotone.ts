...
/**
 * ClockCounterClockwiseDuotone icon from Phosphor Icons
 * @module
 */
export function PiClockCounterClockwiseDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCounterClockwiseDuotone;
