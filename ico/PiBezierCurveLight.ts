...
/**
 * BezierCurveLight icon from Phosphor Icons
 * @module
 */
export function PiBezierCurveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBezierCurveLight;
