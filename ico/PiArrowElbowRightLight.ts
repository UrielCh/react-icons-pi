...
/**
 * ArrowElbowRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightLight;
