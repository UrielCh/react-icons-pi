...
/**
 * HourglassSimpleHighDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleHighDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleHighDuotone;
