...
/**
 * ArrowClockwiseBold icon from Phosphor Icons
 * @module
 */
export function PiArrowClockwiseBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowClockwiseBold;
