...
/**
 * MicrosoftExcelLogoFill icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftExcelLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftExcelLogoFill;
