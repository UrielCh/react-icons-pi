...
/**
 * LinkSimpleBreakThin icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleBreakThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleBreakThin;
