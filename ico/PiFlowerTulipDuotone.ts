...
/**
 * FlowerTulipDuotone icon from Phosphor Icons
 * @module
 */
export function PiFlowerTulipDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlowerTulipDuotone;
