...
/**
 * AlignCenterHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalBold;
