...
/**
 * SelectionInverseLight icon from Phosphor Icons
 * @module
 */
export function PiSelectionInverseLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionInverseLight;
