...
/**
 * CaretCircleDoubleRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleRightDuotone;
