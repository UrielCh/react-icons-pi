...
/**
 * VolleyballDuotone icon from Phosphor Icons
 * @module
 */
export function PiVolleyballDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVolleyballDuotone;
