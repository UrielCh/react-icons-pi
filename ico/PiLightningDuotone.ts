...
/**
 * LightningDuotone icon from Phosphor Icons
 * @module
 */
export function PiLightningDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightningDuotone;
