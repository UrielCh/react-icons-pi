...
/**
 * AlignTopSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignTopSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignTopSimpleDuotone;
