...
/**
 * SquareLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiSquareLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareLogoDuotone;
