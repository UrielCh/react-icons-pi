...
/**
 * BatteryVerticalFullFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalFullFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalFullFill;
