...
/**
 * ArrowUUpRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpRightThin;
