...
/**
 * HeartStraightBreak icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightBreak(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightBreak;
