...
/**
 * ArrowFatLinesUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesUpThin;
