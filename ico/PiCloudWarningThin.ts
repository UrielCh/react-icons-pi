...
/**
 * CloudWarningThin icon from Phosphor Icons
 * @module
 */
export function PiCloudWarningThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudWarningThin;
