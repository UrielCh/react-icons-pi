...
/**
 * NewspaperClippingLight icon from Phosphor Icons
 * @module
 */
export function PiNewspaperClippingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNewspaperClippingLight;
