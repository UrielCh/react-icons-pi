...
/**
 * NumberSquareFiveBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFiveBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFiveBold;
