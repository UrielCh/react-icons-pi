...
/**
 * ArrowsInSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsInSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInSimpleLight;
