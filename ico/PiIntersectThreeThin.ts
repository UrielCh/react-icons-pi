...
/**
 * IntersectThreeThin icon from Phosphor Icons
 * @module
 */
export function PiIntersectThreeThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectThreeThin;
