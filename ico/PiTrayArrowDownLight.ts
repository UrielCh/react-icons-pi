...
/**
 * TrayArrowDownLight icon from Phosphor Icons
 * @module
 */
export function PiTrayArrowDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrayArrowDownLight;
