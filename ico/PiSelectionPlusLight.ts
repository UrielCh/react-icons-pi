...
/**
 * SelectionPlusLight icon from Phosphor Icons
 * @module
 */
export function PiSelectionPlusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionPlusLight;
