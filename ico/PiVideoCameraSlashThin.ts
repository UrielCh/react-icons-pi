...
/**
 * VideoCameraSlashThin icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraSlashThin;
