...
/**
 * PencilSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleDuotone;
