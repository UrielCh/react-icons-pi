...
/**
 * ContactlessPaymentBold icon from Phosphor Icons
 * @module
 */
export function PiContactlessPaymentBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiContactlessPaymentBold;
