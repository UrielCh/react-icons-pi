...
/**
 * NumberCircleEightFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleEightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleEightFill;
