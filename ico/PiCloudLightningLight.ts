...
/**
 * CloudLightningLight icon from Phosphor Icons
 * @module
 */
export function PiCloudLightningLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudLightningLight;
