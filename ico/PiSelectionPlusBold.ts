...
/**
 * SelectionPlusBold icon from Phosphor Icons
 * @module
 */
export function PiSelectionPlusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionPlusBold;
