...
/**
 * CurrencyKrwLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyKrwLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyKrwLight;
