...
/**
 * GoogleChromeLogoFill icon from Phosphor Icons
 * @module
 */
export function PiGoogleChromeLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleChromeLogoFill;
