...
/**
 * ArrowCircleDownLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLeftLight;
