...
/**
 * CaretDoubleLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleLeftDuotone;
