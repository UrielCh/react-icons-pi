...
/**
 * RainbowCloudThin icon from Phosphor Icons
 * @module
 */
export function PiRainbowCloudThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRainbowCloudThin;
