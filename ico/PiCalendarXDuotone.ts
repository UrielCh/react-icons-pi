...
/**
 * CalendarXDuotone icon from Phosphor Icons
 * @module
 */
export function PiCalendarXDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarXDuotone;
