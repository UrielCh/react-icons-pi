...
/**
 * FileArrowUpLight icon from Phosphor Icons
 * @module
 */
export function PiFileArrowUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileArrowUpLight;
