...
/**
 * FolderSimpleUserBold icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleUserBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleUserBold;
