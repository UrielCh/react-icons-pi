...
/**
 * FireExtinguisherFill icon from Phosphor Icons
 * @module
 */
export function PiFireExtinguisherFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireExtinguisherFill;
