...
/**
 * SelectionForeground icon from Phosphor Icons
 * @module
 */
export function PiSelectionForeground(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionForeground;
