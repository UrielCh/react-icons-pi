...
/**
 * MicrosoftExcelLogo icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftExcelLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftExcelLogo;
