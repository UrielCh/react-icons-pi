...
/**
 * BatteryEmptyFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryEmptyFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryEmptyFill;
