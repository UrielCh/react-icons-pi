...
/**
 * CurrencyDollarSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarSimpleLight;
