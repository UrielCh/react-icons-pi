...
/**
 * ChatCircleTextBold icon from Phosphor Icons
 * @module
 */
export function PiChatCircleTextBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleTextBold;
