...
/**
 * ChargingStationFill icon from Phosphor Icons
 * @module
 */
export function PiChargingStationFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChargingStationFill;
