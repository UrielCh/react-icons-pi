...
/**
 * HourglassSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleFill;
