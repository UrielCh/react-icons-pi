...
/**
 * FolderSimpleLockThin icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleLockThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleLockThin;
