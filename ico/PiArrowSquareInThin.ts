...
/**
 * ArrowSquareInThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareInThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareInThin;
