...
/**
 * HourglassSimpleLowDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLowDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLowDuotone;
