...
/**
 * CameraRotateFill icon from Phosphor Icons
 * @module
 */
export function PiCameraRotateFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraRotateFill;
