...
/**
 * ShareNetworkThin icon from Phosphor Icons
 * @module
 */
export function PiShareNetworkThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShareNetworkThin;
