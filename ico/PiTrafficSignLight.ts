...
/**
 * TrafficSignLight icon from Phosphor Icons
 * @module
 */
export function PiTrafficSignLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficSignLight;
