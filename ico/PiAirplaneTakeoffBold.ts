...
/**
 * AirplaneTakeoffBold icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTakeoffBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTakeoffBold;
