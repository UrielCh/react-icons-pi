...
/**
 * UmbrellaSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiUmbrellaSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUmbrellaSimpleFill;
