...
/**
 * BellSimpleZLight icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleZLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleZLight;
