...
/**
 * BracketsSquareThin icon from Phosphor Icons
 * @module
 */
export function PiBracketsSquareThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsSquareThin;
