...
/**
 * VinylRecordDuotone icon from Phosphor Icons
 * @module
 */
export function PiVinylRecordDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVinylRecordDuotone;
