...
/**
 * NumberCircleFourLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFourLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFourLight;
