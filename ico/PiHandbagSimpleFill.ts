...
/**
 * HandbagSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiHandbagSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandbagSimpleFill;
