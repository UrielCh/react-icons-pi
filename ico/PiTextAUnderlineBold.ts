...
/**
 * TextAUnderlineBold icon from Phosphor Icons
 * @module
 */
export function PiTextAUnderlineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAUnderlineBold;
