...
/**
 * OrangeSliceLight icon from Phosphor Icons
 * @module
 */
export function PiOrangeSliceLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiOrangeSliceLight;
