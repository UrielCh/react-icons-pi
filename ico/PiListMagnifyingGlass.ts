...
/**
 * ListMagnifyingGlass icon from Phosphor Icons
 * @module
 */
export function PiListMagnifyingGlass(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListMagnifyingGlass;
