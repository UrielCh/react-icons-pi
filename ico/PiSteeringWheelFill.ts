...
/**
 * SteeringWheelFill icon from Phosphor Icons
 * @module
 */
export function PiSteeringWheelFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSteeringWheelFill;
