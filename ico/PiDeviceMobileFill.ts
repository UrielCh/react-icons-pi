...
/**
 * DeviceMobileFill icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileFill;
