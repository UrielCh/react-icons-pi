...
/**
 * FolderSimpleUserThin icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleUserThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleUserThin;
