...
/**
 * SpotifyLogoLight icon from Phosphor Icons
 * @module
 */
export function PiSpotifyLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpotifyLogoLight;
