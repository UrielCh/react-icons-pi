...
/**
 * NumberCircleThreeDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleThreeDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleThreeDuotone;
