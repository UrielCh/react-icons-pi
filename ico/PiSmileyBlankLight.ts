...
/**
 * SmileyBlankLight icon from Phosphor Icons
 * @module
 */
export function PiSmileyBlankLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyBlankLight;
