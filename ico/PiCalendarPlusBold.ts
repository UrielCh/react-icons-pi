...
/**
 * CalendarPlusBold icon from Phosphor Icons
 * @module
 */
export function PiCalendarPlusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarPlusBold;
