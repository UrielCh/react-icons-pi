...
/**
 * ArrowsOutCardinalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutCardinalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutCardinalFill;
