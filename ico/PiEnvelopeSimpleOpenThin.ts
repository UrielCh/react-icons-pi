...
/**
 * EnvelopeSimpleOpenThin icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleOpenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleOpenThin;
