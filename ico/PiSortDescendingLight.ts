...
/**
 * SortDescendingLight icon from Phosphor Icons
 * @module
 */
export function PiSortDescendingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSortDescendingLight;
