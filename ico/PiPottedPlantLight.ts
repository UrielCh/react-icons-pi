...
/**
 * PottedPlantLight icon from Phosphor Icons
 * @module
 */
export function PiPottedPlantLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPottedPlantLight;
