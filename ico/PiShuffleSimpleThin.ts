...
/**
 * ShuffleSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiShuffleSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShuffleSimpleThin;
