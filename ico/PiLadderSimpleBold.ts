...
/**
 * LadderSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiLadderSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLadderSimpleBold;
