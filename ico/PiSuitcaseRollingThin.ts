...
/**
 * SuitcaseRollingThin icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseRollingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseRollingThin;
