...
/**
 * ArrowElbowUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowUpLeftLight;
