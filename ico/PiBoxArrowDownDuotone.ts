...
/**
 * BoxArrowDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiBoxArrowDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoxArrowDownDuotone;
