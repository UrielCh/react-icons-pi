...
/**
 * SquareSplitHorizontal icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitHorizontal;
