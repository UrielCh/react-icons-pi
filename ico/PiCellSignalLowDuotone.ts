...
/**
 * CellSignalLowDuotone icon from Phosphor Icons
 * @module
 */
export function PiCellSignalLowDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalLowDuotone;
