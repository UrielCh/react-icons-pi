...
/**
 * WheelchairMotionThin icon from Phosphor Icons
 * @module
 */
export function PiWheelchairMotionThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWheelchairMotionThin;
