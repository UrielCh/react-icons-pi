...
/**
 * NumberSquareSevenLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSevenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSevenLight;
