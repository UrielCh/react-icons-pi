...
/**
 * ArrowBendDoubleUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpRightBold;
