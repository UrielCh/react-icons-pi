...
/**
 * BatteryPlusDuotone icon from Phosphor Icons
 * @module
 */
export function PiBatteryPlusDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryPlusDuotone;
