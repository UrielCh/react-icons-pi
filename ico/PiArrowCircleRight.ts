...
/**
 * ArrowCircleRight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleRight;
