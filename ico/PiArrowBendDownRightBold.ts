...
/**
 * ArrowBendDownRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownRightBold;
