...
/**
 * GenderIntersexThin icon from Phosphor Icons
 * @module
 */
export function PiGenderIntersexThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderIntersexThin;
