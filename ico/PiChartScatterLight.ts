...
/**
 * ChartScatterLight icon from Phosphor Icons
 * @module
 */
export function PiChartScatterLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartScatterLight;
