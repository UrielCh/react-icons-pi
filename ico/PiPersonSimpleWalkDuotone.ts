...
/**
 * PersonSimpleWalkDuotone icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleWalkDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleWalkDuotone;
