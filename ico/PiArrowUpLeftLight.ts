...
/**
 * ArrowUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUpLeftLight;
