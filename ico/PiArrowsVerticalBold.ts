...
/**
 * ArrowsVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsVerticalBold;
