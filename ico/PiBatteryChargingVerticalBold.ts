...
/**
 * BatteryChargingVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingVerticalBold;
