...
/**
 * SkipBackCircleThin icon from Phosphor Icons
 * @module
 */
export function PiSkipBackCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipBackCircleThin;
