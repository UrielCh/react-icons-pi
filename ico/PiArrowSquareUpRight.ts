...
/**
 * ArrowSquareUpRight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpRight;
