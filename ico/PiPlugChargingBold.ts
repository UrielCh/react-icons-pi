...
/**
 * PlugChargingBold icon from Phosphor Icons
 * @module
 */
export function PiPlugChargingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlugChargingBold;
