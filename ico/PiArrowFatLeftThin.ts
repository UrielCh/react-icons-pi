...
/**
 * ArrowFatLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLeftThin;
