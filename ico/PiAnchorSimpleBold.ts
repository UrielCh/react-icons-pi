...
/**
 * AnchorSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAnchorSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAnchorSimpleBold;
