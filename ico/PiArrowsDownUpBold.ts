...
/**
 * ArrowsDownUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsDownUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsDownUpBold;
