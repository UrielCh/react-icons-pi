...
/**
 * NewspaperClippingThin icon from Phosphor Icons
 * @module
 */
export function PiNewspaperClippingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNewspaperClippingThin;
