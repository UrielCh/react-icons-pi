...
/**
 * AsteriskSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAsteriskSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAsteriskSimpleThin;
