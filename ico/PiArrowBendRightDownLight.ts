...
/**
 * ArrowBendRightDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightDownLight;
