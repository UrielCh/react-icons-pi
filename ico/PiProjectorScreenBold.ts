...
/**
 * ProjectorScreenBold icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenBold;
