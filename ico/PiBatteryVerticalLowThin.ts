...
/**
 * BatteryVerticalLowThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalLowThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalLowThin;
