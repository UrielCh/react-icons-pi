...
/**
 * CellSignalLowThin icon from Phosphor Icons
 * @module
 */
export function PiCellSignalLowThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalLowThin;
