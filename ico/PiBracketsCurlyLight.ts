...
/**
 * BracketsCurlyLight icon from Phosphor Icons
 * @module
 */
export function PiBracketsCurlyLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsCurlyLight;
