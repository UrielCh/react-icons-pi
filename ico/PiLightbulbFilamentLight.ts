...
/**
 * LightbulbFilamentLight icon from Phosphor Icons
 * @module
 */
export function PiLightbulbFilamentLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightbulbFilamentLight;
