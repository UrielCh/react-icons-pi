...
/**
 * DeviceTabletCameraLight icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletCameraLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletCameraLight;
