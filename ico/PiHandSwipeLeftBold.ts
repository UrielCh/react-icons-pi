...
/**
 * HandSwipeLeftBold icon from Phosphor Icons
 * @module
 */
export function PiHandSwipeLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandSwipeLeftBold;
