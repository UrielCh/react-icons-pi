...
/**
 * SelectionBackgroundDuotone icon from Phosphor Icons
 * @module
 */
export function PiSelectionBackgroundDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionBackgroundDuotone;
