...
/**
 * ClipboardTextLight icon from Phosphor Icons
 * @module
 */
export function PiClipboardTextLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClipboardTextLight;
