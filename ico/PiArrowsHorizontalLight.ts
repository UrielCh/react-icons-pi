...
/**
 * ArrowsHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsHorizontalLight;
