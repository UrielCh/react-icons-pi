...
/**
 * ArrowCircleDownRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownRightThin;
