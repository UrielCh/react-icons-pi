...
/**
 * HourglassMediumDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassMediumDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassMediumDuotone;
