...
/**
 * ArrowBendDoubleUpLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpLeftThin;
