...
/**
 * MicrosoftPowerpointLogoThin icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftPowerpointLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftPowerpointLogoThin;
