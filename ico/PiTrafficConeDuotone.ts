...
/**
 * TrafficConeDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrafficConeDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficConeDuotone;
