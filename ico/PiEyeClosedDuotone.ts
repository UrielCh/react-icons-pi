...
/**
 * EyeClosedDuotone icon from Phosphor Icons
 * @module
 */
export function PiEyeClosedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyeClosedDuotone;
