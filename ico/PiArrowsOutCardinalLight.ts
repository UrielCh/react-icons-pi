...
/**
 * ArrowsOutCardinalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutCardinalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutCardinalLight;
