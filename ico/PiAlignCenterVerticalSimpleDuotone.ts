...
/**
 * AlignCenterVerticalSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalSimpleDuotone;
