...
/**
 * CellSignalNoneFill icon from Phosphor Icons
 * @module
 */
export function PiCellSignalNoneFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalNoneFill;
