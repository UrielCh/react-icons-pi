...
/**
 * CirclesThreePlusBold icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreePlusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreePlusBold;
