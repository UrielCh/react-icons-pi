...
/**
 * CircleHalfTiltFill icon from Phosphor Icons
 * @module
 */
export function PiCircleHalfTiltFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleHalfTiltFill;
