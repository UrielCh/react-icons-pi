...
/**
 * ArrowDownLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowDownLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownLeftDuotone;
