...
/**
 * ListNumbersLight icon from Phosphor Icons
 * @module
 */
export function PiListNumbersLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListNumbersLight;
