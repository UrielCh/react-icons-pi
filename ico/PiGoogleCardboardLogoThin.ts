...
/**
 * GoogleCardboardLogoThin icon from Phosphor Icons
 * @module
 */
export function PiGoogleCardboardLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleCardboardLogoThin;
