...
/**
 * SkipForwardCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardCircleDuotone;
