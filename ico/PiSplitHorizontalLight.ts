...
/**
 * SplitHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiSplitHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitHorizontalLight;
