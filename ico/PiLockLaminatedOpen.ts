...
/**
 * LockLaminatedOpen icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedOpen(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedOpen;
