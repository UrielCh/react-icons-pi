...
/**
 * ArrowSquareOutBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareOutBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareOutBold;
