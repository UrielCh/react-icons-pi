...
/**
 * FolderSimpleDashed icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleDashed(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleDashed;
