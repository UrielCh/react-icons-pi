...
/**
 * CurrencyDollarThin icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarThin;
