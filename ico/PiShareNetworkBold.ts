...
/**
 * ShareNetworkBold icon from Phosphor Icons
 * @module
 */
export function PiShareNetworkBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShareNetworkBold;
