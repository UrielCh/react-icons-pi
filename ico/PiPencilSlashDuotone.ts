...
/**
 * PencilSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiPencilSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSlashDuotone;
