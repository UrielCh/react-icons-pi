...
/**
 * LockSimpleOpenThin icon from Phosphor Icons
 * @module
 */
export function PiLockSimpleOpenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockSimpleOpenThin;
