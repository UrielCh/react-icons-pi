...
/**
 * ArrowBendRightDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightDownFill;
