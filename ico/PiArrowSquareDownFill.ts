...
/**
 * ArrowSquareDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownFill;
