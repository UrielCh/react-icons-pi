...
/**
 * CaretCircleDownBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDownBold;
