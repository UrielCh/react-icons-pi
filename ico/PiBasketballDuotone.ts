...
/**
 * BasketballDuotone icon from Phosphor Icons
 * @module
 */
export function PiBasketballDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBasketballDuotone;
