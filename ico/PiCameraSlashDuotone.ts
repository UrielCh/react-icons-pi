...
/**
 * CameraSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiCameraSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraSlashDuotone;
