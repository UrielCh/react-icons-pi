...
/**
 * WaveSawtoothThin icon from Phosphor Icons
 * @module
 */
export function PiWaveSawtoothThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWaveSawtoothThin;
