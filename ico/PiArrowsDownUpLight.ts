...
/**
 * ArrowsDownUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsDownUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsDownUpLight;
