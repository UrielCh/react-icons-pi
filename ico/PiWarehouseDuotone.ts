...
/**
 * WarehouseDuotone icon from Phosphor Icons
 * @module
 */
export function PiWarehouseDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarehouseDuotone;
