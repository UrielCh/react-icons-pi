...
/**
 * PersonSimpleBike icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBike(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBike;
