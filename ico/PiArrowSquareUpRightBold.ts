...
/**
 * ArrowSquareUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpRightBold;
