...
/**
 * ArrowSquareOutThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareOutThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareOutThin;
