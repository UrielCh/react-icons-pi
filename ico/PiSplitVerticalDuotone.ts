...
/**
 * SplitVerticalDuotone icon from Phosphor Icons
 * @module
 */
export function PiSplitVerticalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitVerticalDuotone;
