...
/**
 * SidebarSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiSidebarSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSidebarSimpleDuotone;
