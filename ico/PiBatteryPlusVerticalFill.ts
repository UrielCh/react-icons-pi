...
/**
 * BatteryPlusVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryPlusVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryPlusVerticalFill;
