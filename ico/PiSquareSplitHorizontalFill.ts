...
/**
 * SquareSplitHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitHorizontalFill;
