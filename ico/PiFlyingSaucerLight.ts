...
/**
 * FlyingSaucerLight icon from Phosphor Icons
 * @module
 */
export function PiFlyingSaucerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFlyingSaucerLight;
