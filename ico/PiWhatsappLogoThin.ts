...
/**
 * WhatsappLogoThin icon from Phosphor Icons
 * @module
 */
export function PiWhatsappLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWhatsappLogoThin;
