...
/**
 * GenderNeuterFill icon from Phosphor Icons
 * @module
 */
export function PiGenderNeuterFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNeuterFill;
