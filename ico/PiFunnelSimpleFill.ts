...
/**
 * FunnelSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiFunnelSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFunnelSimpleFill;
