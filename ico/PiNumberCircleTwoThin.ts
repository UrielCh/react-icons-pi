...
/**
 * NumberCircleTwoThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleTwoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleTwoThin;
