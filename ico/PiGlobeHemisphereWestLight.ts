...
/**
 * GlobeHemisphereWestLight icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereWestLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereWestLight;
