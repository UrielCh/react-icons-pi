...
/**
 * ArrowBendDoubleUpRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpRightDuotone;
