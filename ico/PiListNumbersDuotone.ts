...
/**
 * ListNumbersDuotone icon from Phosphor Icons
 * @module
 */
export function PiListNumbersDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListNumbersDuotone;
