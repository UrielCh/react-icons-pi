...
/**
 * NumberSquareTwoFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareTwoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareTwoFill;
