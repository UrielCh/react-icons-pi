...
/**
 * ChatCircleDotsThin icon from Phosphor Icons
 * @module
 */
export function PiChatCircleDotsThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleDotsThin;
