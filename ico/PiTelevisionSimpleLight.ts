...
/**
 * TelevisionSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiTelevisionSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTelevisionSimpleLight;
