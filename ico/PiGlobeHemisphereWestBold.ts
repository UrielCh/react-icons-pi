...
/**
 * GlobeHemisphereWestBold icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereWestBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereWestBold;
