...
/**
 * FolderSimpleUserLight icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleUserLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleUserLight;
