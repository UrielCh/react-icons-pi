...
/**
 * HardDrivesDuotone icon from Phosphor Icons
 * @module
 */
export function PiHardDrivesDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHardDrivesDuotone;
