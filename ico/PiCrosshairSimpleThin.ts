...
/**
 * CrosshairSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiCrosshairSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCrosshairSimpleThin;
