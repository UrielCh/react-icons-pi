...
/**
 * ArrowLineUpRight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpRight;
