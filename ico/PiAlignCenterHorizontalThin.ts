...
/**
 * AlignCenterHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalThin;
