...
/**
 * ImagesSquareDuotone icon from Phosphor Icons
 * @module
 */
export function PiImagesSquareDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiImagesSquareDuotone;
