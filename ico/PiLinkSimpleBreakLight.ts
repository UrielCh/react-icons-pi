...
/**
 * LinkSimpleBreakLight icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleBreakLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleBreakLight;
