...
/**
 * CaretDoubleLeftFill icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleLeftFill;
