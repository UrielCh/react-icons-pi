...
/**
 * PersonSimpleBikeLight icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBikeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBikeLight;
