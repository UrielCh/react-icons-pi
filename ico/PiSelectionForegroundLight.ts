...
/**
 * SelectionForegroundLight icon from Phosphor Icons
 * @module
 */
export function PiSelectionForegroundLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionForegroundLight;
