...
/**
 * ChatCircleDotsDuotone icon from Phosphor Icons
 * @module
 */
export function PiChatCircleDotsDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleDotsDuotone;
