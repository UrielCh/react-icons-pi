...
/**
 * WaveSawtoothFill icon from Phosphor Icons
 * @module
 */
export function PiWaveSawtoothFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWaveSawtoothFill;
