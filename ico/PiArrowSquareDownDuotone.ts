...
/**
 * ArrowSquareDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownDuotone;
