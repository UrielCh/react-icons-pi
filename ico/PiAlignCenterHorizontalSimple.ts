...
/**
 * AlignCenterHorizontalSimple icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalSimple;
