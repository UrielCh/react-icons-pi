...
/**
 * LockLaminatedOpenDuotone icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedOpenDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedOpenDuotone;
