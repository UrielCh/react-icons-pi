...
/**
 * DeviceMobileSpeaker icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileSpeaker(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileSpeaker;
