...
/**
 * HighlighterCircleFill icon from Phosphor Icons
 * @module
 */
export function PiHighlighterCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHighlighterCircleFill;
