...
/**
 * CirclesThreePlusLight icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreePlusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreePlusLight;
