...
/**
 * GooglePhotosLogoThin icon from Phosphor Icons
 * @module
 */
export function PiGooglePhotosLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePhotosLogoThin;
