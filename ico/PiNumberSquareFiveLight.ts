...
/**
 * NumberSquareFiveLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFiveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFiveLight;
