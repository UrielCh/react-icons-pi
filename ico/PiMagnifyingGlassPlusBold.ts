...
/**
 * MagnifyingGlassPlusBold icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassPlusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassPlusBold;
