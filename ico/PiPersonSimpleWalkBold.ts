...
/**
 * PersonSimpleWalkBold icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleWalkBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleWalkBold;
