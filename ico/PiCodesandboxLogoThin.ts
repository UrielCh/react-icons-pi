...
/**
 * CodesandboxLogoThin icon from Phosphor Icons
 * @module
 */
export function PiCodesandboxLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodesandboxLogoThin;
