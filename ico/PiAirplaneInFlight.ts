...
/**
 * AirplaneInFlight icon from Phosphor Icons
 * @module
 */
export function PiAirplaneInFlight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneInFlight;
