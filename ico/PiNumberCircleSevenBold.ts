...
/**
 * NumberCircleSevenBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSevenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSevenBold;
