...
/**
 * PaintBrushBroadFill icon from Phosphor Icons
 * @module
 */
export function PiPaintBrushBroadFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaintBrushBroadFill;
