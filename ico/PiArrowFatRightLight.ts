...
/**
 * ArrowFatRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatRightLight;
