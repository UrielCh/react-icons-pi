...
/**
 * FolderSimpleDashedThin icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleDashedThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleDashedThin;
