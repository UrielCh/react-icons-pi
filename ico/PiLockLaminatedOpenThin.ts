...
/**
 * LockLaminatedOpenThin icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedOpenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedOpenThin;
