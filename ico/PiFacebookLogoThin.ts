...
/**
 * FacebookLogoThin icon from Phosphor Icons
 * @module
 */
export function PiFacebookLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFacebookLogoThin;
