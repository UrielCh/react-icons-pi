...
/**
 * UsersThreeDuotone icon from Phosphor Icons
 * @module
 */
export function PiUsersThreeDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUsersThreeDuotone;
