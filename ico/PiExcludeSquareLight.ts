...
/**
 * ExcludeSquareLight icon from Phosphor Icons
 * @module
 */
export function PiExcludeSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiExcludeSquareLight;
