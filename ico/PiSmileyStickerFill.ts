...
/**
 * SmileyStickerFill icon from Phosphor Icons
 * @module
 */
export function PiSmileyStickerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyStickerFill;
