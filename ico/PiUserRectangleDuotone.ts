...
/**
 * UserRectangleDuotone icon from Phosphor Icons
 * @module
 */
export function PiUserRectangleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserRectangleDuotone;
