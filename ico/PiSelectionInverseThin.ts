...
/**
 * SelectionInverseThin icon from Phosphor Icons
 * @module
 */
export function PiSelectionInverseThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionInverseThin;
