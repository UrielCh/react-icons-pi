...
/**
 * CopyrightDuotone icon from Phosphor Icons
 * @module
 */
export function PiCopyrightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCopyrightDuotone;
