...
/**
 * CameraSlashLight icon from Phosphor Icons
 * @module
 */
export function PiCameraSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraSlashLight;
