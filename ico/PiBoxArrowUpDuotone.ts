...
/**
 * BoxArrowUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiBoxArrowUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoxArrowUpDuotone;
