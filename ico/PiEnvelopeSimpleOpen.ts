...
/**
 * EnvelopeSimpleOpen icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleOpen(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleOpen;
