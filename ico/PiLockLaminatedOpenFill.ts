...
/**
 * LockLaminatedOpenFill icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedOpenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedOpenFill;
