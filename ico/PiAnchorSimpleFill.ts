...
/**
 * AnchorSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiAnchorSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAnchorSimpleFill;
