...
/**
 * PersonSimpleWalkThin icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleWalkThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleWalkThin;
