...
/**
 * ArrowULeftDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftDownBold;
