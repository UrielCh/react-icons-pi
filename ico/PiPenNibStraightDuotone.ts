...
/**
 * PenNibStraightDuotone icon from Phosphor Icons
 * @module
 */
export function PiPenNibStraightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPenNibStraightDuotone;
