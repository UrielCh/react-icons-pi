...
/**
 * WifiSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiWifiSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWifiSlashDuotone;
