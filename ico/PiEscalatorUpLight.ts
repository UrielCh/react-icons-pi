...
/**
 * EscalatorUpLight icon from Phosphor Icons
 * @module
 */
export function PiEscalatorUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEscalatorUpLight;
