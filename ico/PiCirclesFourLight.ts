...
/**
 * CirclesFourLight icon from Phosphor Icons
 * @module
 */
export function PiCirclesFourLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesFourLight;
