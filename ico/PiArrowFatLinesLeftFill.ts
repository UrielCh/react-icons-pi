...
/**
 * ArrowFatLinesLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesLeftFill;
