...
/**
 * BatteryVerticalEmptyLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalEmptyLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalEmptyLight;
