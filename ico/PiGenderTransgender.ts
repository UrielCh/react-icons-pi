...
/**
 * GenderTransgender icon from Phosphor Icons
 * @module
 */
export function PiGenderTransgender(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderTransgender;
