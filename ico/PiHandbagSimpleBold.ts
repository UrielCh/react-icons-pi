...
/**
 * HandbagSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiHandbagSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandbagSimpleBold;
