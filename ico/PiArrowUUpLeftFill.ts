...
/**
 * ArrowUUpLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpLeftFill;
