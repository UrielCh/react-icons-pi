...
/**
 * FolderStarDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderStarDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderStarDuotone;
