...
/**
 * PaperclipDuotone icon from Phosphor Icons
 * @module
 */
export function PiPaperclipDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipDuotone;
