...
/**
 * ArrowSquareRight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareRight;
