...
/**
 * SplitHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiSplitHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitHorizontalFill;
