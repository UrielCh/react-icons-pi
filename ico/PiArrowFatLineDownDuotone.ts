...
/**
 * ArrowFatLineDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineDownDuotone;
