...
/**
 * SubtractSquareBold icon from Phosphor Icons
 * @module
 */
export function PiSubtractSquareBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSubtractSquareBold;
