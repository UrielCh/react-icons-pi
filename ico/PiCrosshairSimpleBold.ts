...
/**
 * CrosshairSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiCrosshairSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCrosshairSimpleBold;
