...
/**
 * ThermometerSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiThermometerSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerSimpleBold;
