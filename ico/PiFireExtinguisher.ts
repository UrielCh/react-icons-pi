...
/**
 * FireExtinguisher icon from Phosphor Icons
 * @module
 */
export function PiFireExtinguisher(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireExtinguisher;
