...
/**
 * NumberSquareFourThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFourThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFourThin;
