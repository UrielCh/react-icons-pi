...
/**
 * NumberCircleEightThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleEightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleEightThin;
