...
/**
 * ArrowDownLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowDownLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownLeftFill;
