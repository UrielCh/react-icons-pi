...
/**
 * HandsPrayingLight icon from Phosphor Icons
 * @module
 */
export function PiHandsPrayingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandsPrayingLight;
