...
/**
 * SpeakerSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiSpeakerSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerSlashDuotone;
