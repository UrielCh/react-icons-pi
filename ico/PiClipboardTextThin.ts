...
/**
 * ClipboardTextThin icon from Phosphor Icons
 * @module
 */
export function PiClipboardTextThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClipboardTextThin;
