...
/**
 * CaretCircleDownLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDownLight;
