...
/**
 * UserCircleMinusDuotone icon from Phosphor Icons
 * @module
 */
export function PiUserCircleMinusDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleMinusDuotone;
