...
/**
 * ArrowArcRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowArcRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcRightBold;
