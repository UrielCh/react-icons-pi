...
/**
 * LinkSimpleBreakBold icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleBreakBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleBreakBold;
