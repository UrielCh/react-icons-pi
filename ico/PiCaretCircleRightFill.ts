...
/**
 * CaretCircleRightFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleRightFill;
