...
/**
 * MessengerLogoBold icon from Phosphor Icons
 * @module
 */
export function PiMessengerLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMessengerLogoBold;
