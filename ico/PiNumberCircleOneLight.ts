...
/**
 * NumberCircleOneLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleOneLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleOneLight;
