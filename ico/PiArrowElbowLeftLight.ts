...
/**
 * ArrowElbowLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowLeftLight;
