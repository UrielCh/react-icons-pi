...
/**
 * ListMagnifyingGlassFill icon from Phosphor Icons
 * @module
 */
export function PiListMagnifyingGlassFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListMagnifyingGlassFill;
