...
/**
 * GooglePodcastsLogoLight icon from Phosphor Icons
 * @module
 */
export function PiGooglePodcastsLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePodcastsLogoLight;
