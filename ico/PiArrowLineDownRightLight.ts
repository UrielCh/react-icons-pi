...
/**
 * ArrowLineDownRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownRightLight;
