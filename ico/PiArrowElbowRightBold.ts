...
/**
 * ArrowElbowRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightBold;
