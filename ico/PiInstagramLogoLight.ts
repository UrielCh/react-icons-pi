...
/**
 * InstagramLogoLight icon from Phosphor Icons
 * @module
 */
export function PiInstagramLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiInstagramLogoLight;
