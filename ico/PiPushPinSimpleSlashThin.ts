...
/**
 * PushPinSimpleSlashThin icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleSlashThin;
