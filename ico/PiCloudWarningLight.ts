...
/**
 * CloudWarningLight icon from Phosphor Icons
 * @module
 */
export function PiCloudWarningLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudWarningLight;
