...
/**
 * ArrowBendUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpLeftLight;
