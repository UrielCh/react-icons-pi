...
/**
 * AlignLeftSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAlignLeftSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignLeftSimpleThin;
