...
/**
 * LinkSimpleHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalLight;
