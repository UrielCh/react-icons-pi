...
/**
 * TelevisionSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiTelevisionSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTelevisionSimpleThin;
