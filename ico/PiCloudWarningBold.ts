...
/**
 * CloudWarningBold icon from Phosphor Icons
 * @module
 */
export function PiCloudWarningBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudWarningBold;
