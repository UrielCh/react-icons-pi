...
/**
 * ArrowSquareUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpFill;
