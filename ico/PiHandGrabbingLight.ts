...
/**
 * HandGrabbingLight icon from Phosphor Icons
 * @module
 */
export function PiHandGrabbingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandGrabbingLight;
