...
/**
 * ShoppingBagOpenLight icon from Phosphor Icons
 * @module
 */
export function PiShoppingBagOpenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShoppingBagOpenLight;
