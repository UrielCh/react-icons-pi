...
/**
 * SteeringWheelDuotone icon from Phosphor Icons
 * @module
 */
export function PiSteeringWheelDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSteeringWheelDuotone;
