...
/**
 * HandWithdrawBold icon from Phosphor Icons
 * @module
 */
export function PiHandWithdrawBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandWithdrawBold;
