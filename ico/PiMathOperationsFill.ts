...
/**
 * MathOperationsFill icon from Phosphor Icons
 * @module
 */
export function PiMathOperationsFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMathOperationsFill;
