...
/**
 * ClockCountdownLight icon from Phosphor Icons
 * @module
 */
export function PiClockCountdownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCountdownLight;
