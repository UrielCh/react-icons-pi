...
/**
 * ArrowFatRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatRightDuotone;
