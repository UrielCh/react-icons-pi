...
/**
 * DotsThreeCircleVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleVerticalThin;
