...
/**
 * DropboxLogoLight icon from Phosphor Icons
 * @module
 */
export function PiDropboxLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDropboxLogoLight;
