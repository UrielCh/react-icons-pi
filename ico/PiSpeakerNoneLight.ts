...
/**
 * SpeakerNoneLight icon from Phosphor Icons
 * @module
 */
export function PiSpeakerNoneLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerNoneLight;
