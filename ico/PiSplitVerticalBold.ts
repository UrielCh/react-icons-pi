...
/**
 * SplitVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiSplitVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitVerticalBold;
