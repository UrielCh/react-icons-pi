...
/**
 * ClockAfternoonLight icon from Phosphor Icons
 * @module
 */
export function PiClockAfternoonLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockAfternoonLight;
