...
/**
 * BoxArrowDownFill icon from Phosphor Icons
 * @module
 */
export function PiBoxArrowDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoxArrowDownFill;
