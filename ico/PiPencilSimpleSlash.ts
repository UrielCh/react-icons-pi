...
/**
 * PencilSimpleSlash icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleSlash(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleSlash;
