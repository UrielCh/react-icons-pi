...
/**
 * DetectiveDuotone icon from Phosphor Icons
 * @module
 */
export function PiDetectiveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDetectiveDuotone;
