...
/**
 * StackOverflowLogo icon from Phosphor Icons
 * @module
 */
export function PiStackOverflowLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackOverflowLogo;
