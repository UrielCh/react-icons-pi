...
/**
 * PaperclipHorizontal icon from Phosphor Icons
 * @module
 */
export function PiPaperclipHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipHorizontal;
