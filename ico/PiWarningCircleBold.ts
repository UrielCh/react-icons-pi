...
/**
 * WarningCircleBold icon from Phosphor Icons
 * @module
 */
export function PiWarningCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningCircleBold;
