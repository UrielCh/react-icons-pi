...
/**
 * TrademarkRegisteredBold icon from Phosphor Icons
 * @module
 */
export function PiTrademarkRegisteredBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrademarkRegisteredBold;
