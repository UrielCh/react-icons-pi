...
/**
 * ArrowsInCardinalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsInCardinalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInCardinalLight;
