...
/**
 * ScreencastDuotone icon from Phosphor Icons
 * @module
 */
export function PiScreencastDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiScreencastDuotone;
