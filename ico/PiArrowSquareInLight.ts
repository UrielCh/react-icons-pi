...
/**
 * ArrowSquareInLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareInLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareInLight;
