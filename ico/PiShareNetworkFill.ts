...
/**
 * ShareNetworkFill icon from Phosphor Icons
 * @module
 */
export function PiShareNetworkFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShareNetworkFill;
