...
/**
 * ArrowCircleUpLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpLeftThin;
