...
/**
 * AlignCenterVertical icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVertical;
