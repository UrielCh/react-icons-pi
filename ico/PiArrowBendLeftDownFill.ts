...
/**
 * ArrowBendLeftDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftDownFill;
