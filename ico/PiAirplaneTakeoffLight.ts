...
/**
 * AirplaneTakeoffLight icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTakeoffLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTakeoffLight;
