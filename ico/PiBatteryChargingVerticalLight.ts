...
/**
 * BatteryChargingVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingVerticalLight;
