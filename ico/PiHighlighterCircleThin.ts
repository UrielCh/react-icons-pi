...
/**
 * HighlighterCircleThin icon from Phosphor Icons
 * @module
 */
export function PiHighlighterCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHighlighterCircleThin;
