...
/**
 * ChartPieSliceFill icon from Phosphor Icons
 * @module
 */
export function PiChartPieSliceFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartPieSliceFill;
