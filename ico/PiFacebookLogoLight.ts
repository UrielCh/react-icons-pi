...
/**
 * FacebookLogoLight icon from Phosphor Icons
 * @module
 */
export function PiFacebookLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFacebookLogoLight;
