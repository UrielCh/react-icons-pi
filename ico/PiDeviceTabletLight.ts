...
/**
 * DeviceTabletLight icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletLight;
