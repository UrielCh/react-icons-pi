...
/**
 * FileAudioDuotone icon from Phosphor Icons
 * @module
 */
export function PiFileAudioDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileAudioDuotone;
