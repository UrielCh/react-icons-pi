...
/**
 * FacebookLogoFill icon from Phosphor Icons
 * @module
 */
export function PiFacebookLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFacebookLogoFill;
