...
/**
 * ArrowElbowDownLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowDownLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowDownLeftLight;
