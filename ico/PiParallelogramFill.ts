...
/**
 * ParallelogramFill icon from Phosphor Icons
 * @module
 */
export function PiParallelogramFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiParallelogramFill;
