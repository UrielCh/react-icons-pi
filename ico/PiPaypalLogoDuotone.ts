...
/**
 * PaypalLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiPaypalLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaypalLogoDuotone;
