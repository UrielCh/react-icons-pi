...
/**
 * CaretCircleDoubleUpFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleUpFill;
