...
/**
 * ArrowsOutLineVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineVerticalThin;
