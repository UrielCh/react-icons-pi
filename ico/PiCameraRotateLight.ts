...
/**
 * CameraRotateLight icon from Phosphor Icons
 * @module
 */
export function PiCameraRotateLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraRotateLight;
