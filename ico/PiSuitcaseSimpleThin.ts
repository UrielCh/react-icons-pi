...
/**
 * SuitcaseSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseSimpleThin;
