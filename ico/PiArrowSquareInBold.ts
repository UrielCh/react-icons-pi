...
/**
 * ArrowSquareInBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareInBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareInBold;
