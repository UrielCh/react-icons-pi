...
/**
 * DotsThreeCircleLight icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleLight;
