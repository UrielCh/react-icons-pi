...
/**
 * EnvelopeSimpleOpenLight icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleOpenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleOpenLight;
