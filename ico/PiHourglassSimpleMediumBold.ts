...
/**
 * HourglassSimpleMediumBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleMediumBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleMediumBold;
