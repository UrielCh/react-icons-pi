...
/**
 * ClockCountdownBold icon from Phosphor Icons
 * @module
 */
export function PiClockCountdownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCountdownBold;
