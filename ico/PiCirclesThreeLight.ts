...
/**
 * CirclesThreeLight icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreeLight;
