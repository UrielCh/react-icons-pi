...
/**
 * SelectionSlashBold icon from Phosphor Icons
 * @module
 */
export function PiSelectionSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionSlashBold;
