...
/**
 * SelectionInverse icon from Phosphor Icons
 * @module
 */
export function PiSelectionInverse(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionInverse;
