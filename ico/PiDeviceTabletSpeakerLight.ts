...
/**
 * DeviceTabletSpeakerLight icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletSpeakerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletSpeakerLight;
