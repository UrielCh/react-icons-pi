...
/**
 * LineSegmentsDuotone icon from Phosphor Icons
 * @module
 */
export function PiLineSegmentsDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLineSegmentsDuotone;
