...
/**
 * CaretCircleDoubleRightLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleRightLight;
