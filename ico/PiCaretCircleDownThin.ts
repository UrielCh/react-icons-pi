...
/**
 * CaretCircleDownThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDownThin;
