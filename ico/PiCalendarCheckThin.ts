...
/**
 * CalendarCheckThin icon from Phosphor Icons
 * @module
 */
export function PiCalendarCheckThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarCheckThin;
