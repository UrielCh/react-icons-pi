...
/**
 * BracketsRoundBold icon from Phosphor Icons
 * @module
 */
export function PiBracketsRoundBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsRoundBold;
