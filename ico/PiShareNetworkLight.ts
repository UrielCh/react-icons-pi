...
/**
 * ShareNetworkLight icon from Phosphor Icons
 * @module
 */
export function PiShareNetworkLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShareNetworkLight;
