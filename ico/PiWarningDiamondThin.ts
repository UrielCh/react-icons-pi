...
/**
 * WarningDiamondThin icon from Phosphor Icons
 * @module
 */
export function PiWarningDiamondThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningDiamondThin;
