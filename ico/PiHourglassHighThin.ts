...
/**
 * HourglassHighThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassHighThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassHighThin;
