...
/**
 * ArrowFatLineUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineUpLight;
