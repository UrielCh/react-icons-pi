...
/**
 * EyedropperSampleBold icon from Phosphor Icons
 * @module
 */
export function PiEyedropperSampleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperSampleBold;
