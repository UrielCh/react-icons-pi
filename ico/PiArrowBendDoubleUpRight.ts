...
/**
 * ArrowBendDoubleUpRight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpRight;
