...
/**
 * PencilSimpleSlashThin icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleSlashThin;
