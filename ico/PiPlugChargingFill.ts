...
/**
 * PlugChargingFill icon from Phosphor Icons
 * @module
 */
export function PiPlugChargingFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlugChargingFill;
