...
/**
 * FolderDashedDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderDashedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderDashedDuotone;
