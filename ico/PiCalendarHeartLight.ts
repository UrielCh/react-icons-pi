...
/**
 * CalendarHeartLight icon from Phosphor Icons
 * @module
 */
export function PiCalendarHeartLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarHeartLight;
