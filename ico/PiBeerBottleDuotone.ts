...
/**
 * BeerBottleDuotone icon from Phosphor Icons
 * @module
 */
export function PiBeerBottleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBeerBottleDuotone;
