...
/**
 * ArrowSquareLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareLeftBold;
