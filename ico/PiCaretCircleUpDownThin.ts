...
/**
 * CaretCircleUpDownThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpDownThin;
