...
/**
 * CaretCircleDoubleDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleDownDuotone;
