...
/**
 * SquareHalfDuotone icon from Phosphor Icons
 * @module
 */
export function PiSquareHalfDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareHalfDuotone;
