...
/**
 * AlignBottomDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomDuotone;
