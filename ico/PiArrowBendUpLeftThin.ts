...
/**
 * ArrowBendUpLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpLeftThin;
