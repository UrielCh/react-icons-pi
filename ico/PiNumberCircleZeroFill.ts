...
/**
 * NumberCircleZeroFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleZeroFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleZeroFill;
