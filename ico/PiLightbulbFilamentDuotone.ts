...
/**
 * LightbulbFilamentDuotone icon from Phosphor Icons
 * @module
 */
export function PiLightbulbFilamentDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightbulbFilamentDuotone;
