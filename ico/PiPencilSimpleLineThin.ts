...
/**
 * PencilSimpleLineThin icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleLineThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleLineThin;
