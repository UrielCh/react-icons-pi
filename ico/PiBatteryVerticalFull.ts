...
/**
 * BatteryVerticalFull icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalFull(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalFull;
