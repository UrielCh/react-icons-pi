...
/**
 * ArrowsInSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsInSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInSimpleBold;
