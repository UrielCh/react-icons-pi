...
/**
 * BookmarkSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiBookmarkSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookmarkSimpleLight;
