...
/**
 * ArrowUUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpLeftLight;
