...
/**
 * ArrowBendLeftUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftUpThin;
