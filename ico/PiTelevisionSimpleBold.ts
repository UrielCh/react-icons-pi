...
/**
 * TelevisionSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiTelevisionSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTelevisionSimpleBold;
