...
/**
 * CaretCircleUpDown icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpDown;
