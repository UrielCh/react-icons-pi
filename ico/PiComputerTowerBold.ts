...
/**
 * ComputerTowerBold icon from Phosphor Icons
 * @module
 */
export function PiComputerTowerBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiComputerTowerBold;
