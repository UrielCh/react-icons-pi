...
/**
 * ArrowUDownLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownLeftBold;
