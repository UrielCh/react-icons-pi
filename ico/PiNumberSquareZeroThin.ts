...
/**
 * NumberSquareZeroThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareZeroThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareZeroThin;
