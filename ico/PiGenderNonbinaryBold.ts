...
/**
 * GenderNonbinaryBold icon from Phosphor Icons
 * @module
 */
export function PiGenderNonbinaryBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNonbinaryBold;
