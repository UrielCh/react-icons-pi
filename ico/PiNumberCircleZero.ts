...
/**
 * NumberCircleZero icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleZero(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleZero;
