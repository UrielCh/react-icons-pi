...
/**
 * NumberSquareEightBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareEightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareEightBold;
