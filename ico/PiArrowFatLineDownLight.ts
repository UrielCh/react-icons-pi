...
/**
 * ArrowFatLineDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineDownLight;
