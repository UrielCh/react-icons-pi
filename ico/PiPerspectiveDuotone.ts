...
/**
 * PerspectiveDuotone icon from Phosphor Icons
 * @module
 */
export function PiPerspectiveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPerspectiveDuotone;
