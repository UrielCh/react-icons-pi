...
/**
 * NumberCircleNineFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleNineFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleNineFill;
