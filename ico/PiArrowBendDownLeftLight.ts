...
/**
 * ArrowBendDownLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownLeftLight;
