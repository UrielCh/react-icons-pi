...
/**
 * AlignBottomSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomSimpleFill;
