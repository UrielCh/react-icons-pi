...
/**
 * PhoneSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiPhoneSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneSlashDuotone;
