...
/**
 * TextAlignLeftThin icon from Phosphor Icons
 * @module
 */
export function PiTextAlignLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignLeftThin;
