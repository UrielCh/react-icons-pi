...
/**
 * ListMagnifyingGlassThin icon from Phosphor Icons
 * @module
 */
export function PiListMagnifyingGlassThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListMagnifyingGlassThin;
