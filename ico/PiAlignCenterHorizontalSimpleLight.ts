...
/**
 * AlignCenterHorizontalSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalSimpleLight;
