...
/**
 * ArrowCircleRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleRightLight;
