...
/**
 * MicrosoftExcelLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftExcelLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftExcelLogoDuotone;
