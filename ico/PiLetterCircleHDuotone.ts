...
/**
 * LetterCircleHDuotone icon from Phosphor Icons
 * @module
 */
export function PiLetterCircleHDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLetterCircleHDuotone;
