...
/**
 * ArrowSquareDownRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownRightThin;
