...
/**
 * ClockClockwiseBold icon from Phosphor Icons
 * @module
 */
export function PiClockClockwiseBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockClockwiseBold;
