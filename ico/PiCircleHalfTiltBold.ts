...
/**
 * CircleHalfTiltBold icon from Phosphor Icons
 * @module
 */
export function PiCircleHalfTiltBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleHalfTiltBold;
