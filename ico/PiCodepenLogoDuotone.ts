...
/**
 * CodepenLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiCodepenLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodepenLogoDuotone;
