...
/**
 * ArrowsOutLineVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineVerticalFill;
