...
/**
 * NumberSquareThreeLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareThreeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareThreeLight;
