...
/**
 * TreeEvergreenThin icon from Phosphor Icons
 * @module
 */
export function PiTreeEvergreenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTreeEvergreenThin;
