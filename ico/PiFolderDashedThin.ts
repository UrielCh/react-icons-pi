...
/**
 * FolderDashedThin icon from Phosphor Icons
 * @module
 */
export function PiFolderDashedThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderDashedThin;
