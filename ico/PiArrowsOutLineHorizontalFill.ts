...
/**
 * ArrowsOutLineHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineHorizontalFill;
