...
/**
 * BriefcaseMetalLight icon from Phosphor Icons
 * @module
 */
export function PiBriefcaseMetalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBriefcaseMetalLight;
