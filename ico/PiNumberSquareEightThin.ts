...
/**
 * NumberSquareEightThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareEightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareEightThin;
