...
/**
 * WifiMediumDuotone icon from Phosphor Icons
 * @module
 */
export function PiWifiMediumDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWifiMediumDuotone;
