...
/**
 * ShuffleSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiShuffleSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShuffleSimpleLight;
