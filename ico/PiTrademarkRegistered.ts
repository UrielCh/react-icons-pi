...
/**
 * TrademarkRegistered icon from Phosphor Icons
 * @module
 */
export function PiTrademarkRegistered(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrademarkRegistered;
