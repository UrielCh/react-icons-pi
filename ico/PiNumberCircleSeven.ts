...
/**
 * NumberCircleSeven icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSeven(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSeven;
