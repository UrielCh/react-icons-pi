...
/**
 * HandsPrayingBold icon from Phosphor Icons
 * @module
 */
export function PiHandsPrayingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandsPrayingBold;
