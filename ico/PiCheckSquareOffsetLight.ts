...
/**
 * CheckSquareOffsetLight icon from Phosphor Icons
 * @module
 */
export function PiCheckSquareOffsetLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckSquareOffsetLight;
