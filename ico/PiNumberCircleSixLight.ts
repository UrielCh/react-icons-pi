...
/**
 * NumberCircleSixLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSixLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSixLight;
