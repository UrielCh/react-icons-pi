...
/**
 * DeviceTabletCameraBold icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletCameraBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletCameraBold;
