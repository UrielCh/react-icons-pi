...
/**
 * CheckCircleLight icon from Phosphor Icons
 * @module
 */
export function PiCheckCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckCircleLight;
