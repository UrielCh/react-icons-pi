...
/**
 * ArrowElbowUpLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowUpLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowUpLeft;
