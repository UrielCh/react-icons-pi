...
/**
 * PersonSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleLight;
