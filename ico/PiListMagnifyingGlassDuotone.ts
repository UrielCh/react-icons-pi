...
/**
 * ListMagnifyingGlassDuotone icon from Phosphor Icons
 * @module
 */
export function PiListMagnifyingGlassDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListMagnifyingGlassDuotone;
