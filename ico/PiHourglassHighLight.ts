...
/**
 * HourglassHighLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassHighLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassHighLight;
