...
/**
 * ArrowFatLinesRight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesRight;
