...
/**
 * AirTrafficControlFill icon from Phosphor Icons
 * @module
 */
export function PiAirTrafficControlFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirTrafficControlFill;
