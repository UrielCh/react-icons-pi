...
/**
 * AsteriskSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiAsteriskSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAsteriskSimpleDuotone;
