...
/**
 * PlugsConnectedDuotone icon from Phosphor Icons
 * @module
 */
export function PiPlugsConnectedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlugsConnectedDuotone;
