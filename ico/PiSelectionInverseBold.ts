...
/**
 * SelectionInverseBold icon from Phosphor Icons
 * @module
 */
export function PiSelectionInverseBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionInverseBold;
