...
/**
 * HourglassSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleDuotone;
