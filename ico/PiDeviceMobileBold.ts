...
/**
 * DeviceMobileBold icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileBold;
