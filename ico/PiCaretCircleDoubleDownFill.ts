...
/**
 * CaretCircleDoubleDownFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleDownFill;
