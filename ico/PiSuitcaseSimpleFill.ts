...
/**
 * SuitcaseSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseSimpleFill;
