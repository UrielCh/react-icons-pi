...
/**
 * ArrowURightUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowURightUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightUpLight;
