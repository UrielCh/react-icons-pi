...
/**
 * ArrowCircleDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownDuotone;
