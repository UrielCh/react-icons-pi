...
/**
 * SpeakerSlashLight icon from Phosphor Icons
 * @module
 */
export function PiSpeakerSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerSlashLight;
