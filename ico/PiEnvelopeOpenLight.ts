...
/**
 * EnvelopeOpenLight icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeOpenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeOpenLight;
