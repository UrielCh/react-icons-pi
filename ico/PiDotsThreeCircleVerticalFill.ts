...
/**
 * DotsThreeCircleVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleVerticalFill;
