...
/**
 * SelectionForegroundBold icon from Phosphor Icons
 * @module
 */
export function PiSelectionForegroundBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionForegroundBold;
