...
/**
 * SelectionInverseFill icon from Phosphor Icons
 * @module
 */
export function PiSelectionInverseFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionInverseFill;
