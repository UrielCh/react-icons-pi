...
/**
 * CurrencyNgnDuotone icon from Phosphor Icons
 * @module
 */
export function PiCurrencyNgnDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyNgnDuotone;
