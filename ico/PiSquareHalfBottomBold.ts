...
/**
 * SquareHalfBottomBold icon from Phosphor Icons
 * @module
 */
export function PiSquareHalfBottomBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareHalfBottomBold;
