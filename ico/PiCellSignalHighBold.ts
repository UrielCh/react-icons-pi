...
/**
 * CellSignalHighBold icon from Phosphor Icons
 * @module
 */
export function PiCellSignalHighBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalHighBold;
