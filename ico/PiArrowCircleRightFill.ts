...
/**
 * ArrowCircleRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleRightFill;
