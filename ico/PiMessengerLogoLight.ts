...
/**
 * MessengerLogoLight icon from Phosphor Icons
 * @module
 */
export function PiMessengerLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMessengerLogoLight;
