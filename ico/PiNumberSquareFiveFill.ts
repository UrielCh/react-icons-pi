...
/**
 * NumberSquareFiveFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFiveFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFiveFill;
