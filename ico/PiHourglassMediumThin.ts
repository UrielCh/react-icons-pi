...
/**
 * HourglassMediumThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassMediumThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassMediumThin;
