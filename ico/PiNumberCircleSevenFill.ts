...
/**
 * NumberCircleSevenFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSevenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSevenFill;
