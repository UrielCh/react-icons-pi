...
/**
 * ArrowsInLineHorizontal icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineHorizontal;
