...
/**
 * UserCircleGearBold icon from Phosphor Icons
 * @module
 */
export function PiUserCircleGearBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleGearBold;
