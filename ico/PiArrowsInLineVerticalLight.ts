...
/**
 * ArrowsInLineVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineVerticalLight;
