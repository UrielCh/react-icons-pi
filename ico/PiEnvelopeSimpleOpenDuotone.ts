...
/**
 * EnvelopeSimpleOpenDuotone icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleOpenDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleOpenDuotone;
