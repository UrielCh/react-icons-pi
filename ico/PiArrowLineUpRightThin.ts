...
/**
 * ArrowLineUpRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpRightThin;
