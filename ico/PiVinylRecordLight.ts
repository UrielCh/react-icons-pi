...
/**
 * VinylRecordLight icon from Phosphor Icons
 * @module
 */
export function PiVinylRecordLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVinylRecordLight;
