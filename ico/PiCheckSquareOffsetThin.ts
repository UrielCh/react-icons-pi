...
/**
 * CheckSquareOffsetThin icon from Phosphor Icons
 * @module
 */
export function PiCheckSquareOffsetThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckSquareOffsetThin;
