...
/**
 * HourglassHighFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassHighFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassHighFill;
