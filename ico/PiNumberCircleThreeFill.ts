...
/**
 * NumberCircleThreeFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleThreeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleThreeFill;
