...
/**
 * HandbagSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiHandbagSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandbagSimpleThin;
