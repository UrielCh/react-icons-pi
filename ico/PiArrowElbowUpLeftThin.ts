...
/**
 * ArrowElbowUpLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowUpLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowUpLeftThin;
