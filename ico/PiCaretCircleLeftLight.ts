...
/**
 * CaretCircleLeftLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleLeftLight;
