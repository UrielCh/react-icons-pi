...
/**
 * FingerprintSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiFingerprintSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFingerprintSimpleThin;
