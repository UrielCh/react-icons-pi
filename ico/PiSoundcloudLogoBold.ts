...
/**
 * SoundcloudLogoBold icon from Phosphor Icons
 * @module
 */
export function PiSoundcloudLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSoundcloudLogoBold;
