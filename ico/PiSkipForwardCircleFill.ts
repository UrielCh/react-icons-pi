...
/**
 * SkipForwardCircleFill icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardCircleFill;
