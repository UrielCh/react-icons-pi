...
/**
 * SquareHalfBottomLight icon from Phosphor Icons
 * @module
 */
export function PiSquareHalfBottomLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareHalfBottomLight;
