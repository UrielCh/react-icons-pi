...
/**
 * ArrowSquareUpLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpLeftDuotone;
