...
/**
 * LinkSimpleHorizontalBreakLight icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalBreakLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalBreakLight;
