...
/**
 * SplitHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiSplitHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitHorizontalThin;
