...
/**
 * ArrowBendDownRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownRightThin;
