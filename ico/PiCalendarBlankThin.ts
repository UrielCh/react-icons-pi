...
/**
 * CalendarBlankThin icon from Phosphor Icons
 * @module
 */
export function PiCalendarBlankThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarBlankThin;
