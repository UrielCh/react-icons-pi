...
/**
 * StarAndCrescentDuotone icon from Phosphor Icons
 * @module
 */
export function PiStarAndCrescentDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarAndCrescentDuotone;
