...
/**
 * BatteryMediumLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryMediumLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryMediumLight;
