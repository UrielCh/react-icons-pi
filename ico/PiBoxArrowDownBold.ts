...
/**
 * BoxArrowDownBold icon from Phosphor Icons
 * @module
 */
export function PiBoxArrowDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoxArrowDownBold;
