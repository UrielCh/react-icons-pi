...
/**
 * CircleDashedBold icon from Phosphor Icons
 * @module
 */
export function PiCircleDashedBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleDashedBold;
