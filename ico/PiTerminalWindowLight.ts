...
/**
 * TerminalWindowLight icon from Phosphor Icons
 * @module
 */
export function PiTerminalWindowLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTerminalWindowLight;
