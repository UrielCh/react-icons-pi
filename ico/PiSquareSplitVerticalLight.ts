...
/**
 * SquareSplitVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitVerticalLight;
