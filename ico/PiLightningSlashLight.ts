...
/**
 * LightningSlashLight icon from Phosphor Icons
 * @module
 */
export function PiLightningSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightningSlashLight;
