...
/**
 * PersonArmsSpread icon from Phosphor Icons
 * @module
 */
export function PiPersonArmsSpread(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonArmsSpread;
