...
/**
 * GenderNeuterThin icon from Phosphor Icons
 * @module
 */
export function PiGenderNeuterThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNeuterThin;
