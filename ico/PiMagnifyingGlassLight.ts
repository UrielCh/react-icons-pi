...
/**
 * MagnifyingGlassLight icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassLight;
