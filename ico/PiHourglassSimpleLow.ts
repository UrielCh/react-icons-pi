...
/**
 * HourglassSimpleLow icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLow(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLow;
