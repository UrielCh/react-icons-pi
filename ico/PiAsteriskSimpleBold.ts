...
/**
 * AsteriskSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAsteriskSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAsteriskSimpleBold;
