...
/**
 * CaretUpDownLight icon from Phosphor Icons
 * @module
 */
export function PiCaretUpDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretUpDownLight;
