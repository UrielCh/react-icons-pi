...
/**
 * ClockClockwiseLight icon from Phosphor Icons
 * @module
 */
export function PiClockClockwiseLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockClockwiseLight;
