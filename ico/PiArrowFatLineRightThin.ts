...
/**
 * ArrowFatLineRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineRightThin;
