...
/**
 * ArrowCircleLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleLeftBold;
