...
/**
 * CurrencyCircleDollarLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyCircleDollarLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyCircleDollarLight;
