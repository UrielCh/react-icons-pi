...
/**
 * TextStrikethroughBold icon from Phosphor Icons
 * @module
 */
export function PiTextStrikethroughBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextStrikethroughBold;
