...
/**
 * GameControllerFill icon from Phosphor Icons
 * @module
 */
export function PiGameControllerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGameControllerFill;
