...
/**
 * ArrowSquareDownRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownRightFill;
