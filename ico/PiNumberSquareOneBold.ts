...
/**
 * NumberSquareOneBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareOneBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareOneBold;
