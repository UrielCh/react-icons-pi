...
/**
 * RadioactiveLight icon from Phosphor Icons
 * @module
 */
export function PiRadioactiveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRadioactiveLight;
