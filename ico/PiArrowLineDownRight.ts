...
/**
 * ArrowLineDownRight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownRight;
