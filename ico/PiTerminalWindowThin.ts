...
/**
 * TerminalWindowThin icon from Phosphor Icons
 * @module
 */
export function PiTerminalWindowThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTerminalWindowThin;
