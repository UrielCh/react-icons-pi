...
/**
 * ArrowCircleUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpLeftLight;
