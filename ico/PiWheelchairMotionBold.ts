...
/**
 * WheelchairMotionBold icon from Phosphor Icons
 * @module
 */
export function PiWheelchairMotionBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWheelchairMotionBold;
