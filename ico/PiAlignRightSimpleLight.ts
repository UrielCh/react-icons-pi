...
/**
 * AlignRightSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAlignRightSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignRightSimpleLight;
