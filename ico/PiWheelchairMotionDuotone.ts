...
/**
 * WheelchairMotionDuotone icon from Phosphor Icons
 * @module
 */
export function PiWheelchairMotionDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWheelchairMotionDuotone;
