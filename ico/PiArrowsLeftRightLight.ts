...
/**
 * ArrowsLeftRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsLeftRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsLeftRightLight;
