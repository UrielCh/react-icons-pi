...
/**
 * EnvelopeSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleBold;
