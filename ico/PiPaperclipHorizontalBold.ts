...
/**
 * PaperclipHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiPaperclipHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipHorizontalBold;
