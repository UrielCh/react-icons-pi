...
/**
 * CodepenLogoLight icon from Phosphor Icons
 * @module
 */
export function PiCodepenLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodepenLogoLight;
