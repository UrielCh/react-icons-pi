...
/**
 * PushPinSlashThin icon from Phosphor Icons
 * @module
 */
export function PiPushPinSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSlashThin;
