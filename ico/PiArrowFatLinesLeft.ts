...
/**
 * ArrowFatLinesLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesLeft;
