...
/**
 * AirplaneTakeoffDuotone icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTakeoffDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTakeoffDuotone;
