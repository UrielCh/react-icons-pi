...
/**
 * HeartStraightFill icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightFill;
