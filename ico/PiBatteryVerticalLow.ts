...
/**
 * BatteryVerticalLow icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalLow(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalLow;
