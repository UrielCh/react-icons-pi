...
/**
 * MopedFrontDuotone icon from Phosphor Icons
 * @module
 */
export function PiMopedFrontDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMopedFrontDuotone;
