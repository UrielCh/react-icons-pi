...
/**
 * ArrowCircleUpLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpLeftFill;
