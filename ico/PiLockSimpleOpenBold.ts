...
/**
 * LockSimpleOpenBold icon from Phosphor Icons
 * @module
 */
export function PiLockSimpleOpenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockSimpleOpenBold;
