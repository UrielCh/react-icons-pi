...
/**
 * ArrowSquareUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpDuotone;
