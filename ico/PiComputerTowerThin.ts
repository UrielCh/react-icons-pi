...
/**
 * ComputerTowerThin icon from Phosphor Icons
 * @module
 */
export function PiComputerTowerThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiComputerTowerThin;
