...
/**
 * ArrowElbowRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightFill;
