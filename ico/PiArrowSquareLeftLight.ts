...
/**
 * ArrowSquareLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareLeftLight;
