...
/**
 * LinkedinLogoThin icon from Phosphor Icons
 * @module
 */
export function PiLinkedinLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkedinLogoThin;
