...
/**
 * IntersectSquareLight icon from Phosphor Icons
 * @module
 */
export function PiIntersectSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectSquareLight;
