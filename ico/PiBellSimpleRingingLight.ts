...
/**
 * BellSimpleRingingLight icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleRingingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleRingingLight;
