...
/**
 * ArrowBendDownLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownLeftDuotone;
