...
/**
 * CalendarCheckDuotone icon from Phosphor Icons
 * @module
 */
export function PiCalendarCheckDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarCheckDuotone;
