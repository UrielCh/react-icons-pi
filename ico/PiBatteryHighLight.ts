...
/**
 * BatteryHighLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryHighLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryHighLight;
