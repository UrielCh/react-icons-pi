...
/**
 * PencilSimpleLineBold icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleLineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleLineBold;
