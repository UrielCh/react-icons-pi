...
/**
 * ArrowsLeftRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsLeftRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsLeftRightBold;
