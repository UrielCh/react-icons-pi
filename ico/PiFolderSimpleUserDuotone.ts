...
/**
 * FolderSimpleUserDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleUserDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleUserDuotone;
