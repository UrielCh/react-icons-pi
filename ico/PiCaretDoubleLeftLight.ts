...
/**
 * CaretDoubleLeftLight icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleLeftLight;
