...
/**
 * OfficeChairLight icon from Phosphor Icons
 * @module
 */
export function PiOfficeChairLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiOfficeChairLight;
