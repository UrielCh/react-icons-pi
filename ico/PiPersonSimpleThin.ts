...
/**
 * PersonSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThin;
