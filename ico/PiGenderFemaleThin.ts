...
/**
 * GenderFemaleThin icon from Phosphor Icons
 * @module
 */
export function PiGenderFemaleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderFemaleThin;
