...
/**
 * UserSquareDuotone icon from Phosphor Icons
 * @module
 */
export function PiUserSquareDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserSquareDuotone;
