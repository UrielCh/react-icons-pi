...
/**
 * CloudArrowDownLight icon from Phosphor Icons
 * @module
 */
export function PiCloudArrowDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudArrowDownLight;
