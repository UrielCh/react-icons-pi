...
/**
 * LockLaminatedOpenBold icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedOpenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedOpenBold;
