...
/**
 * CurrencyDollarSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarSimpleBold;
