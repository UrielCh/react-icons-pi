...
/**
 * HandGrabbingFill icon from Phosphor Icons
 * @module
 */
export function PiHandGrabbingFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandGrabbingFill;
