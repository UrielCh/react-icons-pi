...
/**
 * ChalkboardTeacherThin icon from Phosphor Icons
 * @module
 */
export function PiChalkboardTeacherThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChalkboardTeacherThin;
