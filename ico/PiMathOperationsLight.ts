...
/**
 * MathOperationsLight icon from Phosphor Icons
 * @module
 */
export function PiMathOperationsLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMathOperationsLight;
