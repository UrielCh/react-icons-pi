...
/**
 * FolderSimpleLockDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleLockDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleLockDuotone;
