...
/**
 * BracketsCurlyFill icon from Phosphor Icons
 * @module
 */
export function PiBracketsCurlyFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsCurlyFill;
