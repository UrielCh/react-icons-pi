...
/**
 * ToiletPaperDuotone icon from Phosphor Icons
 * @module
 */
export function PiToiletPaperDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiToiletPaperDuotone;
