...
/**
 * AlignCenterVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalThin;
