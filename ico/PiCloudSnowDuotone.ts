...
/**
 * CloudSnowDuotone icon from Phosphor Icons
 * @module
 */
export function PiCloudSnowDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudSnowDuotone;
