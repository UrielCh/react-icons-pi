...
/**
 * CalendarPlusThin icon from Phosphor Icons
 * @module
 */
export function PiCalendarPlusThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarPlusThin;
