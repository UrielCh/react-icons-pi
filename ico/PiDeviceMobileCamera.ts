...
/**
 * DeviceMobileCamera icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileCamera(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileCamera;
