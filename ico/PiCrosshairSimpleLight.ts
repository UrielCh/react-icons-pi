...
/**
 * CrosshairSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiCrosshairSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCrosshairSimpleLight;
