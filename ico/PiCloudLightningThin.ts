...
/**
 * CloudLightningThin icon from Phosphor Icons
 * @module
 */
export function PiCloudLightningThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudLightningThin;
