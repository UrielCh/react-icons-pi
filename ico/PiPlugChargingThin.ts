...
/**
 * PlugChargingThin icon from Phosphor Icons
 * @module
 */
export function PiPlugChargingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlugChargingThin;
