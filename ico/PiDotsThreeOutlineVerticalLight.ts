...
/**
 * DotsThreeOutlineVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineVerticalLight;
