...
/**
 * ThumbsDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiThumbsDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThumbsDownDuotone;
