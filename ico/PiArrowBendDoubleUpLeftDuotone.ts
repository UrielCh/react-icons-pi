...
/**
 * ArrowBendDoubleUpLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpLeftDuotone;
