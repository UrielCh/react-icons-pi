...
/**
 * GitPullRequestThin icon from Phosphor Icons
 * @module
 */
export function PiGitPullRequestThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitPullRequestThin;
