...
/**
 * ArrowUUpRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpRightFill;
