...
/**
 * GenderTransgenderLight icon from Phosphor Icons
 * @module
 */
export function PiGenderTransgenderLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderTransgenderLight;
