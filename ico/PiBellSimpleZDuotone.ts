...
/**
 * BellSimpleZDuotone icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleZDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleZDuotone;
