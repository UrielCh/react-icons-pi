...
/**
 * LineSegmentsBold icon from Phosphor Icons
 * @module
 */
export function PiLineSegmentsBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLineSegmentsBold;
