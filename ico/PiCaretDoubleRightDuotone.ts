...
/**
 * CaretDoubleRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleRightDuotone;
