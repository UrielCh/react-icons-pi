...
/**
 * FileMagnifyingGlassLight icon from Phosphor Icons
 * @module
 */
export function PiFileMagnifyingGlassLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileMagnifyingGlassLight;
