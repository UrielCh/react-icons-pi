...
/**
 * ArrowURightDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowURightDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightDownLight;
