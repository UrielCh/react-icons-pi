...
/**
 * UmbrellaSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiUmbrellaSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUmbrellaSimpleThin;
