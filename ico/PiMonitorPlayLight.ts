...
/**
 * MonitorPlayLight icon from Phosphor Icons
 * @module
 */
export function PiMonitorPlayLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMonitorPlayLight;
