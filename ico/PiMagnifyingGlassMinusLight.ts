...
/**
 * MagnifyingGlassMinusLight icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassMinusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassMinusLight;
