...
/**
 * WaveTriangleBold icon from Phosphor Icons
 * @module
 */
export function PiWaveTriangleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWaveTriangleBold;
