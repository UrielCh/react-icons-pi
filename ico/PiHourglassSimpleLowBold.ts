...
/**
 * HourglassSimpleLowBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLowBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLowBold;
