...
/**
 * StackSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiStackSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackSimpleLight;
