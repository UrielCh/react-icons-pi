...
/**
 * StackOverflowLogoThin icon from Phosphor Icons
 * @module
 */
export function PiStackOverflowLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackOverflowLogoThin;
