...
/**
 * DotsThreeCircleThin icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleThin;
