...
/**
 * AlignTopSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAlignTopSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignTopSimpleLight;
