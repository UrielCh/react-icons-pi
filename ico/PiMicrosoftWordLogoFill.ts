...
/**
 * MicrosoftWordLogoFill icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftWordLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftWordLogoFill;
