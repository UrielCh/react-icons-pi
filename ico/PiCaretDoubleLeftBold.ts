...
/**
 * CaretDoubleLeftBold icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleLeftBold;
