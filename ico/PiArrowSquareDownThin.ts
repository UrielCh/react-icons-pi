...
/**
 * ArrowSquareDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownThin;
