...
/**
 * ArrowBendLeftUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftUpLight;
