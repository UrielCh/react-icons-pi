...
/**
 * ArrowsOutSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutSimpleLight;
