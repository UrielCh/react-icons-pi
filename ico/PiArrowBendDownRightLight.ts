...
/**
 * ArrowBendDownRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownRightLight;
