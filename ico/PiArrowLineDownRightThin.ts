...
/**
 * ArrowLineDownRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownRightThin;
