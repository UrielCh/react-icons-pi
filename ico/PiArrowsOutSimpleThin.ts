...
/**
 * ArrowsOutSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutSimpleThin;
