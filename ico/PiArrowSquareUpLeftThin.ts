...
/**
 * ArrowSquareUpLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpLeftThin;
