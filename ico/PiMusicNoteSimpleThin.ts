...
/**
 * MusicNoteSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiMusicNoteSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMusicNoteSimpleThin;
