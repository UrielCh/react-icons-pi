...
/**
 * PersonSimpleBikeDuotone icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBikeDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBikeDuotone;
