...
/**
 * ArrowSquareDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownLight;
