...
/**
 * NumberSquareThreeThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareThreeThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareThreeThin;
