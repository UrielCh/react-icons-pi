...
/**
 * GoogleChromeLogo icon from Phosphor Icons
 * @module
 */
export function PiGoogleChromeLogo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoogleChromeLogo;
