...
/**
 * ArrowElbowDownLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowDownLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowDownLeft;
