...
/**
 * NumberSquareTwoLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareTwoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareTwoLight;
