...
/**
 * HourglassSimpleHighFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleHighFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleHighFill;
