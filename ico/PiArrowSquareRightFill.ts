...
/**
 * ArrowSquareRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareRightFill;
