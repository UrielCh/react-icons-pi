...
/**
 * CaretCircleRightBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleRightBold;
