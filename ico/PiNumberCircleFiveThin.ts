...
/**
 * NumberCircleFiveThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFiveThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFiveThin;
