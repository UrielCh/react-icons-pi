...
/**
 * SelectionForegroundThin icon from Phosphor Icons
 * @module
 */
export function PiSelectionForegroundThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionForegroundThin;
