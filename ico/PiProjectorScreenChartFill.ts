...
/**
 * ProjectorScreenChartFill icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenChartFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenChartFill;
