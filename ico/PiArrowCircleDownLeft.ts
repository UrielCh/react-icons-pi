...
/**
 * ArrowCircleDownLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLeft;
