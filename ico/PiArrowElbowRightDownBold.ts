...
/**
 * ArrowElbowRightDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightDownBold;
