...
/**
 * PushPinSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleBold;
