...
/**
 * GitlabLogoSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoSimpleFill;
