...
/**
 * CloudRainDuotone icon from Phosphor Icons
 * @module
 */
export function PiCloudRainDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudRainDuotone;
