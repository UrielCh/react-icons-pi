...
/**
 * ArrowBendDoubleUpRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpRightFill;
