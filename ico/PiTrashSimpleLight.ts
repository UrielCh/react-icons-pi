...
/**
 * TrashSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiTrashSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrashSimpleLight;
