...
/**
 * MicrosoftExcelLogoBold icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftExcelLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftExcelLogoBold;
