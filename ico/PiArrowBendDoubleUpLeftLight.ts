...
/**
 * ArrowBendDoubleUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpLeftLight;
