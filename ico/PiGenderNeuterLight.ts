...
/**
 * GenderNeuterLight icon from Phosphor Icons
 * @module
 */
export function PiGenderNeuterLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNeuterLight;
