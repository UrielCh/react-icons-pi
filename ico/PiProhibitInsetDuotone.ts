...
/**
 * ProhibitInsetDuotone icon from Phosphor Icons
 * @module
 */
export function PiProhibitInsetDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProhibitInsetDuotone;
