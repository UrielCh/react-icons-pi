...
/**
 * TextOutdentLight icon from Phosphor Icons
 * @module
 */
export function PiTextOutdentLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextOutdentLight;
