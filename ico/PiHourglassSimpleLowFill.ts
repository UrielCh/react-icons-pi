...
/**
 * HourglassSimpleLowFill icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLowFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLowFill;
