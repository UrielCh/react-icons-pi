...
/**
 * PaintBrushBroadLight icon from Phosphor Icons
 * @module
 */
export function PiPaintBrushBroadLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaintBrushBroadLight;
