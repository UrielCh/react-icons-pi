...
/**
 * HandGrabbingThin icon from Phosphor Icons
 * @module
 */
export function PiHandGrabbingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandGrabbingThin;
