...
/**
 * SplitVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiSplitVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitVerticalLight;
