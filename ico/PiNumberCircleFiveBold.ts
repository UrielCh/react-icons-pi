...
/**
 * NumberCircleFiveBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFiveBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFiveBold;
