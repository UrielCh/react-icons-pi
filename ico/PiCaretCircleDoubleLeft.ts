...
/**
 * CaretCircleDoubleLeft icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleLeft;
