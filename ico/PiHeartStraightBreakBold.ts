...
/**
 * HeartStraightBreakBold icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightBreakBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightBreakBold;
