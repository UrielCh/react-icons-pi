...
/**
 * ClosedCaptioningLight icon from Phosphor Icons
 * @module
 */
export function PiClosedCaptioningLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClosedCaptioningLight;
