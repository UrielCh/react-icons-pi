...
/**
 * CaretCircleLeftFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleLeftFill;
