...
/**
 * AlignBottomSimple icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomSimple;
