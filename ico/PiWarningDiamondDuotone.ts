...
/**
 * WarningDiamondDuotone icon from Phosphor Icons
 * @module
 */
export function PiWarningDiamondDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningDiamondDuotone;
