...
/**
 * CaretCircleDoubleRightFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleRightFill;
