...
/**
 * IntersectSquareThin icon from Phosphor Icons
 * @module
 */
export function PiIntersectSquareThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectSquareThin;
