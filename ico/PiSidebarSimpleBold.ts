...
/**
 * SidebarSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiSidebarSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSidebarSimpleBold;
