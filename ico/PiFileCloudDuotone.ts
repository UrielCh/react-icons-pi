...
/**
 * FileCloudDuotone icon from Phosphor Icons
 * @module
 */
export function PiFileCloudDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileCloudDuotone;
