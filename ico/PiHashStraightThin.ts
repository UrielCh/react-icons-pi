...
/**
 * HashStraightThin icon from Phosphor Icons
 * @module
 */
export function PiHashStraightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHashStraightThin;
