...
/**
 * AlignCenterHorizontalSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalSimpleFill;
