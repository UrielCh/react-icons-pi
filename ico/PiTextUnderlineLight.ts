...
/**
 * TextUnderlineLight icon from Phosphor Icons
 * @module
 */
export function PiTextUnderlineLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextUnderlineLight;
