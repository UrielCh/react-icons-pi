...
/**
 * NumberZeroDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberZeroDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberZeroDuotone;
