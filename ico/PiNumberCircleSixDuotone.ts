...
/**
 * NumberCircleSixDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSixDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSixDuotone;
