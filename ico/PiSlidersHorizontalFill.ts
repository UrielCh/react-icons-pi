...
/**
 * SlidersHorizontalFill icon from Phosphor Icons
 * @module
 */
export function PiSlidersHorizontalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSlidersHorizontalFill;
