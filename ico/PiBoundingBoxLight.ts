...
/**
 * BoundingBoxLight icon from Phosphor Icons
 * @module
 */
export function PiBoundingBoxLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoundingBoxLight;
