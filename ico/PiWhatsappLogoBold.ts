...
/**
 * WhatsappLogoBold icon from Phosphor Icons
 * @module
 */
export function PiWhatsappLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWhatsappLogoBold;
