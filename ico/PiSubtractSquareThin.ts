...
/**
 * SubtractSquareThin icon from Phosphor Icons
 * @module
 */
export function PiSubtractSquareThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSubtractSquareThin;
