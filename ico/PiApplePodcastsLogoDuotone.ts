...
/**
 * ApplePodcastsLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiApplePodcastsLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiApplePodcastsLogoDuotone;
