...
/**
 * AlignCenterHorizontalSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalSimpleThin;
