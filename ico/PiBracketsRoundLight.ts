...
/**
 * BracketsRoundLight icon from Phosphor Icons
 * @module
 */
export function PiBracketsRoundLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsRoundLight;
