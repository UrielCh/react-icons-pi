...
/**
 * HighlighterCircleLight icon from Phosphor Icons
 * @module
 */
export function PiHighlighterCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHighlighterCircleLight;
