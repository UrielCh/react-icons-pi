...
/**
 * SteeringWheelBold icon from Phosphor Icons
 * @module
 */
export function PiSteeringWheelBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSteeringWheelBold;
