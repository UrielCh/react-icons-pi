...
/**
 * PushPinSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleFill;
