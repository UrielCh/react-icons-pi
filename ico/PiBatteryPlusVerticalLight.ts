...
/**
 * BatteryPlusVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryPlusVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryPlusVerticalLight;
