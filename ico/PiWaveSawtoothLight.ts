...
/**
 * WaveSawtoothLight icon from Phosphor Icons
 * @module
 */
export function PiWaveSawtoothLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWaveSawtoothLight;
