...
/**
 * CirclesThreePlus icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreePlus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreePlus;
