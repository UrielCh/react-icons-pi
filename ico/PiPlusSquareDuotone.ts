...
/**
 * PlusSquareDuotone icon from Phosphor Icons
 * @module
 */
export function PiPlusSquareDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlusSquareDuotone;
