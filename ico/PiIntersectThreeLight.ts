...
/**
 * IntersectThreeLight icon from Phosphor Icons
 * @module
 */
export function PiIntersectThreeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectThreeLight;
