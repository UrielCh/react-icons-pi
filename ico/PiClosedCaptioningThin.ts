...
/**
 * ClosedCaptioningThin icon from Phosphor Icons
 * @module
 */
export function PiClosedCaptioningThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClosedCaptioningThin;
