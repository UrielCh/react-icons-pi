...
/**
 * ComputerTowerFill icon from Phosphor Icons
 * @module
 */
export function PiComputerTowerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiComputerTowerFill;
