...
/**
 * PushPinSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleThin;
