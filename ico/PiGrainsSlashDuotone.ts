...
/**
 * GrainsSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiGrainsSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGrainsSlashDuotone;
