...
/**
 * ArrowFatLineDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineDownThin;
