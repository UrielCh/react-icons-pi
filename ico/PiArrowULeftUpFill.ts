...
/**
 * ArrowULeftUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftUpFill;
