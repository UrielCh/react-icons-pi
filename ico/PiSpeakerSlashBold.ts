...
/**
 * SpeakerSlashBold icon from Phosphor Icons
 * @module
 */
export function PiSpeakerSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerSlashBold;
