...
/**
 * MarkerCircleBold icon from Phosphor Icons
 * @module
 */
export function PiMarkerCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMarkerCircleBold;
