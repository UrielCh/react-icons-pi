...
/**
 * AirplaneTiltThin icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTiltThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTiltThin;
