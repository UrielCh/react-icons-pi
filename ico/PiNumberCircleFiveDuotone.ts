...
/**
 * NumberCircleFiveDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFiveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFiveDuotone;
