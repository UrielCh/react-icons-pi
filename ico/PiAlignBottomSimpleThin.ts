...
/**
 * AlignBottomSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomSimpleThin;
