...
/**
 * BatteryVerticalHighFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalHighFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalHighFill;
