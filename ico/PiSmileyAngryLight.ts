...
/**
 * SmileyAngryLight icon from Phosphor Icons
 * @module
 */
export function PiSmileyAngryLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyAngryLight;
