...
/**
 * VideoCameraSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraSlashDuotone;
