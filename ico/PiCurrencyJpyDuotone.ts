...
/**
 * CurrencyJpyDuotone icon from Phosphor Icons
 * @module
 */
export function PiCurrencyJpyDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyJpyDuotone;
