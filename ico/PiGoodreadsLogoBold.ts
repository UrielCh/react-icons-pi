...
/**
 * GoodreadsLogoBold icon from Phosphor Icons
 * @module
 */
export function PiGoodreadsLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoodreadsLogoBold;
