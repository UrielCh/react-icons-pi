...
/**
 * MagnifyingGlassThin icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassThin;
