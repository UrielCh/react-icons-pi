...
/**
 * VideoCameraSlashBold icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraSlashBold;
