...
/**
 * LockLaminatedThin icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedThin;
