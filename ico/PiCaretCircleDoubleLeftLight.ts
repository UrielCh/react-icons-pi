...
/**
 * CaretCircleDoubleLeftLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleLeftLight;
