...
/**
 * DropHalfBottomFill icon from Phosphor Icons
 * @module
 */
export function PiDropHalfBottomFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDropHalfBottomFill;
