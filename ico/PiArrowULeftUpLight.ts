...
/**
 * ArrowULeftUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftUpLight;
