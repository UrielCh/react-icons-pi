...
/**
 * VideoCameraDuotone icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraDuotone;
