...
/**
 * NumberSquareThreeDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareThreeDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareThreeDuotone;
