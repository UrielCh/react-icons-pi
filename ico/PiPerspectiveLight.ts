...
/**
 * PerspectiveLight icon from Phosphor Icons
 * @module
 */
export function PiPerspectiveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPerspectiveLight;
