...
/**
 * SubtractSquareDuotone icon from Phosphor Icons
 * @module
 */
export function PiSubtractSquareDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSubtractSquareDuotone;
