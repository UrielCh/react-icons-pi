...
/**
 * UniteSquareLight icon from Phosphor Icons
 * @module
 */
export function PiUniteSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUniteSquareLight;
