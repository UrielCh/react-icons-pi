...
/**
 * PushPinSlashBold icon from Phosphor Icons
 * @module
 */
export function PiPushPinSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSlashBold;
