...
/**
 * CloudLightningBold icon from Phosphor Icons
 * @module
 */
export function PiCloudLightningBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudLightningBold;
