...
/**
 * SelectionPlusFill icon from Phosphor Icons
 * @module
 */
export function PiSelectionPlusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionPlusFill;
