...
/**
 * ContactlessPaymentLight icon from Phosphor Icons
 * @module
 */
export function PiContactlessPaymentLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiContactlessPaymentLight;
