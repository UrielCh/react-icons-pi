...
/**
 * TextAlignJustifyLight icon from Phosphor Icons
 * @module
 */
export function PiTextAlignJustifyLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignJustifyLight;
