...
/**
 * InstagramLogoFill icon from Phosphor Icons
 * @module
 */
export function PiInstagramLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiInstagramLogoFill;
