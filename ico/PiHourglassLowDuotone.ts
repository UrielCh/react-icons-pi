...
/**
 * HourglassLowDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassLowDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassLowDuotone;
