...
/**
 * HandsPrayingThin icon from Phosphor Icons
 * @module
 */
export function PiHandsPrayingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandsPrayingThin;
