...
/**
 * BracketsSquareBold icon from Phosphor Icons
 * @module
 */
export function PiBracketsSquareBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsSquareBold;
