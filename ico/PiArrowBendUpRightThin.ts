...
/**
 * ArrowBendUpRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpRightThin;
