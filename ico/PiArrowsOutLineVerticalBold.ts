...
/**
 * ArrowsOutLineVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineVerticalBold;
