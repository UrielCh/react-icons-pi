...
/**
 * SwimmingPoolLight icon from Phosphor Icons
 * @module
 */
export function PiSwimmingPoolLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSwimmingPoolLight;
