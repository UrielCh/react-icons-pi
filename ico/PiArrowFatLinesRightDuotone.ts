...
/**
 * ArrowFatLinesRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesRightDuotone;
