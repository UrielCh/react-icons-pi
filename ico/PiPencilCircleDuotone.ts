...
/**
 * PencilCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiPencilCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilCircleDuotone;
