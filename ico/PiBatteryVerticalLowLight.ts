...
/**
 * BatteryVerticalLowLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalLowLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalLowLight;
