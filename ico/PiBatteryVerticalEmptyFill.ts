...
/**
 * BatteryVerticalEmptyFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalEmptyFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalEmptyFill;
