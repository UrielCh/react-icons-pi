...
/**
 * BatteryEmptyLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryEmptyLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryEmptyLight;
