...
/**
 * FolderSimpleStar icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleStar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleStar;
