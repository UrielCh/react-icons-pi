...
/**
 * TerminalWindowBold icon from Phosphor Icons
 * @module
 */
export function PiTerminalWindowBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTerminalWindowBold;
