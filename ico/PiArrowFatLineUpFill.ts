...
/**
 * ArrowFatLineUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineUpFill;
