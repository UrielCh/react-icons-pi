...
/**
 * AddressBookDuotone icon from Phosphor Icons
 * @module
 */
export function PiAddressBookDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAddressBookDuotone;
