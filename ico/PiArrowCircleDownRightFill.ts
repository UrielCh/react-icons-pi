...
/**
 * ArrowCircleDownRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownRightFill;
