...
/**
 * CaretCircleDoubleUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleUpDuotone;
