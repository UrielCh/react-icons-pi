...
/**
 * CaretCircleUpFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpFill;
