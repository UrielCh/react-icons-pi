...
/**
 * ArrowSquareUpRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpRightThin;
