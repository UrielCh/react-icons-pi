...
/**
 * ArrowUDownLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownLeftFill;
