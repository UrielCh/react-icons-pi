...
/**
 * ArrowULeftDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftDownThin;
