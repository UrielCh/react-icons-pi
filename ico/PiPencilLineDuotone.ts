...
/**
 * PencilLineDuotone icon from Phosphor Icons
 * @module
 */
export function PiPencilLineDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilLineDuotone;
