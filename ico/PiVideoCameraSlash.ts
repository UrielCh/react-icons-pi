...
/**
 * VideoCameraSlash icon from Phosphor Icons
 * @module
 */
export function PiVideoCameraSlash(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiVideoCameraSlash;
