...
/**
 * FileMagnifyingGlassFill icon from Phosphor Icons
 * @module
 */
export function PiFileMagnifyingGlassFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileMagnifyingGlassFill;
