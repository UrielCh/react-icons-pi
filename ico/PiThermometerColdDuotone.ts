...
/**
 * ThermometerColdDuotone icon from Phosphor Icons
 * @module
 */
export function PiThermometerColdDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerColdDuotone;
