...
/**
 * WarningOctagonLight icon from Phosphor Icons
 * @module
 */
export function PiWarningOctagonLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningOctagonLight;
