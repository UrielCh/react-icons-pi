...
/**
 * PrescriptionLight icon from Phosphor Icons
 * @module
 */
export function PiPrescriptionLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPrescriptionLight;
