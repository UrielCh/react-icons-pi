...
/**
 * HourglassLowBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassLowBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassLowBold;
