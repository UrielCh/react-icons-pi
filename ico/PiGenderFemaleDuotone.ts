...
/**
 * GenderFemaleDuotone icon from Phosphor Icons
 * @module
 */
export function PiGenderFemaleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderFemaleDuotone;
