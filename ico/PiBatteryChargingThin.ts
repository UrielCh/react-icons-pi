...
/**
 * BatteryChargingThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingThin;
