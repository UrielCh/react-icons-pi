...
/**
 * DeviceMobileCameraThin icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileCameraThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileCameraThin;
