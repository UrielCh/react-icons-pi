...
/**
 * AlignCenterHorizontalSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterHorizontalSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterHorizontalSimpleBold;
