...
/**
 * GenderIntersexDuotone icon from Phosphor Icons
 * @module
 */
export function PiGenderIntersexDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderIntersexDuotone;
