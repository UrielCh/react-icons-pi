...
/**
 * PersonSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBold;
