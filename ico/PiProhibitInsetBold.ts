...
/**
 * ProhibitInsetBold icon from Phosphor Icons
 * @module
 */
export function PiProhibitInsetBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProhibitInsetBold;
