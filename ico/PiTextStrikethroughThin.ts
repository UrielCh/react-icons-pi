...
/**
 * TextStrikethroughThin icon from Phosphor Icons
 * @module
 */
export function PiTextStrikethroughThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextStrikethroughThin;
