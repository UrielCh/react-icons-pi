...
/**
 * PenNibStraightLight icon from Phosphor Icons
 * @module
 */
export function PiPenNibStraightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPenNibStraightLight;
