...
/**
 * NumberSquareEight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareEight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareEight;
