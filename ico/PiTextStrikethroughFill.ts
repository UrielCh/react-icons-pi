...
/**
 * TextStrikethroughFill icon from Phosphor Icons
 * @module
 */
export function PiTextStrikethroughFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextStrikethroughFill;
