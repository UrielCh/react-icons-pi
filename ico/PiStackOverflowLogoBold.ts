...
/**
 * StackOverflowLogoBold icon from Phosphor Icons
 * @module
 */
export function PiStackOverflowLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackOverflowLogoBold;
