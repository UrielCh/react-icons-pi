...
/**
 * ArrowCircleUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpThin;
