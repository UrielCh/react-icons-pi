...
/**
 * ComputerTowerLight icon from Phosphor Icons
 * @module
 */
export function PiComputerTowerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiComputerTowerLight;
