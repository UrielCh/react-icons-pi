...
/**
 * ArrowsInCardinalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsInCardinalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInCardinalBold;
