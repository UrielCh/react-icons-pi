...
/**
 * GameControllerBold icon from Phosphor Icons
 * @module
 */
export function PiGameControllerBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGameControllerBold;
