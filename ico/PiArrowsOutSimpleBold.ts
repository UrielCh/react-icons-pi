...
/**
 * ArrowsOutSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutSimpleBold;
