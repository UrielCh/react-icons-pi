...
/**
 * SelectionAllFill icon from Phosphor Icons
 * @module
 */
export function PiSelectionAllFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionAllFill;
