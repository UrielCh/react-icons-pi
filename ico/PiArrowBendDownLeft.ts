...
/**
 * ArrowBendDownLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownLeft;
