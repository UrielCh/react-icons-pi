...
/**
 * DeviceTabletThin icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletThin;
