...
/**
 * SkipForwardLight icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardLight;
