...
/**
 * TrainSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrainSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainSimpleDuotone;
