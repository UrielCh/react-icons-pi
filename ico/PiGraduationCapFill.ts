...
/**
 * GraduationCapFill icon from Phosphor Icons
 * @module
 */
export function PiGraduationCapFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraduationCapFill;
