...
/**
 * ArrowSquareRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareRightBold;
