...
/**
 * ArrowDownLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowDownLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownLeftBold;
