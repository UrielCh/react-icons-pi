...
/**
 * PresentationChartFill icon from Phosphor Icons
 * @module
 */
export function PiPresentationChartFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationChartFill;
