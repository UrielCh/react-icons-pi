...
/**
 * GooglePhotosLogoFill icon from Phosphor Icons
 * @module
 */
export function PiGooglePhotosLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePhotosLogoFill;
