...
/**
 * ArrowULeftUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowULeftUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowULeftUpBold;
