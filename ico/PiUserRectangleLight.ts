...
/**
 * UserRectangleLight icon from Phosphor Icons
 * @module
 */
export function PiUserRectangleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserRectangleLight;
