...
/**
 * ArrowBendUpRight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpRight;
