...
/**
 * ChargingStationBold icon from Phosphor Icons
 * @module
 */
export function PiChargingStationBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChargingStationBold;
