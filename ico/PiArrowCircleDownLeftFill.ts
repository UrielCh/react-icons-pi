...
/**
 * ArrowCircleDownLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLeftFill;
