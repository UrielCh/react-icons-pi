...
/**
 * AirplaneInFlightThin icon from Phosphor Icons
 * @module
 */
export function PiAirplaneInFlightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneInFlightThin;
