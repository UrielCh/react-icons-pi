...
/**
 * FileArrowDownLight icon from Phosphor Icons
 * @module
 */
export function PiFileArrowDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileArrowDownLight;
