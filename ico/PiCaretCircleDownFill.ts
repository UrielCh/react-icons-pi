...
/**
 * CaretCircleDownFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDownFill;
