...
/**
 * LockKeyOpenLight icon from Phosphor Icons
 * @module
 */
export function PiLockKeyOpenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockKeyOpenLight;
