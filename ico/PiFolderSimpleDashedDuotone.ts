...
/**
 * FolderSimpleDashedDuotone icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleDashedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleDashedDuotone;
