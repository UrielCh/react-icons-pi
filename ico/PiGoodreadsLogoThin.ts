...
/**
 * GoodreadsLogoThin icon from Phosphor Icons
 * @module
 */
export function PiGoodreadsLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoodreadsLogoThin;
