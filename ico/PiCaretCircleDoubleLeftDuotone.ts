...
/**
 * CaretCircleDoubleLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleLeftDuotone;
