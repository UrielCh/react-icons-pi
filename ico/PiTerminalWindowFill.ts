...
/**
 * TerminalWindowFill icon from Phosphor Icons
 * @module
 */
export function PiTerminalWindowFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTerminalWindowFill;
