...
/**
 * PersonSimpleThrowBold icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThrowBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThrowBold;
