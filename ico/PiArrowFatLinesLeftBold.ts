...
/**
 * ArrowFatLinesLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesLeftBold;
