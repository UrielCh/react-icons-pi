...
/**
 * CrosshairSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiCrosshairSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCrosshairSimpleDuotone;
