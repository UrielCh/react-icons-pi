...
/**
 * EnvelopeSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleThin;
