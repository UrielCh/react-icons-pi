...
/**
 * CameraRotateBold icon from Phosphor Icons
 * @module
 */
export function PiCameraRotateBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraRotateBold;
