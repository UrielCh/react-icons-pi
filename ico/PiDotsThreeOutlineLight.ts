...
/**
 * DotsThreeOutlineLight icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineLight;
