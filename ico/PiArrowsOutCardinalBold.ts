...
/**
 * ArrowsOutCardinalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutCardinalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutCardinalBold;
