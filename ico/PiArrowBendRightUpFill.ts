...
/**
 * ArrowBendRightUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightUpFill;
