...
/**
 * LinkSimpleHorizontalBreakFill icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalBreakFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalBreakFill;
