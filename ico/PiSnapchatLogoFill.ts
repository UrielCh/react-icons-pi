...
/**
 * SnapchatLogoFill icon from Phosphor Icons
 * @module
 */
export function PiSnapchatLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSnapchatLogoFill;
