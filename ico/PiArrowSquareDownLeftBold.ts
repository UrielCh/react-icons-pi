...
/**
 * ArrowSquareDownLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownLeftBold;
