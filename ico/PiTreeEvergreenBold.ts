...
/**
 * TreeEvergreenBold icon from Phosphor Icons
 * @module
 */
export function PiTreeEvergreenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTreeEvergreenBold;
