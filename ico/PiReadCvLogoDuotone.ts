...
/**
 * ReadCvLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiReadCvLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiReadCvLogoDuotone;
