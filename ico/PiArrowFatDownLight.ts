...
/**
 * ArrowFatDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatDownLight;
