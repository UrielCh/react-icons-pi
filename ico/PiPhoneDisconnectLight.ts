...
/**
 * PhoneDisconnectLight icon from Phosphor Icons
 * @module
 */
export function PiPhoneDisconnectLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneDisconnectLight;
