...
/**
 * FolderDashedFill icon from Phosphor Icons
 * @module
 */
export function PiFolderDashedFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderDashedFill;
