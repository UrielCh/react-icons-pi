...
/**
 * ArrowElbowDownLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowDownLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowDownLeftFill;
