...
/**
 * PlusCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiPlusCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlusCircleDuotone;
