...
/**
 * LinkSimpleBreakFill icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleBreakFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleBreakFill;
