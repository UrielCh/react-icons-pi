...
/**
 * GenderFemaleBold icon from Phosphor Icons
 * @module
 */
export function PiGenderFemaleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderFemaleBold;
