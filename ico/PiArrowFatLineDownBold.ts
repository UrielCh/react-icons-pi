...
/**
 * ArrowFatLineDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineDownBold;
