...
/**
 * ArrowFatLinesRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesRightFill;
