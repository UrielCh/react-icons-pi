...
/**
 * ClockClockwiseFill icon from Phosphor Icons
 * @module
 */
export function PiClockClockwiseFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockClockwiseFill;
