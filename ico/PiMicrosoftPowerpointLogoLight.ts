...
/**
 * MicrosoftPowerpointLogoLight icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftPowerpointLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftPowerpointLogoLight;
