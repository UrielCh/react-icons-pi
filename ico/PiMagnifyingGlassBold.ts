...
/**
 * MagnifyingGlassBold icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassBold;
