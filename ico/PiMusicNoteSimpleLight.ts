...
/**
 * MusicNoteSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiMusicNoteSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMusicNoteSimpleLight;
