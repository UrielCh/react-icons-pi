...
/**
 * FolderSimpleLockBold icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleLockBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleLockBold;
