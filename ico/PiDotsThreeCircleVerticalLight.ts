...
/**
 * DotsThreeCircleVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleVerticalLight;
