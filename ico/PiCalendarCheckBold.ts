...
/**
 * CalendarCheckBold icon from Phosphor Icons
 * @module
 */
export function PiCalendarCheckBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarCheckBold;
