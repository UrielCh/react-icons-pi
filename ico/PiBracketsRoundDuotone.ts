...
/**
 * BracketsRoundDuotone icon from Phosphor Icons
 * @module
 */
export function PiBracketsRoundDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsRoundDuotone;
