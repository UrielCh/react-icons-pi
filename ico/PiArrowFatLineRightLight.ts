...
/**
 * ArrowFatLineRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineRightLight;
