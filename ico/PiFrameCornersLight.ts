...
/**
 * FrameCornersLight icon from Phosphor Icons
 * @module
 */
export function PiFrameCornersLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFrameCornersLight;
