...
/**
 * HourglassSimpleMediumDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleMediumDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleMediumDuotone;
