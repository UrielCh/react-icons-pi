...
/**
 * SmileyStickerDuotone icon from Phosphor Icons
 * @module
 */
export function PiSmileyStickerDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyStickerDuotone;
