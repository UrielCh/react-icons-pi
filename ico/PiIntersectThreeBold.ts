...
/**
 * IntersectThreeBold icon from Phosphor Icons
 * @module
 */
export function PiIntersectThreeBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectThreeBold;
