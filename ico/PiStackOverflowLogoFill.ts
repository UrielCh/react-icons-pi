...
/**
 * StackOverflowLogoFill icon from Phosphor Icons
 * @module
 */
export function PiStackOverflowLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackOverflowLogoFill;
