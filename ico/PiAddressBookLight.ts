...
/**
 * AddressBookLight icon from Phosphor Icons
 * @module
 */
export function PiAddressBookLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAddressBookLight;
