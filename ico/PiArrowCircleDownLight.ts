...
/**
 * ArrowCircleDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownLight;
