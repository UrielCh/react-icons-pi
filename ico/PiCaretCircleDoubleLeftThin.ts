...
/**
 * CaretCircleDoubleLeftThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleLeftThin;
