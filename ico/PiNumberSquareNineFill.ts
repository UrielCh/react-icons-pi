...
/**
 * NumberSquareNineFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareNineFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareNineFill;
