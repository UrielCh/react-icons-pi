...
/**
 * PushPinSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleLight;
