...
/**
 * HandbagSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiHandbagSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandbagSimpleLight;
