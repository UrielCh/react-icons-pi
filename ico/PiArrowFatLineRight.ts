...
/**
 * ArrowFatLineRight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineRight;
