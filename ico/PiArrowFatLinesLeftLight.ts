...
/**
 * ArrowFatLinesLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesLeftLight;
