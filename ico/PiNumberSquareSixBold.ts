...
/**
 * NumberSquareSixBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSixBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSixBold;
