...
/**
 * CirclesThreeThin icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreeThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreeThin;
