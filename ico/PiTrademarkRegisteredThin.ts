...
/**
 * TrademarkRegisteredThin icon from Phosphor Icons
 * @module
 */
export function PiTrademarkRegisteredThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrademarkRegisteredThin;
