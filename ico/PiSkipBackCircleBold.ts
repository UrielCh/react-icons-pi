...
/**
 * SkipBackCircleBold icon from Phosphor Icons
 * @module
 */
export function PiSkipBackCircleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipBackCircleBold;
