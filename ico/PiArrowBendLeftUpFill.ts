...
/**
 * ArrowBendLeftUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftUpFill;
