...
/**
 * GenderTransgenderThin icon from Phosphor Icons
 * @module
 */
export function PiGenderTransgenderThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderTransgenderThin;
