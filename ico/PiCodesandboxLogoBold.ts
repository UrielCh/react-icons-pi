...
/**
 * CodesandboxLogoBold icon from Phosphor Icons
 * @module
 */
export function PiCodesandboxLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodesandboxLogoBold;
