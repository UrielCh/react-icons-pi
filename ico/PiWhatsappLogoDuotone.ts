...
/**
 * WhatsappLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiWhatsappLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWhatsappLogoDuotone;
