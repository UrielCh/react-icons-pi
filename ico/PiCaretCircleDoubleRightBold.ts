...
/**
 * CaretCircleDoubleRightBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleRightBold;
