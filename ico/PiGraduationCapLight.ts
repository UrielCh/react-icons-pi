...
/**
 * GraduationCapLight icon from Phosphor Icons
 * @module
 */
export function PiGraduationCapLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraduationCapLight;
