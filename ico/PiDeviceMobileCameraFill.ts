...
/**
 * DeviceMobileCameraFill icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileCameraFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileCameraFill;
