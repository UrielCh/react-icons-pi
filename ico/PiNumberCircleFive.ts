...
/**
 * NumberCircleFive icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFive(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFive;
