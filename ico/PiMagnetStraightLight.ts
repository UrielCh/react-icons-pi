...
/**
 * MagnetStraightLight icon from Phosphor Icons
 * @module
 */
export function PiMagnetStraightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnetStraightLight;
