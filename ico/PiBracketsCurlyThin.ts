...
/**
 * BracketsCurlyThin icon from Phosphor Icons
 * @module
 */
export function PiBracketsCurlyThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsCurlyThin;
