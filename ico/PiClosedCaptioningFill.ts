...
/**
 * ClosedCaptioningFill icon from Phosphor Icons
 * @module
 */
export function PiClosedCaptioningFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClosedCaptioningFill;
