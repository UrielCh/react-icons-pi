...
/**
 * TextAUnderlineFill icon from Phosphor Icons
 * @module
 */
export function PiTextAUnderlineFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAUnderlineFill;
