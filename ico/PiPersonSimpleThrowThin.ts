...
/**
 * PersonSimpleThrowThin icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThrowThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThrowThin;
