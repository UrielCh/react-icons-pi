...
/**
 * PencilSimpleLineFill icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleLineFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleLineFill;
