...
/**
 * ArrowLineDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownThin;
