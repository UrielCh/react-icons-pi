...
/**
 * ArrowArcRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowArcRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcRightFill;
