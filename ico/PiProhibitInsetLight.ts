...
/**
 * ProhibitInsetLight icon from Phosphor Icons
 * @module
 */
export function PiProhibitInsetLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProhibitInsetLight;
