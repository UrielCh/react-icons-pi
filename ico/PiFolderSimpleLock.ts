...
/**
 * FolderSimpleLock icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleLock(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleLock;
