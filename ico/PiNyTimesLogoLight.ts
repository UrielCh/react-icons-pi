...
/**
 * NyTimesLogoLight icon from Phosphor Icons
 * @module
 */
export function PiNyTimesLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNyTimesLogoLight;
