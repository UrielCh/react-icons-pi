...
/**
 * BatteryWarningVertical icon from Phosphor Icons
 * @module
 */
export function PiBatteryWarningVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryWarningVertical;
