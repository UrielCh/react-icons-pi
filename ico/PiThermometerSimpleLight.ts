...
/**
 * ThermometerSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiThermometerSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerSimpleLight;
