...
/**
 * CaretDoubleRightFill icon from Phosphor Icons
 * @module
 */
export function PiCaretDoubleRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretDoubleRightFill;
