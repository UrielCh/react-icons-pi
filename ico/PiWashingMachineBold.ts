...
/**
 * WashingMachineBold icon from Phosphor Icons
 * @module
 */
export function PiWashingMachineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWashingMachineBold;
