...
/**
 * SlidersHorizontal icon from Phosphor Icons
 * @module
 */
export function PiSlidersHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSlidersHorizontal;
