...
/**
 * PresentationLight icon from Phosphor Icons
 * @module
 */
export function PiPresentationLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationLight;
