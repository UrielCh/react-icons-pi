...
/**
 * GitlabLogoSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoSimpleThin;
