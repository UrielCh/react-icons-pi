...
/**
 * StackSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiStackSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackSimpleDuotone;
