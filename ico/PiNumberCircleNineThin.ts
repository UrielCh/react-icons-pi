...
/**
 * NumberCircleNineThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleNineThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleNineThin;
