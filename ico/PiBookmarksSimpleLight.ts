...
/**
 * BookmarksSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiBookmarksSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookmarksSimpleLight;
