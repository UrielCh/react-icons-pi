...
/**
 * WarningCircleFill icon from Phosphor Icons
 * @module
 */
export function PiWarningCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningCircleFill;
