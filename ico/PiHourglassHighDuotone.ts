...
/**
 * HourglassHighDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassHighDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassHighDuotone;
