...
/**
 * BatteryChargingVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingVerticalFill;
