...
/**
 * DotsSixVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiDotsSixVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsSixVerticalLight;
