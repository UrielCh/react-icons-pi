...
/**
 * NumberSquareOneFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareOneFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareOneFill;
