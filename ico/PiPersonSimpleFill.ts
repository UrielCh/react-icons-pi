...
/**
 * PersonSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleFill;
