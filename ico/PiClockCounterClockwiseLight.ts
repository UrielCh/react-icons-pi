...
/**
 * ClockCounterClockwiseLight icon from Phosphor Icons
 * @module
 */
export function PiClockCounterClockwiseLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCounterClockwiseLight;
