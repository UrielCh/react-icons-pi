...
/**
 * GenderNonbinaryDuotone icon from Phosphor Icons
 * @module
 */
export function PiGenderNonbinaryDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNonbinaryDuotone;
