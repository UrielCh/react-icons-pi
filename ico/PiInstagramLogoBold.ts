...
/**
 * InstagramLogoBold icon from Phosphor Icons
 * @module
 */
export function PiInstagramLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiInstagramLogoBold;
