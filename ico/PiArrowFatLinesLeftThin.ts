...
/**
 * ArrowFatLinesLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesLeftThin;
