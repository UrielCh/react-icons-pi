...
/**
 * ShoppingBagLight icon from Phosphor Icons
 * @module
 */
export function PiShoppingBagLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShoppingBagLight;
