...
/**
 * DeviceMobileSpeakerThin icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileSpeakerThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileSpeakerThin;
