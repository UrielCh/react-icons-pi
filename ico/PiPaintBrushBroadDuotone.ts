...
/**
 * PaintBrushBroadDuotone icon from Phosphor Icons
 * @module
 */
export function PiPaintBrushBroadDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaintBrushBroadDuotone;
