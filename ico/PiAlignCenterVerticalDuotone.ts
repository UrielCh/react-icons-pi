...
/**
 * AlignCenterVerticalDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalDuotone;
