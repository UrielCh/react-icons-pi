...
/**
 * FileDashedDuotone icon from Phosphor Icons
 * @module
 */
export function PiFileDashedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileDashedDuotone;
