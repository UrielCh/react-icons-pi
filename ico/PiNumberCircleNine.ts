...
/**
 * NumberCircleNine icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleNine(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleNine;
