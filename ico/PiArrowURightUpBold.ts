...
/**
 * ArrowURightUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowURightUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightUpBold;
