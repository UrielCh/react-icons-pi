...
/**
 * AnchorSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAnchorSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAnchorSimpleThin;
