...
/**
 * BellSimpleRingingThin icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleRingingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleRingingThin;
