...
/**
 * SelectionBackgroundLight icon from Phosphor Icons
 * @module
 */
export function PiSelectionBackgroundLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionBackgroundLight;
