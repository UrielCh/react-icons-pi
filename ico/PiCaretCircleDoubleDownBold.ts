...
/**
 * CaretCircleDoubleDownBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleDownBold;
