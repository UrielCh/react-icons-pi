...
/**
 * ArrowsInLineVertical icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineVertical;
