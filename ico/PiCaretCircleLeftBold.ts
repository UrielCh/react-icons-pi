...
/**
 * CaretCircleLeftBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleLeftBold;
