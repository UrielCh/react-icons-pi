...
/**
 * NumberCircleSevenThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSevenThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSevenThin;
