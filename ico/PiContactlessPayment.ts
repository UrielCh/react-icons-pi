...
/**
 * ContactlessPayment icon from Phosphor Icons
 * @module
 */
export function PiContactlessPayment(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiContactlessPayment;
