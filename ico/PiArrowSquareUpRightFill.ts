...
/**
 * ArrowSquareUpRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpRightFill;
