...
/**
 * TrainRegionalLight icon from Phosphor Icons
 * @module
 */
export function PiTrainRegionalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainRegionalLight;
