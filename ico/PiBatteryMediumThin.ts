...
/**
 * BatteryMediumThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryMediumThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryMediumThin;
