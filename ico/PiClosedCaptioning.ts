...
/**
 * ClosedCaptioning icon from Phosphor Icons
 * @module
 */
export function PiClosedCaptioning(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClosedCaptioning;
