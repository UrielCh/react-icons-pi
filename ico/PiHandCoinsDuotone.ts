...
/**
 * HandCoinsDuotone icon from Phosphor Icons
 * @module
 */
export function PiHandCoinsDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandCoinsDuotone;
