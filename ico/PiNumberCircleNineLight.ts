...
/**
 * NumberCircleNineLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleNineLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleNineLight;
