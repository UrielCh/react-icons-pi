...
/**
 * CirclesThreeBold icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreeBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreeBold;
