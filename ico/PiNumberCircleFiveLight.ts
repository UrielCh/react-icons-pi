...
/**
 * NumberCircleFiveLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFiveLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFiveLight;
