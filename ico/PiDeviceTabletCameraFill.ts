...
/**
 * DeviceTabletCameraFill icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletCameraFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletCameraFill;
