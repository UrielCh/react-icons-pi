...
/**
 * StarAndCrescentBold icon from Phosphor Icons
 * @module
 */
export function PiStarAndCrescentBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarAndCrescentBold;
