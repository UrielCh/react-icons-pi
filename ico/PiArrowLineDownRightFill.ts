...
/**
 * ArrowLineDownRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowLineDownRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineDownRightFill;
