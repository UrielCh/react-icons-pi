...
/**
 * EnvelopeOpenBold icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeOpenBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeOpenBold;
