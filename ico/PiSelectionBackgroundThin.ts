...
/**
 * SelectionBackgroundThin icon from Phosphor Icons
 * @module
 */
export function PiSelectionBackgroundThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionBackgroundThin;
