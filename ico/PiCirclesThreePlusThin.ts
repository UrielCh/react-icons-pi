...
/**
 * CirclesThreePlusThin icon from Phosphor Icons
 * @module
 */
export function PiCirclesThreePlusThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCirclesThreePlusThin;
