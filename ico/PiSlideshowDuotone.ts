...
/**
 * SlideshowDuotone icon from Phosphor Icons
 * @module
 */
export function PiSlideshowDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSlideshowDuotone;
