...
/**
 * ArrowLineLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowLineLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineLeftThin;
