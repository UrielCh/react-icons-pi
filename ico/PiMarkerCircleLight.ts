...
/**
 * MarkerCircleLight icon from Phosphor Icons
 * @module
 */
export function PiMarkerCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMarkerCircleLight;
