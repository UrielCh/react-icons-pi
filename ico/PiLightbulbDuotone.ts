...
/**
 * LightbulbDuotone icon from Phosphor Icons
 * @module
 */
export function PiLightbulbDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightbulbDuotone;
