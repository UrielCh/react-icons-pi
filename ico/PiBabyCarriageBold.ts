...
/**
 * BabyCarriageBold icon from Phosphor Icons
 * @module
 */
export function PiBabyCarriageBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBabyCarriageBold;
