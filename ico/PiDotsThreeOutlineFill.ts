...
/**
 * DotsThreeOutlineFill icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineFill;
