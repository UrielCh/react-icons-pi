...
/**
 * NumberSevenLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSevenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSevenLight;
