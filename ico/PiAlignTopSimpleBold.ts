...
/**
 * AlignTopSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAlignTopSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignTopSimpleBold;
