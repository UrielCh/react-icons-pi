...
/**
 * WaveSawtoothBold icon from Phosphor Icons
 * @module
 */
export function PiWaveSawtoothBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWaveSawtoothBold;
