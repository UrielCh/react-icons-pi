...
/**
 * DotsSixVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiDotsSixVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsSixVerticalBold;
