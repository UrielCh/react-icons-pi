...
/**
 * BatteryVerticalFullLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalFullLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalFullLight;
