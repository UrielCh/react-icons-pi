...
/**
 * DotsThreeOutlineThin icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineThin;
