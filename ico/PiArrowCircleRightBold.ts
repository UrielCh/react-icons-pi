...
/**
 * ArrowCircleRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleRightBold;
