...
/**
 * CurrencyInrLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyInrLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyInrLight;
