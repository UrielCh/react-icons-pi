...
/**
 * CaretCircleUpDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpDownDuotone;
