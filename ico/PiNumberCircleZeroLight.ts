...
/**
 * NumberCircleZeroLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleZeroLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleZeroLight;
