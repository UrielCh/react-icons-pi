...
/**
 * ArrowElbowLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowLeftFill;
