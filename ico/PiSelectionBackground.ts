...
/**
 * SelectionBackground icon from Phosphor Icons
 * @module
 */
export function PiSelectionBackground(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionBackground;
