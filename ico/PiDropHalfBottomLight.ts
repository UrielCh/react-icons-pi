...
/**
 * DropHalfBottomLight icon from Phosphor Icons
 * @module
 */
export function PiDropHalfBottomLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDropHalfBottomLight;
