...
/**
 * PrescriptionFill icon from Phosphor Icons
 * @module
 */
export function PiPrescriptionFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPrescriptionFill;
