...
/**
 * ClockCounterClockwiseBold icon from Phosphor Icons
 * @module
 */
export function PiClockCounterClockwiseBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCounterClockwiseBold;
