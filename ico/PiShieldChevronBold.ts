...
/**
 * ShieldChevronBold icon from Phosphor Icons
 * @module
 */
export function PiShieldChevronBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShieldChevronBold;
