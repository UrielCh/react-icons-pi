...
/**
 * NewspaperClipping icon from Phosphor Icons
 * @module
 */
export function PiNewspaperClipping(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNewspaperClipping;
