...
/**
 * EyedropperSampleDuotone icon from Phosphor Icons
 * @module
 */
export function PiEyedropperSampleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperSampleDuotone;
