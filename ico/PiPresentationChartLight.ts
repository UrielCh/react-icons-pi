...
/**
 * PresentationChartLight icon from Phosphor Icons
 * @module
 */
export function PiPresentationChartLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationChartLight;
