...
/**
 * IntersectSquareFill icon from Phosphor Icons
 * @module
 */
export function PiIntersectSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectSquareFill;
