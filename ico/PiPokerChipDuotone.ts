...
/**
 * PokerChipDuotone icon from Phosphor Icons
 * @module
 */
export function PiPokerChipDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPokerChipDuotone;
