...
/**
 * ArrowCircleUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpBold;
