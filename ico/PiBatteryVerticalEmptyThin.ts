...
/**
 * BatteryVerticalEmptyThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalEmptyThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalEmptyThin;
