...
/**
 * MinusCircleLight icon from Phosphor Icons
 * @module
 */
export function PiMinusCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMinusCircleLight;
