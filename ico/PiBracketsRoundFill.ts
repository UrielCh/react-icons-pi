...
/**
 * BracketsRoundFill icon from Phosphor Icons
 * @module
 */
export function PiBracketsRoundFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsRoundFill;
