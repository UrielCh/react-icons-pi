...
/**
 * CaretCircleUpDownFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpDownFill;
