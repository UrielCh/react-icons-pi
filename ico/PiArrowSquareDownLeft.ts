...
/**
 * ArrowSquareDownLeft icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownLeft;
