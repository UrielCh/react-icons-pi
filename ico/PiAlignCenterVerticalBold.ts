...
/**
 * AlignCenterVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalBold;
