...
/**
 * LinkSimpleHorizontalBreakBold icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalBreakBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalBreakBold;
