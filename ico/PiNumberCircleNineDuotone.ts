...
/**
 * NumberCircleNineDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleNineDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleNineDuotone;
