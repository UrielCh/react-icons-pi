...
/**
 * CameraRotateThin icon from Phosphor Icons
 * @module
 */
export function PiCameraRotateThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraRotateThin;
