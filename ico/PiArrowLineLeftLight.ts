...
/**
 * ArrowLineLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineLeftLight;
