...
/**
 * NumberCircleThreeThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleThreeThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleThreeThin;
