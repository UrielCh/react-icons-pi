...
/**
 * IdentificationCard icon from Phosphor Icons
 * @module
 */
export function PiIdentificationCard(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationCard;
