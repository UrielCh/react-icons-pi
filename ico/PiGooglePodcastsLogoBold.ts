...
/**
 * GooglePodcastsLogoBold icon from Phosphor Icons
 * @module
 */
export function PiGooglePodcastsLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePodcastsLogoBold;
