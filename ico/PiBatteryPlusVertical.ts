...
/**
 * BatteryPlusVertical icon from Phosphor Icons
 * @module
 */
export function PiBatteryPlusVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryPlusVertical;
