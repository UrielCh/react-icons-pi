...
/**
 * CellSignalMediumThin icon from Phosphor Icons
 * @module
 */
export function PiCellSignalMediumThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalMediumThin;
