...
/**
 * PersonSimpleWalkLight icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleWalkLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleWalkLight;
