...
/**
 * ChalkboardTeacher icon from Phosphor Icons
 * @module
 */
export function PiChalkboardTeacher(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChalkboardTeacher;
