...
/**
 * ContactlessPaymentDuotone icon from Phosphor Icons
 * @module
 */
export function PiContactlessPaymentDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiContactlessPaymentDuotone;
