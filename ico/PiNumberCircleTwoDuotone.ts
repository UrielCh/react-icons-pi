...
/**
 * NumberCircleTwoDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleTwoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleTwoDuotone;
