...
/**
 * UserCirclePlusThin icon from Phosphor Icons
 * @module
 */
export function PiUserCirclePlusThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCirclePlusThin;
