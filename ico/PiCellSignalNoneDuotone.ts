...
/**
 * CellSignalNoneDuotone icon from Phosphor Icons
 * @module
 */
export function PiCellSignalNoneDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalNoneDuotone;
