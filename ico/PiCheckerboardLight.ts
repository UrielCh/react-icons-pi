...
/**
 * CheckerboardLight icon from Phosphor Icons
 * @module
 */
export function PiCheckerboardLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckerboardLight;
