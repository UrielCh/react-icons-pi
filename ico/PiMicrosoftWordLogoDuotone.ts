...
/**
 * MicrosoftWordLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftWordLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftWordLogoDuotone;
