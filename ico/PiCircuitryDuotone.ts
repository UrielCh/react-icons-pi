...
/**
 * CircuitryDuotone icon from Phosphor Icons
 * @module
 */
export function PiCircuitryDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircuitryDuotone;
