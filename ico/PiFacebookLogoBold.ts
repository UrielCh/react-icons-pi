...
/**
 * FacebookLogoBold icon from Phosphor Icons
 * @module
 */
export function PiFacebookLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFacebookLogoBold;
