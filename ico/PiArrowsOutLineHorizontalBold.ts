...
/**
 * ArrowsOutLineHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineHorizontalBold;
