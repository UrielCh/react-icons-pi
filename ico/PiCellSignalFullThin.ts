...
/**
 * CellSignalFullThin icon from Phosphor Icons
 * @module
 */
export function PiCellSignalFullThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalFullThin;
