...
/**
 * AppStoreLogoBold icon from Phosphor Icons
 * @module
 */
export function PiAppStoreLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAppStoreLogoBold;
