...
/**
 * MagnifyingGlassPlusFill icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassPlusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassPlusFill;
