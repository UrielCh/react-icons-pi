...
/**
 * AlignBottomSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomSimpleBold;
