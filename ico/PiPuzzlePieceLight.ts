...
/**
 * PuzzlePieceLight icon from Phosphor Icons
 * @module
 */
export function PiPuzzlePieceLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPuzzlePieceLight;
