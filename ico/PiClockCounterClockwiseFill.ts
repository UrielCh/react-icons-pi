...
/**
 * ClockCounterClockwiseFill icon from Phosphor Icons
 * @module
 */
export function PiClockCounterClockwiseFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCounterClockwiseFill;
