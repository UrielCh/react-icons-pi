...
/**
 * ArrowSquareDownRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownRightLight;
