...
/**
 * ThermometerSimple icon from Phosphor Icons
 * @module
 */
export function PiThermometerSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerSimple;
