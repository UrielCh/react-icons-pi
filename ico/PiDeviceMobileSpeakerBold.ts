...
/**
 * DeviceMobileSpeakerBold icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileSpeakerBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileSpeakerBold;
