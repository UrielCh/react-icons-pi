...
/**
 * ExcludeSquareThin icon from Phosphor Icons
 * @module
 */
export function PiExcludeSquareThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiExcludeSquareThin;
