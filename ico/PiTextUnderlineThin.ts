...
/**
 * TextUnderlineThin icon from Phosphor Icons
 * @module
 */
export function PiTextUnderlineThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextUnderlineThin;
