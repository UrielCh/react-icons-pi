...
/**
 * NumberSquareZeroBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareZeroBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareZeroBold;
