...
/**
 * AlignCenterVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalLight;
