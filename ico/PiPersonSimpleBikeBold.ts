...
/**
 * PersonSimpleBikeBold icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleBikeBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleBikeBold;
