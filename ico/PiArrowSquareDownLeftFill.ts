...
/**
 * ArrowSquareDownLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownLeftFill;
