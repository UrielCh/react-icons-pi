...
/**
 * GameControllerThin icon from Phosphor Icons
 * @module
 */
export function PiGameControllerThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGameControllerThin;
