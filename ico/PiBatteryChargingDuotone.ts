...
/**
 * BatteryChargingDuotone icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingDuotone;
