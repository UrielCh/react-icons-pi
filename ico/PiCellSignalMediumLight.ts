...
/**
 * CellSignalMediumLight icon from Phosphor Icons
 * @module
 */
export function PiCellSignalMediumLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalMediumLight;
