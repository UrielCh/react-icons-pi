...
/**
 * NumberSquareThree icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareThree(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareThree;
