...
/**
 * ThermometerSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiThermometerSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiThermometerSimpleThin;
