...
/**
 * SelectionAllDuotone icon from Phosphor Icons
 * @module
 */
export function PiSelectionAllDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionAllDuotone;
