...
/**
 * SoundcloudLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiSoundcloudLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSoundcloudLogoDuotone;
