...
/**
 * TelevisionSimple icon from Phosphor Icons
 * @module
 */
export function PiTelevisionSimple(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTelevisionSimple;
