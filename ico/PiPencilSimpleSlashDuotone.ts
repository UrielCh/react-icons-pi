...
/**
 * PencilSimpleSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleSlashDuotone;
