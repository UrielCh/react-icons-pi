...
/**
 * CircleDashedFill icon from Phosphor Icons
 * @module
 */
export function PiCircleDashedFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleDashedFill;
