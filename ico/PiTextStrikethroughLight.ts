...
/**
 * TextStrikethroughLight icon from Phosphor Icons
 * @module
 */
export function PiTextStrikethroughLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextStrikethroughLight;
