...
/**
 * BatteryVerticalMedium icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalMedium(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalMedium;
