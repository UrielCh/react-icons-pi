...
/**
 * BatteryVerticalHighBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalHighBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalHighBold;
