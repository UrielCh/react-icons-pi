...
/**
 * ArrowsInLineHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineHorizontalThin;
