...
/**
 * FolderDashedLight icon from Phosphor Icons
 * @module
 */
export function PiFolderDashedLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderDashedLight;
