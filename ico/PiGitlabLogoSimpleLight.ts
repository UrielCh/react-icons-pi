...
/**
 * GitlabLogoSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoSimpleLight;
