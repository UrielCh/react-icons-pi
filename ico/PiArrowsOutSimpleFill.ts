...
/**
 * ArrowsOutSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutSimpleFill;
