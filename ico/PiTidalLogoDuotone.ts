...
/**
 * TidalLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiTidalLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTidalLogoDuotone;
