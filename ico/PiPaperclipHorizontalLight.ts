...
/**
 * PaperclipHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiPaperclipHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipHorizontalLight;
