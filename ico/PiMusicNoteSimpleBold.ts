...
/**
 * MusicNoteSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiMusicNoteSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMusicNoteSimpleBold;
