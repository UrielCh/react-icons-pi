...
/**
 * UserCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiUserCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleDuotone;
