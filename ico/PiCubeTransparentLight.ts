...
/**
 * CubeTransparentLight icon from Phosphor Icons
 * @module
 */
export function PiCubeTransparentLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCubeTransparentLight;
