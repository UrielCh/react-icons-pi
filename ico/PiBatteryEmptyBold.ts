...
/**
 * BatteryEmptyBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryEmptyBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryEmptyBold;
