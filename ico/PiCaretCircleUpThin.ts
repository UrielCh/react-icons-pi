...
/**
 * CaretCircleUpThin icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleUpThin;
