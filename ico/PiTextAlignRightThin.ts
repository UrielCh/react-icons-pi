...
/**
 * TextAlignRightThin icon from Phosphor Icons
 * @module
 */
export function PiTextAlignRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignRightThin;
