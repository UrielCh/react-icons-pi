...
/**
 * NumberSquareEightLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareEightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareEightLight;
