...
/**
 * TrafficSignalFill icon from Phosphor Icons
 * @module
 */
export function PiTrafficSignalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficSignalFill;
