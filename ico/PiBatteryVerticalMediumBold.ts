...
/**
 * BatteryVerticalMediumBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalMediumBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalMediumBold;
