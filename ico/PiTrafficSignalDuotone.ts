...
/**
 * TrafficSignalDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrafficSignalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficSignalDuotone;
