...
/**
 * ArrowBendDoubleUpRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpRightThin;
