...
/**
 * TreeEvergreenFill icon from Phosphor Icons
 * @module
 */
export function PiTreeEvergreenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTreeEvergreenFill;
