...
/**
 * TextAlignRightLight icon from Phosphor Icons
 * @module
 */
export function PiTextAlignRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignRightLight;
