...
/**
 * ArrowFatLinesUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesUpLight;
