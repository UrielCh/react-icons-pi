...
/**
 * SlidersHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiSlidersHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSlidersHorizontalLight;
