...
/**
 * PushPinSimpleSlashBold icon from Phosphor Icons
 * @module
 */
export function PiPushPinSimpleSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPushPinSimpleSlashBold;
