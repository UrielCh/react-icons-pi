...
/**
 * LockSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiLockSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockSimpleDuotone;
