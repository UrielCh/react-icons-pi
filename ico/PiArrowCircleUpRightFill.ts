...
/**
 * ArrowCircleUpRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpRightFill;
