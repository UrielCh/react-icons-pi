...
/**
 * ImageSquareDuotone icon from Phosphor Icons
 * @module
 */
export function PiImageSquareDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiImageSquareDuotone;
