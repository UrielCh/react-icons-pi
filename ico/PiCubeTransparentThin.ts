...
/**
 * CubeTransparentThin icon from Phosphor Icons
 * @module
 */
export function PiCubeTransparentThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCubeTransparentThin;
