...
/**
 * GraduationCapBold icon from Phosphor Icons
 * @module
 */
export function PiGraduationCapBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraduationCapBold;
