...
/**
 * TreeEvergreenLight icon from Phosphor Icons
 * @module
 */
export function PiTreeEvergreenLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTreeEvergreenLight;
