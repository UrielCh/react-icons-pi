...
/**
 * TextAlignRightBold icon from Phosphor Icons
 * @module
 */
export function PiTextAlignRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAlignRightBold;
