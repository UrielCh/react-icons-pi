...
/**
 * NotionLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiNotionLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNotionLogoDuotone;
