...
/**
 * ArrowUpLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowUpLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUpLeftDuotone;
