...
/**
 * CellSignalLowLight icon from Phosphor Icons
 * @module
 */
export function PiCellSignalLowLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalLowLight;
