...
/**
 * NumberCircleEightLight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleEightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleEightLight;
