...
/**
 * DotsThreeOutlineVertical icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineVertical;
