...
/**
 * ComputerTowerDuotone icon from Phosphor Icons
 * @module
 */
export function PiComputerTowerDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiComputerTowerDuotone;
