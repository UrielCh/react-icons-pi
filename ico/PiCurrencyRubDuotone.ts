...
/**
 * CurrencyRubDuotone icon from Phosphor Icons
 * @module
 */
export function PiCurrencyRubDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyRubDuotone;
