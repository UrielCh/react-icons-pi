...
/**
 * NumberSquareOneThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareOneThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareOneThin;
