...
/**
 * SmileyStickerThin icon from Phosphor Icons
 * @module
 */
export function PiSmileyStickerThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyStickerThin;
