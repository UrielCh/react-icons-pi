...
/**
 * BatteryVerticalHigh icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalHigh(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalHigh;
