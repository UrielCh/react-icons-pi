...
/**
 * LineSegmentDuotone icon from Phosphor Icons
 * @module
 */
export function PiLineSegmentDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLineSegmentDuotone;
