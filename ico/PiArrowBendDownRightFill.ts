...
/**
 * ArrowBendDownRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownRightFill;
