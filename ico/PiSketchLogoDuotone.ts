...
/**
 * SketchLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiSketchLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSketchLogoDuotone;
