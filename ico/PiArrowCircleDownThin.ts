...
/**
 * ArrowCircleDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownThin;
