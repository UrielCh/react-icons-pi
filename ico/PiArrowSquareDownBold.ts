...
/**
 * ArrowSquareDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownBold;
