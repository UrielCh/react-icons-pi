...
/**
 * RainbowCloudBold icon from Phosphor Icons
 * @module
 */
export function PiRainbowCloudBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRainbowCloudBold;
