...
/**
 * NumberCircleZeroThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleZeroThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleZeroThin;
