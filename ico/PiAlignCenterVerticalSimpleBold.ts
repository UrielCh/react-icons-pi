...
/**
 * AlignCenterVerticalSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalSimpleBold;
