...
/**
 * ChartScatterThin icon from Phosphor Icons
 * @module
 */
export function PiChartScatterThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartScatterThin;
