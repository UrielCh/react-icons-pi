...
/**
 * PenNibStraightBold icon from Phosphor Icons
 * @module
 */
export function PiPenNibStraightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPenNibStraightBold;
