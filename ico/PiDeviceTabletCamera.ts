...
/**
 * DeviceTabletCamera icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletCamera(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletCamera;
