...
/**
 * GraduationCapDuotone icon from Phosphor Icons
 * @module
 */
export function PiGraduationCapDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraduationCapDuotone;
