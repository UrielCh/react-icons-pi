...
/**
 * CellSignalSlashBold icon from Phosphor Icons
 * @module
 */
export function PiCellSignalSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalSlashBold;
