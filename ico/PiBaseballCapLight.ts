...
/**
 * BaseballCapLight icon from Phosphor Icons
 * @module
 */
export function PiBaseballCapLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBaseballCapLight;
