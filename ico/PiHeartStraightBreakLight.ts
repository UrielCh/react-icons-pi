...
/**
 * HeartStraightBreakLight icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightBreakLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightBreakLight;
