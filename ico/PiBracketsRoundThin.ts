...
/**
 * BracketsRoundThin icon from Phosphor Icons
 * @module
 */
export function PiBracketsRoundThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsRoundThin;
