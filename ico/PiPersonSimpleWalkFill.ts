...
/**
 * PersonSimpleWalkFill icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleWalkFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleWalkFill;
