...
/**
 * ArrowUDownRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownRightBold;
