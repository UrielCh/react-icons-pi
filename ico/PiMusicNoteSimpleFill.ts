...
/**
 * MusicNoteSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiMusicNoteSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMusicNoteSimpleFill;
