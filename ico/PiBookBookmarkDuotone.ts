...
/**
 * BookBookmarkDuotone icon from Phosphor Icons
 * @module
 */
export function PiBookBookmarkDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookBookmarkDuotone;
