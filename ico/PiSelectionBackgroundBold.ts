...
/**
 * SelectionBackgroundBold icon from Phosphor Icons
 * @module
 */
export function PiSelectionBackgroundBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionBackgroundBold;
