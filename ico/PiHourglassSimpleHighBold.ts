...
/**
 * HourglassSimpleHighBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleHighBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleHighBold;
