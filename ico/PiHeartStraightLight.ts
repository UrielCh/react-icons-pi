...
/**
 * HeartStraightLight icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightLight;
