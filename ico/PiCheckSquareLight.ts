...
/**
 * CheckSquareLight icon from Phosphor Icons
 * @module
 */
export function PiCheckSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckSquareLight;
