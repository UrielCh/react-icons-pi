...
/**
 * LockLaminatedDuotone icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedDuotone;
