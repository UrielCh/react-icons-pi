...
/**
 * PersonSimpleThrowLight icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThrowLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThrowLight;
