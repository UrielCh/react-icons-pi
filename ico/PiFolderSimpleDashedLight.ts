...
/**
 * FolderSimpleDashedLight icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleDashedLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleDashedLight;
