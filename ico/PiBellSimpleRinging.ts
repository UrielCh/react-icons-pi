...
/**
 * BellSimpleRinging icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleRinging(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleRinging;
