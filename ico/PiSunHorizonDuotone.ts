...
/**
 * SunHorizonDuotone icon from Phosphor Icons
 * @module
 */
export function PiSunHorizonDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSunHorizonDuotone;
