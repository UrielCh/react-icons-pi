...
/**
 * AlignTopSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAlignTopSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignTopSimpleThin;
