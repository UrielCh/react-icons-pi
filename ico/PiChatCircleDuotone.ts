...
/**
 * ChatCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiChatCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleDuotone;
