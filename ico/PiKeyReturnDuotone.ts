...
/**
 * KeyReturnDuotone icon from Phosphor Icons
 * @module
 */
export function PiKeyReturnDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiKeyReturnDuotone;
