...
/**
 * AlignBottomLight icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomLight;
