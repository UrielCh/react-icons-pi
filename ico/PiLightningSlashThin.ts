...
/**
 * LightningSlashThin icon from Phosphor Icons
 * @module
 */
export function PiLightningSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightningSlashThin;
