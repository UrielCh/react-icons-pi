...
/**
 * PresentationBold icon from Phosphor Icons
 * @module
 */
export function PiPresentationBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationBold;
