...
/**
 * ClosedCaptioningBold icon from Phosphor Icons
 * @module
 */
export function PiClosedCaptioningBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClosedCaptioningBold;
