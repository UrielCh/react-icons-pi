...
/**
 * NumberCircleZeroDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleZeroDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleZeroDuotone;
