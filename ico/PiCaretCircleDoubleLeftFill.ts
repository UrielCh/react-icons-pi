...
/**
 * CaretCircleDoubleLeftFill icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleLeftFill;
