...
/**
 * HourglassSimpleMediumLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleMediumLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleMediumLight;
