...
/**
 * ArrowElbowRightDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightDownThin;
