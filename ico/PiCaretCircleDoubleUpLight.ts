...
/**
 * CaretCircleDoubleUpLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleUpLight;
