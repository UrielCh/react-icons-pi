...
/**
 * CalendarCheckFill icon from Phosphor Icons
 * @module
 */
export function PiCalendarCheckFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarCheckFill;
