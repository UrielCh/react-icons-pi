...
/**
 * SquareSplitHorizontalDuotone icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitHorizontalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitHorizontalDuotone;
