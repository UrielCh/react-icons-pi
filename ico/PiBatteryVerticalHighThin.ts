...
/**
 * BatteryVerticalHighThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalHighThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalHighThin;
