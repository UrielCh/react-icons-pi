...
/**
 * ArrowsHorizontal icon from Phosphor Icons
 * @module
 */
export function PiArrowsHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsHorizontal;
