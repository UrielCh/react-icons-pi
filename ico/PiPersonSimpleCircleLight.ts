...
/**
 * PersonSimpleCircleLight icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleCircleLight;
