...
/**
 * ArrowFatLinesDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesDownThin;
