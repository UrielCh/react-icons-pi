...
/**
 * ArrowFatLinesRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesRightBold;
