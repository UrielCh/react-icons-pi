...
/**
 * NumberCircleSixThin icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleSixThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleSixThin;
