...
/**
 * BatteryChargingVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingVerticalThin;
