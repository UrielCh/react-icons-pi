...
/**
 * ArrowURightDownThin icon from Phosphor Icons
 * @module
 */
export function PiArrowURightDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightDownThin;
