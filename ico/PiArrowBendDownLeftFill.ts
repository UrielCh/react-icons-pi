...
/**
 * ArrowBendDownLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownLeftFill;
