...
/**
 * PersonSimpleRunThin icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleRunThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleRunThin;
