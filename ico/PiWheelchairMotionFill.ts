...
/**
 * WheelchairMotionFill icon from Phosphor Icons
 * @module
 */
export function PiWheelchairMotionFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWheelchairMotionFill;
