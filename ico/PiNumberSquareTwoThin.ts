...
/**
 * NumberSquareTwoThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareTwoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareTwoThin;
