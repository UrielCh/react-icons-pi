...
/**
 * CheckSquareOffset icon from Phosphor Icons
 * @module
 */
export function PiCheckSquareOffset(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckSquareOffset;
