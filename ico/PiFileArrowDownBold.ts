...
/**
 * FileArrowDownBold icon from Phosphor Icons
 * @module
 */
export function PiFileArrowDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileArrowDownBold;
