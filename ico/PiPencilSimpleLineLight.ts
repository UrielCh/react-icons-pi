...
/**
 * PencilSimpleLineLight icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleLineLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleLineLight;
