...
/**
 * HourglassSimpleLowThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLowThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLowThin;
