...
/**
 * GlobeHemisphereEastLight icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereEastLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereEastLight;
