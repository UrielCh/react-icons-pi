...
/**
 * NumberSquareZero icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareZero(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareZero;
