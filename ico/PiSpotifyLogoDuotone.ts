...
/**
 * SpotifyLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiSpotifyLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpotifyLogoDuotone;
