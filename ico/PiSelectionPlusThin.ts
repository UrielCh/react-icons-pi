...
/**
 * SelectionPlusThin icon from Phosphor Icons
 * @module
 */
export function PiSelectionPlusThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionPlusThin;
