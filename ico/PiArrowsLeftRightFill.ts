...
/**
 * ArrowsLeftRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowsLeftRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsLeftRightFill;
