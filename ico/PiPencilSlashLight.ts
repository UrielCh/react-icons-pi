...
/**
 * PencilSlashLight icon from Phosphor Icons
 * @module
 */
export function PiPencilSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSlashLight;
