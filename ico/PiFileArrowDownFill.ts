...
/**
 * FileArrowDownFill icon from Phosphor Icons
 * @module
 */
export function PiFileArrowDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFileArrowDownFill;
