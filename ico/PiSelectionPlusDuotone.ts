...
/**
 * SelectionPlusDuotone icon from Phosphor Icons
 * @module
 */
export function PiSelectionPlusDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionPlusDuotone;
