...
/**
 * ArrowFatLineLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineLeftFill;
