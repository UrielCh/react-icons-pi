...
/**
 * WebhooksLogoBold icon from Phosphor Icons
 * @module
 */
export function PiWebhooksLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWebhooksLogoBold;
