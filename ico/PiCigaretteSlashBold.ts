...
/**
 * CigaretteSlashBold icon from Phosphor Icons
 * @module
 */
export function PiCigaretteSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCigaretteSlashBold;
