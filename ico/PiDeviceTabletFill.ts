...
/**
 * DeviceTabletFill icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletFill;
