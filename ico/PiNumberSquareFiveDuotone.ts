...
/**
 * NumberSquareFiveDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareFiveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareFiveDuotone;
