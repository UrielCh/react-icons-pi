...
/**
 * DotsThreeOutlineVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineVerticalFill;
