...
/**
 * WarningOctagonThin icon from Phosphor Icons
 * @module
 */
export function PiWarningOctagonThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningOctagonThin;
