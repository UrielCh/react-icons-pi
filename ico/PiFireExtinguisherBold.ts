...
/**
 * FireExtinguisherBold icon from Phosphor Icons
 * @module
 */
export function PiFireExtinguisherBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFireExtinguisherBold;
