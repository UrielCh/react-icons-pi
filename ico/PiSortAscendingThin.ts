...
/**
 * SortAscendingThin icon from Phosphor Icons
 * @module
 */
export function PiSortAscendingThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSortAscendingThin;
