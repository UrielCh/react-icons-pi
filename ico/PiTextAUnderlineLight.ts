...
/**
 * TextAUnderlineLight icon from Phosphor Icons
 * @module
 */
export function PiTextAUnderlineLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAUnderlineLight;
