...
/**
 * ArrowUDownRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownRightThin;
