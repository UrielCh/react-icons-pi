...
/**
 * SelectionSlashLight icon from Phosphor Icons
 * @module
 */
export function PiSelectionSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSelectionSlashLight;
