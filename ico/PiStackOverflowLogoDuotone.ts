...
/**
 * StackOverflowLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiStackOverflowLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStackOverflowLogoDuotone;
