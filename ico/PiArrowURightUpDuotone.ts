...
/**
 * ArrowURightUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowURightUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowURightUpDuotone;
