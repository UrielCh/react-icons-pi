...
/**
 * BoundingBoxDuotone icon from Phosphor Icons
 * @module
 */
export function PiBoundingBoxDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoundingBoxDuotone;
