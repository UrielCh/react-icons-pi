...
/**
 * ArrowCircleUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpRightBold;
