...
/**
 * LinkedinLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiLinkedinLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkedinLogoDuotone;
