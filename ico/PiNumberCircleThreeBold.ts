...
/**
 * NumberCircleThreeBold icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleThreeBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleThreeBold;
