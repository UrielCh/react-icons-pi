...
/**
 * PhoneDisconnectDuotone icon from Phosphor Icons
 * @module
 */
export function PiPhoneDisconnectDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneDisconnectDuotone;
