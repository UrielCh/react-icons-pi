...
/**
 * CodesandboxLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiCodesandboxLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCodesandboxLogoDuotone;
