...
/**
 * EyedropperSampleLight icon from Phosphor Icons
 * @module
 */
export function PiEyedropperSampleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperSampleLight;
