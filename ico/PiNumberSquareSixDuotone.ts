...
/**
 * NumberSquareSixDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSixDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSixDuotone;
