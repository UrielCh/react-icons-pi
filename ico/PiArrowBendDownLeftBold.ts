...
/**
 * ArrowBendDownLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownLeftBold;
