...
/**
 * ArrowsOutLineVertical icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineVertical;
