...
/**
 * ArrowBendLeftUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftUpDuotone;
