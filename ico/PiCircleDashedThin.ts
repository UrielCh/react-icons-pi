...
/**
 * CircleDashedThin icon from Phosphor Icons
 * @module
 */
export function PiCircleDashedThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleDashedThin;
