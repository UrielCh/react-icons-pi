...
/**
 * ChalkboardTeacherFill icon from Phosphor Icons
 * @module
 */
export function PiChalkboardTeacherFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChalkboardTeacherFill;
