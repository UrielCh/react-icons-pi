...
/**
 * MicrosoftExcelLogoLight icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftExcelLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftExcelLogoLight;
