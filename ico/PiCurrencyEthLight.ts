...
/**
 * CurrencyEthLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyEthLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyEthLight;
