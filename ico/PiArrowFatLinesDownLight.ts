...
/**
 * ArrowFatLinesDownLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesDownLight;
