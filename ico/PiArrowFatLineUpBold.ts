...
/**
 * ArrowFatLineUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineUpBold;
