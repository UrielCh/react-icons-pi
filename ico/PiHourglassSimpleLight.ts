...
/**
 * HourglassSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleLight;
