...
/**
 * DotsThreeVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeVerticalLight;
