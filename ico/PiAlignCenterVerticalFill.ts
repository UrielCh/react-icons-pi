...
/**
 * AlignCenterVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalFill;
