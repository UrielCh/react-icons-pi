...
/**
 * MinusCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiMinusCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMinusCircleDuotone;
