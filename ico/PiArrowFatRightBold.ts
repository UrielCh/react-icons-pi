...
/**
 * ArrowFatRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatRightBold;
