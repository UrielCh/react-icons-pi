...
/**
 * IdentificationBadgeLight icon from Phosphor Icons
 * @module
 */
export function PiIdentificationBadgeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationBadgeLight;
