...
/**
 * AlignTopSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiAlignTopSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignTopSimpleFill;
