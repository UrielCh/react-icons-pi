...
/**
 * AlignLeftSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiAlignLeftSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignLeftSimpleBold;
