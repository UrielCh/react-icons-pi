...
/**
 * SquareSplitVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitVerticalFill;
