...
/**
 * ShuffleSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiShuffleSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiShuffleSimpleBold;
