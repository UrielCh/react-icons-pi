...
/**
 * ArrowsInLineHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineHorizontalLight;
