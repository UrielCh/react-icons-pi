...
/**
 * NumberSquareNine icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareNine(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareNine;
