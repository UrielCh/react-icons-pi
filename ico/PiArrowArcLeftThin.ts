...
/**
 * ArrowArcLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowArcLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcLeftThin;
