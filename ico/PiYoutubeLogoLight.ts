...
/**
 * YoutubeLogoLight icon from Phosphor Icons
 * @module
 */
export function PiYoutubeLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiYoutubeLogoLight;
