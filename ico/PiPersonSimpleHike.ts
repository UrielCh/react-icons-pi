...
/**
 * PersonSimpleHike icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleHike(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleHike;
