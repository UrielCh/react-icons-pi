...
/**
 * LinkSimpleHorizontalBreak icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontalBreak(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontalBreak;
