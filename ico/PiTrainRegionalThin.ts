...
/**
 * TrainRegionalThin icon from Phosphor Icons
 * @module
 */
export function PiTrainRegionalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainRegionalThin;
