...
/**
 * AsteriskSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiAsteriskSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAsteriskSimpleLight;
