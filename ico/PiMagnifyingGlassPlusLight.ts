...
/**
 * MagnifyingGlassPlusLight icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassPlusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassPlusLight;
