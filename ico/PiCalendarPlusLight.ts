...
/**
 * CalendarPlusLight icon from Phosphor Icons
 * @module
 */
export function PiCalendarPlusLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarPlusLight;
