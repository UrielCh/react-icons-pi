...
/**
 * PrescriptionBold icon from Phosphor Icons
 * @module
 */
export function PiPrescriptionBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPrescriptionBold;
