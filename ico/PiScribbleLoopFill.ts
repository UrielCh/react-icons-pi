...
/**
 * ScribbleLoopFill icon from Phosphor Icons
 * @module
 */
export function PiScribbleLoopFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiScribbleLoopFill;
