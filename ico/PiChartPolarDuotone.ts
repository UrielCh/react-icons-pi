...
/**
 * ChartPolarDuotone icon from Phosphor Icons
 * @module
 */
export function PiChartPolarDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartPolarDuotone;
