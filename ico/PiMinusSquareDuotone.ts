...
/**
 * MinusSquareDuotone icon from Phosphor Icons
 * @module
 */
export function PiMinusSquareDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMinusSquareDuotone;
