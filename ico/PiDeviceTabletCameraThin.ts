...
/**
 * DeviceTabletCameraThin icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletCameraThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletCameraThin;
