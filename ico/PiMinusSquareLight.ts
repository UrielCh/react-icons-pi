...
/**
 * MinusSquareLight icon from Phosphor Icons
 * @module
 */
export function PiMinusSquareLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMinusSquareLight;
