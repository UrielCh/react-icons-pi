...
/**
 * ArrowSquareDownRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownRightDuotone;
