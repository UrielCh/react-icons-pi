...
/**
 * SortDescendingBold icon from Phosphor Icons
 * @module
 */
export function PiSortDescendingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSortDescendingBold;
