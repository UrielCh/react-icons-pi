...
/**
 * BellSimpleSlashLight icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleSlashLight;
