...
/**
 * ArrowCounterClockwiseBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCounterClockwiseBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCounterClockwiseBold;
