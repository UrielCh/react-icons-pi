...
/**
 * ArrowDownRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowDownRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownRightLight;
