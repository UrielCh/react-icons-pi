...
/**
 * GenderFemaleFill icon from Phosphor Icons
 * @module
 */
export function PiGenderFemaleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderFemaleFill;
