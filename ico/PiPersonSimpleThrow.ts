...
/**
 * PersonSimpleThrow icon from Phosphor Icons
 * @module
 */
export function PiPersonSimpleThrow(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonSimpleThrow;
