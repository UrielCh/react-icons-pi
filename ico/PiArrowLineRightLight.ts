...
/**
 * ArrowLineRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineRightLight;
