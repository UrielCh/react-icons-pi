...
/**
 * ArrowBendRightUpThin icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightUpThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightUpThin;
