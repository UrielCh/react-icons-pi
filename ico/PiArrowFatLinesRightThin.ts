...
/**
 * ArrowFatLinesRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesRightThin;
