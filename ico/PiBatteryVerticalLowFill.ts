...
/**
 * BatteryVerticalLowFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalLowFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalLowFill;
