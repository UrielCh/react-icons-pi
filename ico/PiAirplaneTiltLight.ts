...
/**
 * AirplaneTiltLight icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTiltLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTiltLight;
