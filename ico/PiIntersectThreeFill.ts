...
/**
 * IntersectThreeFill icon from Phosphor Icons
 * @module
 */
export function PiIntersectThreeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIntersectThreeFill;
