...
/**
 * PencilSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleLight;
