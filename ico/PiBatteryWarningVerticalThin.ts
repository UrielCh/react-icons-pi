...
/**
 * BatteryWarningVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryWarningVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryWarningVerticalThin;
