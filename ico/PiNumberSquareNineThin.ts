...
/**
 * NumberSquareNineThin icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareNineThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareNineThin;
