...
/**
 * NewspaperDuotone icon from Phosphor Icons
 * @module
 */
export function PiNewspaperDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNewspaperDuotone;
