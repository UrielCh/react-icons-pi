...
/**
 * HourglassDuotone icon from Phosphor Icons
 * @module
 */
export function PiHourglassDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassDuotone;
