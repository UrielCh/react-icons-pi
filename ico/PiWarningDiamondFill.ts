...
/**
 * WarningDiamondFill icon from Phosphor Icons
 * @module
 */
export function PiWarningDiamondFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningDiamondFill;
