...
/**
 * NumberSquareNineBold icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareNineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareNineBold;
