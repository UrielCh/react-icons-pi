...
/**
 * LinkedinLogoLight icon from Phosphor Icons
 * @module
 */
export function PiLinkedinLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkedinLogoLight;
