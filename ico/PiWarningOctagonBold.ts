...
/**
 * WarningOctagonBold icon from Phosphor Icons
 * @module
 */
export function PiWarningOctagonBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningOctagonBold;
