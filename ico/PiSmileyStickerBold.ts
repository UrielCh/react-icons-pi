...
/**
 * SmileyStickerBold icon from Phosphor Icons
 * @module
 */
export function PiSmileyStickerBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyStickerBold;
