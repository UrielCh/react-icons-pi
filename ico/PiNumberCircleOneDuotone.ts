...
/**
 * NumberCircleOneDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleOneDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleOneDuotone;
