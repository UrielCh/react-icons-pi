...
/**
 * CameraRotateDuotone icon from Phosphor Icons
 * @module
 */
export function PiCameraRotateDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCameraRotateDuotone;
