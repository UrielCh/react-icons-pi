...
/**
 * HourglassSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleBold;
