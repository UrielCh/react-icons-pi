...
/**
 * UserRectangleFill icon from Phosphor Icons
 * @module
 */
export function PiUserRectangleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserRectangleFill;
