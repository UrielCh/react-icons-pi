...
/**
 * ClockAfternoonBold icon from Phosphor Icons
 * @module
 */
export function PiClockAfternoonBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockAfternoonBold;
