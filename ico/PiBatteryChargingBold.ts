...
/**
 * BatteryChargingBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingBold;
