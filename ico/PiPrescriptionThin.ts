...
/**
 * PrescriptionThin icon from Phosphor Icons
 * @module
 */
export function PiPrescriptionThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPrescriptionThin;
