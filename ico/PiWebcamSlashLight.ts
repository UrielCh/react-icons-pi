...
/**
 * WebcamSlashLight icon from Phosphor Icons
 * @module
 */
export function PiWebcamSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWebcamSlashLight;
