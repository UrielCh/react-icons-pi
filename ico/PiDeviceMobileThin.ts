...
/**
 * DeviceMobileThin icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileThin;
