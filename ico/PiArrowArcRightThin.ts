...
/**
 * ArrowArcRightThin icon from Phosphor Icons
 * @module
 */
export function PiArrowArcRightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowArcRightThin;
