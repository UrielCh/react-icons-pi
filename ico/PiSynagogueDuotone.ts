...
/**
 * SynagogueDuotone icon from Phosphor Icons
 * @module
 */
export function PiSynagogueDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSynagogueDuotone;
