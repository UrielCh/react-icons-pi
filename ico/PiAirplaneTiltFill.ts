...
/**
 * AirplaneTiltFill icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTiltFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTiltFill;
