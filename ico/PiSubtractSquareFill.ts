...
/**
 * SubtractSquareFill icon from Phosphor Icons
 * @module
 */
export function PiSubtractSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSubtractSquareFill;
