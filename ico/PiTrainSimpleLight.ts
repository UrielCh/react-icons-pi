...
/**
 * TrainSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiTrainSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrainSimpleLight;
