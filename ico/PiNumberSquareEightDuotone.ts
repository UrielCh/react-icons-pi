...
/**
 * NumberSquareEightDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareEightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareEightDuotone;
