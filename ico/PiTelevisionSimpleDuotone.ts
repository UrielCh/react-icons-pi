...
/**
 * TelevisionSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiTelevisionSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTelevisionSimpleDuotone;
