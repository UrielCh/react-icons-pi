...
/**
 * ArrowFatLinesUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesUpBold;
