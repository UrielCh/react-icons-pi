...
/**
 * ArrowClockwiseLight icon from Phosphor Icons
 * @module
 */
export function PiArrowClockwiseLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowClockwiseLight;
