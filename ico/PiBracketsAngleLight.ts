...
/**
 * BracketsAngleLight icon from Phosphor Icons
 * @module
 */
export function PiBracketsAngleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsAngleLight;
