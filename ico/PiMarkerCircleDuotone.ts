...
/**
 * MarkerCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiMarkerCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMarkerCircleDuotone;
