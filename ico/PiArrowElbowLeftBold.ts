...
/**
 * ArrowElbowLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowLeftBold;
