...
/**
 * NumberFiveDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberFiveDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberFiveDuotone;
