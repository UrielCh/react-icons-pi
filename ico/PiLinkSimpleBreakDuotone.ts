...
/**
 * LinkSimpleBreakDuotone icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleBreakDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleBreakDuotone;
