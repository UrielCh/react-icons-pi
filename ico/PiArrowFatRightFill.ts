...
/**
 * ArrowFatRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatRightFill;
