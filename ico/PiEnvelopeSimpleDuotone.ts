...
/**
 * EnvelopeSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiEnvelopeSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEnvelopeSimpleDuotone;
