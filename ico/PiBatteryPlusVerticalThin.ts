...
/**
 * BatteryPlusVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryPlusVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryPlusVerticalThin;
