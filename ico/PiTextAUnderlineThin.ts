...
/**
 * TextAUnderlineThin icon from Phosphor Icons
 * @module
 */
export function PiTextAUnderlineThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextAUnderlineThin;
