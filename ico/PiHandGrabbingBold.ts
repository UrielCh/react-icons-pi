...
/**
 * HandGrabbingBold icon from Phosphor Icons
 * @module
 */
export function PiHandGrabbingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHandGrabbingBold;
