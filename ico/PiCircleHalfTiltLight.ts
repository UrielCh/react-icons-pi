...
/**
 * CircleHalfTiltLight icon from Phosphor Icons
 * @module
 */
export function PiCircleHalfTiltLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleHalfTiltLight;
