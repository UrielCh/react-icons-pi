...
/**
 * ArrowSquareLeftDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareLeftDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareLeftDuotone;
