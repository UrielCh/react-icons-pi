...
/**
 * HighlighterCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiHighlighterCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHighlighterCircleDuotone;
