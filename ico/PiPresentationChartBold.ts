...
/**
 * PresentationChartBold icon from Phosphor Icons
 * @module
 */
export function PiPresentationChartBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationChartBold;
