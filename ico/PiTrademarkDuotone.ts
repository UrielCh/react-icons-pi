...
/**
 * TrademarkDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrademarkDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrademarkDuotone;
