...
/**
 * DeviceTabletSpeakerFill icon from Phosphor Icons
 * @module
 */
export function PiDeviceTabletSpeakerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceTabletSpeakerFill;
