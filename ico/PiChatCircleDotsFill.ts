...
/**
 * ChatCircleDotsFill icon from Phosphor Icons
 * @module
 */
export function PiChatCircleDotsFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleDotsFill;
