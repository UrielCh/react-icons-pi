...
/**
 * AlignCenterVerticalSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiAlignCenterVerticalSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignCenterVerticalSimpleThin;
