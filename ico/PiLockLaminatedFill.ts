...
/**
 * LockLaminatedFill icon from Phosphor Icons
 * @module
 */
export function PiLockLaminatedFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLockLaminatedFill;
