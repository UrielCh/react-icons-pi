...
/**
 * FolderSimpleUserFill icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleUserFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleUserFill;
