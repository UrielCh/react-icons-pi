...
/**
 * ChartScatterBold icon from Phosphor Icons
 * @module
 */
export function PiChartScatterBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChartScatterBold;
