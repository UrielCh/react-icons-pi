...
/**
 * CurrencyKztLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyKztLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyKztLight;
