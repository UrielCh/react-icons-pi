...
/**
 * PencilSimpleFill icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleFill;
