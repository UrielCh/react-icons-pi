...
/**
 * LineSegmentsLight icon from Phosphor Icons
 * @module
 */
export function PiLineSegmentsLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLineSegmentsLight;
