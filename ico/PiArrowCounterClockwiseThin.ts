...
/**
 * ArrowCounterClockwiseThin icon from Phosphor Icons
 * @module
 */
export function PiArrowCounterClockwiseThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCounterClockwiseThin;
