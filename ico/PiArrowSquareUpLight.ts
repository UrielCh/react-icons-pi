...
/**
 * ArrowSquareUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpLight;
