...
/**
 * GooglePhotosLogoLight icon from Phosphor Icons
 * @module
 */
export function PiGooglePhotosLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePhotosLogoLight;
