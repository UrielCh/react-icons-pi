...
/**
 * UserCirclePlusFill icon from Phosphor Icons
 * @module
 */
export function PiUserCirclePlusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCirclePlusFill;
