...
/**
 * FrameCornersFill icon from Phosphor Icons
 * @module
 */
export function PiFrameCornersFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFrameCornersFill;
