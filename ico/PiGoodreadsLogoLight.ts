...
/**
 * GoodreadsLogoLight icon from Phosphor Icons
 * @module
 */
export function PiGoodreadsLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGoodreadsLogoLight;
