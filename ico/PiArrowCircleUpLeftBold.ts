...
/**
 * ArrowCircleUpLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpLeftBold;
