...
/**
 * RainbowCloudDuotone icon from Phosphor Icons
 * @module
 */
export function PiRainbowCloudDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRainbowCloudDuotone;
