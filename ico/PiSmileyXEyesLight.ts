...
/**
 * SmileyXEyesLight icon from Phosphor Icons
 * @module
 */
export function PiSmileyXEyesLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyXEyesLight;
