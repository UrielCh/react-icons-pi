...
/**
 * ArrowFatLinesDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesDownBold;
