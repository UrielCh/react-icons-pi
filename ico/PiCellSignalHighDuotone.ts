...
/**
 * CellSignalHighDuotone icon from Phosphor Icons
 * @module
 */
export function PiCellSignalHighDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalHighDuotone;
