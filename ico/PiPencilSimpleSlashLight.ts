...
/**
 * PencilSimpleSlashLight icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleSlashLight;
