...
/**
 * ArrowSquareRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareRightLight;
