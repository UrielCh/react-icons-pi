...
/**
 * TelevisionDuotone icon from Phosphor Icons
 * @module
 */
export function PiTelevisionDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTelevisionDuotone;
