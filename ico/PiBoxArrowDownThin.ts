...
/**
 * BoxArrowDownThin icon from Phosphor Icons
 * @module
 */
export function PiBoxArrowDownThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoxArrowDownThin;
