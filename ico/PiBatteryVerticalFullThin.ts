...
/**
 * BatteryVerticalFullThin icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalFullThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalFullThin;
