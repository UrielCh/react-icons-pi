...
/**
 * NumberOneDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberOneDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberOneDuotone;
