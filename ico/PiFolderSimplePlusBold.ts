...
/**
 * FolderSimplePlusBold icon from Phosphor Icons
 * @module
 */
export function PiFolderSimplePlusBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimplePlusBold;
