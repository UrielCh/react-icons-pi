...
/**
 * FolderSimpleStarFill icon from Phosphor Icons
 * @module
 */
export function PiFolderSimpleStarFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderSimpleStarFill;
