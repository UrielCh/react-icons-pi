...
/**
 * HourglassSimpleHighLight icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleHighLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleHighLight;
