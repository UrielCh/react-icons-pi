...
/**
 * ClockClockwiseDuotone icon from Phosphor Icons
 * @module
 */
export function PiClockClockwiseDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockClockwiseDuotone;
