...
/**
 * SkipForwardCircle icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardCircle;
