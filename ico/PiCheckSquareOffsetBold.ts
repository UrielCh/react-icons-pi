...
/**
 * CheckSquareOffsetBold icon from Phosphor Icons
 * @module
 */
export function PiCheckSquareOffsetBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCheckSquareOffsetBold;
