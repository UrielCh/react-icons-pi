...
/**
 * WheelchairMotion icon from Phosphor Icons
 * @module
 */
export function PiWheelchairMotion(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWheelchairMotion;
