...
/**
 * MagnifyingGlassPlusDuotone icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassPlusDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassPlusDuotone;
