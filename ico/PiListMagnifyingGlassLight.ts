...
/**
 * ListMagnifyingGlassLight icon from Phosphor Icons
 * @module
 */
export function PiListMagnifyingGlassLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiListMagnifyingGlassLight;
