...
/**
 * AirplaneTaxiingBold icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTaxiingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTaxiingBold;
