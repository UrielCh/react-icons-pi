...
/**
 * GlobeHemisphereEast icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereEast(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereEast;
