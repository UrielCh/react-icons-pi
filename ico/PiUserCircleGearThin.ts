...
/**
 * UserCircleGearThin icon from Phosphor Icons
 * @module
 */
export function PiUserCircleGearThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserCircleGearThin;
