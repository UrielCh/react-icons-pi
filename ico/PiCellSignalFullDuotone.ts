...
/**
 * CellSignalFullDuotone icon from Phosphor Icons
 * @module
 */
export function PiCellSignalFullDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalFullDuotone;
