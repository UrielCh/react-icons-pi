...
/**
 * BatteryVerticalMediumLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalMediumLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalMediumLight;
