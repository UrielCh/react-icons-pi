...
/**
 * ArrowUDownLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownLeftThin;
