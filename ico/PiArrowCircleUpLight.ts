...
/**
 * ArrowCircleUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpLight;
