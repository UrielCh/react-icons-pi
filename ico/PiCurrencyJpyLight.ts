...
/**
 * CurrencyJpyLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyJpyLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyJpyLight;
