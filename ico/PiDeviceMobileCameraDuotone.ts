...
/**
 * DeviceMobileCameraDuotone icon from Phosphor Icons
 * @module
 */
export function PiDeviceMobileCameraDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDeviceMobileCameraDuotone;
