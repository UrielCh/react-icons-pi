...
/**
 * UserRectangleThin icon from Phosphor Icons
 * @module
 */
export function PiUserRectangleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserRectangleThin;
