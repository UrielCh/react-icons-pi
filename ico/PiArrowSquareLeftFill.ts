...
/**
 * ArrowSquareLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareLeftFill;
