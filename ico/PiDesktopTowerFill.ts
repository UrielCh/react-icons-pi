...
/**
 * DesktopTowerFill icon from Phosphor Icons
 * @module
 */
export function PiDesktopTowerFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDesktopTowerFill;
