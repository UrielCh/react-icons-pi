...
/**
 * BatteryVerticalEmpty icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalEmpty(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalEmpty;
