...
/**
 * AirplaneInFlightLight icon from Phosphor Icons
 * @module
 */
export function PiAirplaneInFlightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneInFlightLight;
