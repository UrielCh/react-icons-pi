...
/**
 * ArrowFatLineLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineLeftLight;
