...
/**
 * BookmarkSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiBookmarkSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBookmarkSimpleThin;
