...
/**
 * GameControllerDuotone icon from Phosphor Icons
 * @module
 */
export function PiGameControllerDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGameControllerDuotone;
