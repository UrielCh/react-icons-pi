...
/**
 * PhoneDisconnectBold icon from Phosphor Icons
 * @module
 */
export function PiPhoneDisconnectBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneDisconnectBold;
