...
/**
 * NumberSquareSixFill icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareSixFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareSixFill;
