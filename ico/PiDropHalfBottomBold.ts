...
/**
 * DropHalfBottomBold icon from Phosphor Icons
 * @module
 */
export function PiDropHalfBottomBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDropHalfBottomBold;
