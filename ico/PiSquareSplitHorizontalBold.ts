...
/**
 * SquareSplitHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitHorizontalBold;
