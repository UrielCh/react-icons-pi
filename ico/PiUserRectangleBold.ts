...
/**
 * UserRectangleBold icon from Phosphor Icons
 * @module
 */
export function PiUserRectangleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiUserRectangleBold;
