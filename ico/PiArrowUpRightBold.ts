...
/**
 * ArrowUpRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowUpRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUpRightBold;
