...
/**
 * MicrosoftTeamsLogoFill icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftTeamsLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftTeamsLogoFill;
