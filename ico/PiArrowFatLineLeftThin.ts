...
/**
 * ArrowFatLineLeftThin icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineLeftThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineLeftThin;
