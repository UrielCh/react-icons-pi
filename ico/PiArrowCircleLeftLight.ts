...
/**
 * ArrowCircleLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleLeftLight;
