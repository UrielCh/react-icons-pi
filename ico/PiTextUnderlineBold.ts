...
/**
 * TextUnderlineBold icon from Phosphor Icons
 * @module
 */
export function PiTextUnderlineBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextUnderlineBold;
