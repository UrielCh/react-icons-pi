...
/**
 * GooglePhotosLogoBold icon from Phosphor Icons
 * @module
 */
export function PiGooglePhotosLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePhotosLogoBold;
