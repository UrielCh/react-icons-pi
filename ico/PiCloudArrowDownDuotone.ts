...
/**
 * CloudArrowDownDuotone icon from Phosphor Icons
 * @module
 */
export function PiCloudArrowDownDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudArrowDownDuotone;
