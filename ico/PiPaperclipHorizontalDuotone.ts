...
/**
 * PaperclipHorizontalDuotone icon from Phosphor Icons
 * @module
 */
export function PiPaperclipHorizontalDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipHorizontalDuotone;
