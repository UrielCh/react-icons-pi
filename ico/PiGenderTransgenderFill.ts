...
/**
 * GenderTransgenderFill icon from Phosphor Icons
 * @module
 */
export function PiGenderTransgenderFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderTransgenderFill;
