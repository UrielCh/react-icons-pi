...
/**
 * MagnifyingGlassMinusFill icon from Phosphor Icons
 * @module
 */
export function PiMagnifyingGlassMinusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnifyingGlassMinusFill;
