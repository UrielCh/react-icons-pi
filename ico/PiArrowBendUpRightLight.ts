...
/**
 * ArrowBendUpRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendUpRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendUpRightLight;
