...
/**
 * DotsSixVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiDotsSixVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsSixVerticalThin;
