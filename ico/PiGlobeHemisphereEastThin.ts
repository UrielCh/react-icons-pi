...
/**
 * GlobeHemisphereEastThin icon from Phosphor Icons
 * @module
 */
export function PiGlobeHemisphereEastThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGlobeHemisphereEastThin;
