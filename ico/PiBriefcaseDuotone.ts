...
/**
 * BriefcaseDuotone icon from Phosphor Icons
 * @module
 */
export function PiBriefcaseDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBriefcaseDuotone;
