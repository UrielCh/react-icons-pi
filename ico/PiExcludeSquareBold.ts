...
/**
 * ExcludeSquareBold icon from Phosphor Icons
 * @module
 */
export function PiExcludeSquareBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiExcludeSquareBold;
