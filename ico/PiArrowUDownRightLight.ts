...
/**
 * ArrowUDownRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownRightLight;
