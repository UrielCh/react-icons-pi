...
/**
 * ArrowSquareUpRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpRightLight;
