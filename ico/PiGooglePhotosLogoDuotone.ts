...
/**
 * GooglePhotosLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiGooglePhotosLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGooglePhotosLogoDuotone;
