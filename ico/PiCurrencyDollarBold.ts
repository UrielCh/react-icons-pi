...
/**
 * CurrencyDollarBold icon from Phosphor Icons
 * @module
 */
export function PiCurrencyDollarBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyDollarBold;
