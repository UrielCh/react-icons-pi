...
/**
 * ArrowBendLeftDownBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendLeftDownBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendLeftDownBold;
