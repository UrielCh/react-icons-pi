...
/**
 * SkipForwardCircleLight icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardCircleLight;
