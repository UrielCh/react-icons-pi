...
/**
 * TrafficSignDuotone icon from Phosphor Icons
 * @module
 */
export function PiTrafficSignDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficSignDuotone;
