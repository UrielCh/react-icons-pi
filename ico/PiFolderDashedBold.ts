...
/**
 * FolderDashedBold icon from Phosphor Icons
 * @module
 */
export function PiFolderDashedBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiFolderDashedBold;
