...
/**
 * HashStraightBold icon from Phosphor Icons
 * @module
 */
export function PiHashStraightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHashStraightBold;
