...
/**
 * ParallelogramBold icon from Phosphor Icons
 * @module
 */
export function PiParallelogramBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiParallelogramBold;
