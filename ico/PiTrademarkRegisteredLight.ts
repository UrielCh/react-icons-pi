...
/**
 * TrademarkRegisteredLight icon from Phosphor Icons
 * @module
 */
export function PiTrademarkRegisteredLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrademarkRegisteredLight;
