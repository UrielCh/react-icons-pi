...
/**
 * CircleHalfDuotone icon from Phosphor Icons
 * @module
 */
export function PiCircleHalfDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleHalfDuotone;
