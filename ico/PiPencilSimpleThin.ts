...
/**
 * PencilSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleThin;
