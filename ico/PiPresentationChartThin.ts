...
/**
 * PresentationChartThin icon from Phosphor Icons
 * @module
 */
export function PiPresentationChartThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationChartThin;
