...
/**
 * NumberEightLight icon from Phosphor Icons
 * @module
 */
export function PiNumberEightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberEightLight;
