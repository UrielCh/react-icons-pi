...
/**
 * ArrowDownLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowDownLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownLeftLight;
