...
/**
 * BatteryVerticalFullBold icon from Phosphor Icons
 * @module
 */
export function PiBatteryVerticalFullBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryVerticalFullBold;
