...
/**
 * CaretCircleDoubleUpBold icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleUpBold;
