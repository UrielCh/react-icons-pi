...
/**
 * ArrowsInLineHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsInLineHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInLineHorizontalBold;
