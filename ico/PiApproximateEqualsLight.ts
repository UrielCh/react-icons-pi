...
/**
 * ApproximateEqualsLight icon from Phosphor Icons
 * @module
 */
export function PiApproximateEqualsLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiApproximateEqualsLight;
