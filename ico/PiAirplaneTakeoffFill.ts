...
/**
 * AirplaneTakeoffFill icon from Phosphor Icons
 * @module
 */
export function PiAirplaneTakeoffFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneTakeoffFill;
