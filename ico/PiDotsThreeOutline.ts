...
/**
 * DotsThreeOutline icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutline;
