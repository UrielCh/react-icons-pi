...
/**
 * ArrowBendDownRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownRightDuotone;
