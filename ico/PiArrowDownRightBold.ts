...
/**
 * ArrowDownRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowDownRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownRightBold;
