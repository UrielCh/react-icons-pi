...
/**
 * DribbbleLogoBold icon from Phosphor Icons
 * @module
 */
export function PiDribbbleLogoBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDribbbleLogoBold;
