...
/**
 * ArrowBendRightUpLight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightUpLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightUpLight;
