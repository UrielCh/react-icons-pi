...
/**
 * SortAscendingLight icon from Phosphor Icons
 * @module
 */
export function PiSortAscendingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSortAscendingLight;
