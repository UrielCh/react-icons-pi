...
/**
 * DotsThreeOutlineVerticalThin icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeOutlineVerticalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeOutlineVerticalThin;
