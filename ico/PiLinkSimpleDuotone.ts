...
/**
 * LinkSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleDuotone;
