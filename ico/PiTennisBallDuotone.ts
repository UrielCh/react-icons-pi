...
/**
 * TennisBallDuotone icon from Phosphor Icons
 * @module
 */
export function PiTennisBallDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTennisBallDuotone;
