...
/**
 * ArrowFatLineDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineDownFill;
