...
/**
 * LightbulbFilamentFill icon from Phosphor Icons
 * @module
 */
export function PiLightbulbFilamentFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLightbulbFilamentFill;
