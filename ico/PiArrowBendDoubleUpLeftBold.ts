...
/**
 * ArrowBendDoubleUpLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDoubleUpLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDoubleUpLeftBold;
