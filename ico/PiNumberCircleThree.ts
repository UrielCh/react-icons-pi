...
/**
 * NumberCircleThree icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleThree(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleThree;
