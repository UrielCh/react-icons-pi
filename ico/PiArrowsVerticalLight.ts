...
/**
 * ArrowsVerticalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsVerticalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsVerticalLight;
