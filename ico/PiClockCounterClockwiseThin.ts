...
/**
 * ClockCounterClockwiseThin icon from Phosphor Icons
 * @module
 */
export function PiClockCounterClockwiseThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiClockCounterClockwiseThin;
