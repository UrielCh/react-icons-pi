...
/**
 * ArrowCircleDownRightBold icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleDownRightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleDownRightBold;
