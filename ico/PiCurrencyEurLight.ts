...
/**
 * CurrencyEurLight icon from Phosphor Icons
 * @module
 */
export function PiCurrencyEurLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyEurLight;
