...
/**
 * GenderTransgenderBold icon from Phosphor Icons
 * @module
 */
export function PiGenderTransgenderBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderTransgenderBold;
