...
/**
 * PenNibStraightFill icon from Phosphor Icons
 * @module
 */
export function PiPenNibStraightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPenNibStraightFill;
