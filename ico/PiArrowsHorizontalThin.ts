...
/**
 * ArrowsHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsHorizontalThin;
