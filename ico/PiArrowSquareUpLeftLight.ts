...
/**
 * ArrowSquareUpLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareUpLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareUpLeftLight;
