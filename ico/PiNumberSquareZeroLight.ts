...
/**
 * NumberSquareZeroLight icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareZeroLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareZeroLight;
