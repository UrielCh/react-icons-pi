...
/**
 * ArrowBendDownRight icon from Phosphor Icons
 * @module
 */
export function PiArrowBendDownRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendDownRight;
