...
/**
 * BatteryChargingLight icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingLight;
