...
/**
 * WarningDiamondLight icon from Phosphor Icons
 * @module
 */
export function PiWarningDiamondLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiWarningDiamondLight;
