...
/**
 * EyedropperSampleThin icon from Phosphor Icons
 * @module
 */
export function PiEyedropperSampleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperSampleThin;
