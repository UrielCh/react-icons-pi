...
/**
 * StarAndCrescentThin icon from Phosphor Icons
 * @module
 */
export function PiStarAndCrescentThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiStarAndCrescentThin;
