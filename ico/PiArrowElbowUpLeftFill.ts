...
/**
 * ArrowElbowUpLeftFill icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowUpLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowUpLeftFill;
