...
/**
 * ArrowDownRightDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowDownRightDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowDownRightDuotone;
