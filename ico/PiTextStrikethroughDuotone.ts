...
/**
 * TextStrikethroughDuotone icon from Phosphor Icons
 * @module
 */
export function PiTextStrikethroughDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextStrikethroughDuotone;
