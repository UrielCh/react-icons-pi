...
/**
 * SkipBackCircleFill icon from Phosphor Icons
 * @module
 */
export function PiSkipBackCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipBackCircleFill;
