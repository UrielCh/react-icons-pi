...
/**
 * PaperclipHorizontalThin icon from Phosphor Icons
 * @module
 */
export function PiPaperclipHorizontalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPaperclipHorizontalThin;
