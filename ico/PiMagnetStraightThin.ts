...
/**
 * MagnetStraightThin icon from Phosphor Icons
 * @module
 */
export function PiMagnetStraightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnetStraightThin;
