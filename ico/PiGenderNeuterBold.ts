...
/**
 * GenderNeuterBold icon from Phosphor Icons
 * @module
 */
export function PiGenderNeuterBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNeuterBold;
