...
/**
 * CoinVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiCoinVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCoinVerticalBold;
