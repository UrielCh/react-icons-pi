...
/**
 * GenderFemaleLight icon from Phosphor Icons
 * @module
 */
export function PiGenderFemaleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderFemaleLight;
