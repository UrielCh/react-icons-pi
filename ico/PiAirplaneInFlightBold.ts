...
/**
 * AirplaneInFlightBold icon from Phosphor Icons
 * @module
 */
export function PiAirplaneInFlightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneInFlightBold;
