...
/**
 * NumberCircleEight icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleEight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleEight;
