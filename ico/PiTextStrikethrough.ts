...
/**
 * TextStrikethrough icon from Phosphor Icons
 * @module
 */
export function PiTextStrikethrough(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextStrikethrough;
