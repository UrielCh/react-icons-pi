...
/**
 * ArrowsInCardinalThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsInCardinalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInCardinalThin;
