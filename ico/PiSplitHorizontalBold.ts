...
/**
 * SplitHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiSplitHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSplitHorizontalBold;
