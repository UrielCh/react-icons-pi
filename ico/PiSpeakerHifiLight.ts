...
/**
 * SpeakerHifiLight icon from Phosphor Icons
 * @module
 */
export function PiSpeakerHifiLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSpeakerHifiLight;
