...
/**
 * PauseCircleLight icon from Phosphor Icons
 * @module
 */
export function PiPauseCircleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPauseCircleLight;
