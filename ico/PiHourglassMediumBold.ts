...
/**
 * HourglassMediumBold icon from Phosphor Icons
 * @module
 */
export function PiHourglassMediumBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassMediumBold;
