...
/**
 * IdentificationBadgeBold icon from Phosphor Icons
 * @module
 */
export function PiIdentificationBadgeBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiIdentificationBadgeBold;
