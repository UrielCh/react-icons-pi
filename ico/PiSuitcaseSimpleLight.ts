...
/**
 * SuitcaseSimpleLight icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseSimpleLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseSimpleLight;
