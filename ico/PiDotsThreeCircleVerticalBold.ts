...
/**
 * DotsThreeCircleVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiDotsThreeCircleVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsThreeCircleVerticalBold;
