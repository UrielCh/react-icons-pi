...
/**
 * ArrowLineRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowLineRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineRightFill;
