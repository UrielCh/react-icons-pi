...
/**
 * CurrencyEurDuotone icon from Phosphor Icons
 * @module
 */
export function PiCurrencyEurDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCurrencyEurDuotone;
