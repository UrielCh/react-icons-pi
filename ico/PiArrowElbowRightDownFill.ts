...
/**
 * ArrowElbowRightDownFill icon from Phosphor Icons
 * @module
 */
export function PiArrowElbowRightDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowElbowRightDownFill;
