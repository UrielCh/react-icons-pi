...
/**
 * ArrowCircleUpRight icon from Phosphor Icons
 * @module
 */
export function PiArrowCircleUpRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowCircleUpRight;
