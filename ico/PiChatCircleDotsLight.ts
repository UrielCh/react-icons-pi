...
/**
 * ChatCircleDotsLight icon from Phosphor Icons
 * @module
 */
export function PiChatCircleDotsLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCircleDotsLight;
