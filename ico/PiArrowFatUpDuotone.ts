...
/**
 * ArrowFatUpDuotone icon from Phosphor Icons
 * @module
 */
export function PiArrowFatUpDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatUpDuotone;
