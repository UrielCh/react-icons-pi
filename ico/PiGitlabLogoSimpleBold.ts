...
/**
 * GitlabLogoSimpleBold icon from Phosphor Icons
 * @module
 */
export function PiGitlabLogoSimpleBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGitlabLogoSimpleBold;
