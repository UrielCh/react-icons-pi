...
/**
 * GameControllerLight icon from Phosphor Icons
 * @module
 */
export function PiGameControllerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGameControllerLight;
