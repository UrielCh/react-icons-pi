...
/**
 * MagnetStraightFill icon from Phosphor Icons
 * @module
 */
export function PiMagnetStraightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMagnetStraightFill;
