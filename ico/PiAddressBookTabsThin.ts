...
/**
 * AddressBookTabsThin icon from Phosphor Icons
 * @module
 */
export function PiAddressBookTabsThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAddressBookTabsThin;
