...
/**
 * MicrosoftWordLogoThin icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftWordLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftWordLogoThin;
