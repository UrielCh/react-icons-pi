...
/**
 * NumberCircleFiveFill icon from Phosphor Icons
 * @module
 */
export function PiNumberCircleFiveFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberCircleFiveFill;
