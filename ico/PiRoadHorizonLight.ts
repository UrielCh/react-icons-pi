...
/**
 * RoadHorizonLight icon from Phosphor Icons
 * @module
 */
export function PiRoadHorizonLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRoadHorizonLight;
