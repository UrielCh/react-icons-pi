...
/**
 * CloudCheckDuotone icon from Phosphor Icons
 * @module
 */
export function PiCloudCheckDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCloudCheckDuotone;
