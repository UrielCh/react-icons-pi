...
/**
 * EyedropperSample icon from Phosphor Icons
 * @module
 */
export function PiEyedropperSample(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperSample;
