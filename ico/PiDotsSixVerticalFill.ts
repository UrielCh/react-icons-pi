...
/**
 * DotsSixVerticalFill icon from Phosphor Icons
 * @module
 */
export function PiDotsSixVerticalFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiDotsSixVerticalFill;
