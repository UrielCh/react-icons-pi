...
/**
 * ArrowClockwiseThin icon from Phosphor Icons
 * @module
 */
export function PiArrowClockwiseThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowClockwiseThin;
