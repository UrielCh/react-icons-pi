...
/**
 * GrainsSlashLight icon from Phosphor Icons
 * @module
 */
export function PiGrainsSlashLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGrainsSlashLight;
