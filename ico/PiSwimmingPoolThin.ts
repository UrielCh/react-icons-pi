...
/**
 * SwimmingPoolThin icon from Phosphor Icons
 * @module
 */
export function PiSwimmingPoolThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSwimmingPoolThin;
