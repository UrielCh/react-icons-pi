...
/**
 * EyedropperDuotone icon from Phosphor Icons
 * @module
 */
export function PiEyedropperDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperDuotone;
