...
/**
 * PhoneDisconnectFill icon from Phosphor Icons
 * @module
 */
export function PiPhoneDisconnectFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPhoneDisconnectFill;
