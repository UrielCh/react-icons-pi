...
/**
 * ArrowUUpLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowUUpLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUUpLeftBold;
