...
/**
 * ArrowBendRightUpBold icon from Phosphor Icons
 * @module
 */
export function PiArrowBendRightUpBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowBendRightUpBold;
