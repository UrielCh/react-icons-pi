...
/**
 * EyedropperSampleFill icon from Phosphor Icons
 * @module
 */
export function PiEyedropperSampleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiEyedropperSampleFill;
