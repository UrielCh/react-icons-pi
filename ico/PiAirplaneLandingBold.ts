...
/**
 * AirplaneLandingBold icon from Phosphor Icons
 * @module
 */
export function PiAirplaneLandingBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneLandingBold;
