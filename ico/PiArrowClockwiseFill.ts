...
/**
 * ArrowClockwiseFill icon from Phosphor Icons
 * @module
 */
export function PiArrowClockwiseFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowClockwiseFill;
