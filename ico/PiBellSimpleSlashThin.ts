...
/**
 * BellSimpleSlashThin icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleSlashThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleSlashThin;
