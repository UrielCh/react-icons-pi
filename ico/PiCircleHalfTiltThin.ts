...
/**
 * CircleHalfTiltThin icon from Phosphor Icons
 * @module
 */
export function PiCircleHalfTiltThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCircleHalfTiltThin;
