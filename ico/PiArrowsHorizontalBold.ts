...
/**
 * ArrowsHorizontalBold icon from Phosphor Icons
 * @module
 */
export function PiArrowsHorizontalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsHorizontalBold;
