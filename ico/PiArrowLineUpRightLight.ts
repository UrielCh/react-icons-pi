...
/**
 * ArrowLineUpRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowLineUpRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowLineUpRightLight;
