...
/**
 * AirplaneInFlightFill icon from Phosphor Icons
 * @module
 */
export function PiAirplaneInFlightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAirplaneInFlightFill;
