...
/**
 * SmileyNervousDuotone icon from Phosphor Icons
 * @module
 */
export function PiSmileyNervousDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyNervousDuotone;
