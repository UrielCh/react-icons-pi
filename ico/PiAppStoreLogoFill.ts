...
/**
 * AppStoreLogoFill icon from Phosphor Icons
 * @module
 */
export function PiAppStoreLogoFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAppStoreLogoFill;
