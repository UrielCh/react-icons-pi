...
/**
 * BellSimpleSlashDuotone icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleSlashDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleSlashDuotone;
