...
/**
 * BellSimpleRingingDuotone icon from Phosphor Icons
 * @module
 */
export function PiBellSimpleRingingDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBellSimpleRingingDuotone;
