...
/**
 * PianoKeysDuotone icon from Phosphor Icons
 * @module
 */
export function PiPianoKeysDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPianoKeysDuotone;
