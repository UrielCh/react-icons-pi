...
/**
 * PenNibStraightThin icon from Phosphor Icons
 * @module
 */
export function PiPenNibStraightThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPenNibStraightThin;
