...
/**
 * CaretCircleDoubleDownLight icon from Phosphor Icons
 * @module
 */
export function PiCaretCircleDoubleDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCaretCircleDoubleDownLight;
