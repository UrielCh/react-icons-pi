...
/**
 * LinkSimpleHorizontal icon from Phosphor Icons
 * @module
 */
export function PiLinkSimpleHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiLinkSimpleHorizontal;
