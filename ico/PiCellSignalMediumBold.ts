...
/**
 * CellSignalMediumBold icon from Phosphor Icons
 * @module
 */
export function PiCellSignalMediumBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalMediumBold;
