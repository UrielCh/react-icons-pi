...
/**
 * RainbowCloudLight icon from Phosphor Icons
 * @module
 */
export function PiRainbowCloudLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiRainbowCloudLight;
