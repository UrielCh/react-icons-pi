...
/**
 * BatteryChargingVertical icon from Phosphor Icons
 * @module
 */
export function PiBatteryChargingVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryChargingVertical;
