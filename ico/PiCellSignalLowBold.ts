...
/**
 * CellSignalLowBold icon from Phosphor Icons
 * @module
 */
export function PiCellSignalLowBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalLowBold;
