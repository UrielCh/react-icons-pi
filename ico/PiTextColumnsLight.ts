...
/**
 * TextColumnsLight icon from Phosphor Icons
 * @module
 */
export function PiTextColumnsLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTextColumnsLight;
