...
/**
 * PresentationChart icon from Phosphor Icons
 * @module
 */
export function PiPresentationChart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPresentationChart;
