...
/**
 * CellSignalFullLight icon from Phosphor Icons
 * @module
 */
export function PiCellSignalFullLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalFullLight;
