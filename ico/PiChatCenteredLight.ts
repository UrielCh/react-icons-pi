...
/**
 * ChatCenteredLight icon from Phosphor Icons
 * @module
 */
export function PiChatCenteredLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChatCenteredLight;
