...
/**
 * GenderNonbinaryFill icon from Phosphor Icons
 * @module
 */
export function PiGenderNonbinaryFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNonbinaryFill;
