...
/**
 * HashStraightLight icon from Phosphor Icons
 * @module
 */
export function PiHashStraightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHashStraightLight;
