...
/**
 * PersonArmsSpreadThin icon from Phosphor Icons
 * @module
 */
export function PiPersonArmsSpreadThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPersonArmsSpreadThin;
