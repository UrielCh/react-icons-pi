...
/**
 * GenderNonbinaryThin icon from Phosphor Icons
 * @module
 */
export function PiGenderNonbinaryThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGenderNonbinaryThin;
