...
/**
 * ArrowFatLinesUpFill icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesUpFill;
