...
/**
 * BatteryMediumFill icon from Phosphor Icons
 * @module
 */
export function PiBatteryMediumFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBatteryMediumFill;
