...
/**
 * ArrowSquareDownLeftLight icon from Phosphor Icons
 * @module
 */
export function PiArrowSquareDownLeftLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowSquareDownLeftLight;
