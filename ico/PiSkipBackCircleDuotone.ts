...
/**
 * SkipBackCircleDuotone icon from Phosphor Icons
 * @module
 */
export function PiSkipBackCircleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipBackCircleDuotone;
