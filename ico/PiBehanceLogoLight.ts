...
/**
 * BehanceLogoLight icon from Phosphor Icons
 * @module
 */
export function PiBehanceLogoLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBehanceLogoLight;
