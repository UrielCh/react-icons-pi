...
/**
 * SmileyStickerLight icon from Phosphor Icons
 * @module
 */
export function PiSmileyStickerLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSmileyStickerLight;
