...
/**
 * HeadlightsDuotone icon from Phosphor Icons
 * @module
 */
export function PiHeadlightsDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeadlightsDuotone;
