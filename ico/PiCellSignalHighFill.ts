...
/**
 * CellSignalHighFill icon from Phosphor Icons
 * @module
 */
export function PiCellSignalHighFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalHighFill;
