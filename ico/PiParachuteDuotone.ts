...
/**
 * ParachuteDuotone icon from Phosphor Icons
 * @module
 */
export function PiParachuteDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiParachuteDuotone;
