...
/**
 * GraduationCapThin icon from Phosphor Icons
 * @module
 */
export function PiGraduationCapThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiGraduationCapThin;
