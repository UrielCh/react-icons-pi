...
/**
 * AlignBottomSimpleDuotone icon from Phosphor Icons
 * @module
 */
export function PiAlignBottomSimpleDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAlignBottomSimpleDuotone;
