...
/**
 * BracketsSquareFill icon from Phosphor Icons
 * @module
 */
export function PiBracketsSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBracketsSquareFill;
