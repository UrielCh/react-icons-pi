...
/**
 * NumberThreeLight icon from Phosphor Icons
 * @module
 */
export function PiNumberThreeLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberThreeLight;
