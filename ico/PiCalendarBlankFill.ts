...
/**
 * CalendarBlankFill icon from Phosphor Icons
 * @module
 */
export function PiCalendarBlankFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCalendarBlankFill;
