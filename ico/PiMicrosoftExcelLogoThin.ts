...
/**
 * MicrosoftExcelLogoThin icon from Phosphor Icons
 * @module
 */
export function PiMicrosoftExcelLogoThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiMicrosoftExcelLogoThin;
