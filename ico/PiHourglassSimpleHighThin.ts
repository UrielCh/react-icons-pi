...
/**
 * HourglassSimpleHighThin icon from Phosphor Icons
 * @module
 */
export function PiHourglassSimpleHighThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHourglassSimpleHighThin;
