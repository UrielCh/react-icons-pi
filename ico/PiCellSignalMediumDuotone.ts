...
/**
 * CellSignalMediumDuotone icon from Phosphor Icons
 * @module
 */
export function PiCellSignalMediumDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalMediumDuotone;
