...
/**
 * ArrowsInSimpleThin icon from Phosphor Icons
 * @module
 */
export function PiArrowsInSimpleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsInSimpleThin;
