...
/**
 * NyTimesLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiNyTimesLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNyTimesLogoDuotone;
