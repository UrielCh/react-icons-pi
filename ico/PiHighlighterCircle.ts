...
/**
 * HighlighterCircle icon from Phosphor Icons
 * @module
 */
export function PiHighlighterCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHighlighterCircle;
