...
/**
 * AngularLogoDuotone icon from Phosphor Icons
 * @module
 */
export function PiAngularLogoDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiAngularLogoDuotone;
