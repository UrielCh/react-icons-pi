...
/**
 * ProjectorScreenChart icon from Phosphor Icons
 * @module
 */
export function PiProjectorScreenChart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiProjectorScreenChart;
