...
/**
 * TrafficSignalThin icon from Phosphor Icons
 * @module
 */
export function PiTrafficSignalThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrafficSignalThin;
