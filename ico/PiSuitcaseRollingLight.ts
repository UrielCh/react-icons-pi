...
/**
 * SuitcaseRollingLight icon from Phosphor Icons
 * @module
 */
export function PiSuitcaseRollingLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSuitcaseRollingLight;
