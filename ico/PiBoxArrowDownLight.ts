...
/**
 * BoxArrowDownLight icon from Phosphor Icons
 * @module
 */
export function PiBoxArrowDownLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiBoxArrowDownLight;
