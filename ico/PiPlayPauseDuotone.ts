...
/**
 * PlayPauseDuotone icon from Phosphor Icons
 * @module
 */
export function PiPlayPauseDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlayPauseDuotone;
