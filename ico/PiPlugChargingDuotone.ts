...
/**
 * PlugChargingDuotone icon from Phosphor Icons
 * @module
 */
export function PiPlugChargingDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPlugChargingDuotone;
