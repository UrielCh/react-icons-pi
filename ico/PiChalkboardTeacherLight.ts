...
/**
 * ChalkboardTeacherLight icon from Phosphor Icons
 * @module
 */
export function PiChalkboardTeacherLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiChalkboardTeacherLight;
