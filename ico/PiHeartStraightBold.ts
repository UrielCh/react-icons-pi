...
/**
 * HeartStraightBold icon from Phosphor Icons
 * @module
 */
export function PiHeartStraightBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiHeartStraightBold;
