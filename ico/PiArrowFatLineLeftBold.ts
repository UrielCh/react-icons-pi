...
/**
 * ArrowFatLineLeftBold icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLineLeftBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLineLeftBold;
