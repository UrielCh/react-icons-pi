...
/**
 * ArrowUDownRightFill icon from Phosphor Icons
 * @module
 */
export function PiArrowUDownRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowUDownRightFill;
