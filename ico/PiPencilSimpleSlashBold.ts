...
/**
 * PencilSimpleSlashBold icon from Phosphor Icons
 * @module
 */
export function PiPencilSimpleSlashBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiPencilSimpleSlashBold;
