...
/**
 * SquareSplitVerticalBold icon from Phosphor Icons
 * @module
 */
export function PiSquareSplitVerticalBold(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSquareSplitVerticalBold;
