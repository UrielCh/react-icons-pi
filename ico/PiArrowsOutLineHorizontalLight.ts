...
/**
 * ArrowsOutLineHorizontalLight icon from Phosphor Icons
 * @module
 */
export function PiArrowsOutLineHorizontalLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowsOutLineHorizontalLight;
