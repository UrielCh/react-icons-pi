...
/**
 * TrayArrowDownFill icon from Phosphor Icons
 * @module
 */
export function PiTrayArrowDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiTrayArrowDownFill;
