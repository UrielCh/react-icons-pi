...
/**
 * CellSignalMediumFill icon from Phosphor Icons
 * @module
 */
export function PiCellSignalMediumFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiCellSignalMediumFill;
