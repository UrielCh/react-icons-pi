...
/**
 * SkipForwardCircleThin icon from Phosphor Icons
 * @module
 */
export function PiSkipForwardCircleThin(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiSkipForwardCircleThin;
