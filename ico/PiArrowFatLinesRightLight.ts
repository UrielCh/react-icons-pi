...
/**
 * ArrowFatLinesRightLight icon from Phosphor Icons
 * @module
 */
export function PiArrowFatLinesRightLight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiArrowFatLinesRightLight;
