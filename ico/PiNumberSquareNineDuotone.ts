...
/**
 * NumberSquareNineDuotone icon from Phosphor Icons
 * @module
 */
export function PiNumberSquareNineDuotone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default PiNumberSquareNineDuotone;
